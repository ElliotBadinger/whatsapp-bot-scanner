...
- _(50 unique anti-pattern types total)_
...
- _(17 unique bug risk types total)_
...
- _(3 unique performance issue types total)_
...
- _(4 unique security issue types total)_

### By Severity

- **CRITICAL:** 5 issue types
- **MAJOR:** _(distribution in full report)_
- **MINOR:** _(distribution in full report)_
...
- Hardcoded IPs
- _(Full breakdown in detailed reports)_
...
- Naming conventions
- _(Full categorization in 832KB report)_
...
_(Query the full report to find files with most occurrences)_

### SonarQube Components Most Affected

_(Query the full report to find components with most issues)_
...
_Complete findings with file-by-file breakdown available in JSON reports totaling 1.36MB_
