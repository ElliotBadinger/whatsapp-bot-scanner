whatsapp-web.js 1.34.1 &raquo; Class: Message
        ...
        [whatsapp-web.js 1.34.1](index.html)
            ...
            ## Methods
              ...
              async
              ### acceptGroupV4Invite()&nbsp;&rarr;  Promise containing Object
              ...
              async
              ### downloadMedia()&nbsp;&rarr;  Promise containing [MessageMedia](MessageMedia.html)
              ...
              async
              ### edit(content[, options])&nbsp;&rarr;  Promise containing nullable [Message](Message.html)
              ...
              async
              ### editScheduledEvent(editedEventObject)&nbsp;&rarr;  Promise containing nullable [Message](Message.html)
              ...
              async
              ### getInfo()&nbsp;&rarr;  Promise containing nullable [MessageInfo](global.html#MessageInfo)
              ...
              async
              ### getMentions()&nbsp;&rarr;  Promise containing Array of [Contact](Contact.html)
              ...
              async
              ### getOrder()&nbsp;&rarr;  Promise containing [Order](Order.html)
              ...
              async
              ### getPayment()&nbsp;&rarr;  Promise containing [Payment](Payment.html)
              ...
              async
              ### getPollVotes()&nbsp;&rarr;  Promise containing Array of [PollVote](PollVote.html)
              ...
              async
              ### getQuotedMessage()&nbsp;&rarr;  Promise containing [Message](Message.html)
              ...
              async
              ### getReactions()&nbsp;&rarr;  Promise containing Array of [ReactionList](global.html#ReactionList)
              ...
              async
              ### pin(duration)&nbsp;&rarr;  Promise containing boolean
              ...
              async
              ### reload()&nbsp;&rarr;  Promise containing [Message](Message.html)
              ...
              async
              ### reply(content[, chatId][, options])&nbsp;&rarr;  Promise containing [Message](Message.html)
