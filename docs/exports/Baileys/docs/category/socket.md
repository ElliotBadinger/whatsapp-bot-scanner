...
## [📄️ Configuration The first step into getting anywhere with Baileys is configuring the socket.](https://baileys.wiki/docs/socket/configuration)## [📄️ Connecting After configuring the socket, comes connecting to WhatsApp servers.](https://baileys.wiki/docs/socket/connecting)## [📄️ History Sync After connecting successfully, the socket will try to download and process old chats, contacts and messages.](https://baileys.wiki/docs/socket/history-sync)## [📄️ Receiving Updates After getting the initial "history" messages, let's get real-time messages and updates.](https://baileys.wiki/docs/socket/receiving-updates)## [📄️ Handling Messages Messages, from a history sync or from a messages.upsert event, come in the form of proto.IWebMessageInfo. This is the protobuf that WhatsApp Web stores its messages in.](https://baileys.wiki/docs/socket/handling-messages)## [📄️ Sending Messages One of the core features of any messaging experience is sending messages.](https://baileys.wiki/docs/socket/sending-messages)## [📄️ Group Management WhatsApp group support is pivotal for many users of this library. To this end, Baileys has very extensive group support.](https://baileys.wiki/docs/socket/group-management)## [📄️ Privacy Baileys has some missing privacy settings as of the writing of this page. The currently exposed methods are:](https://baileys.wiki/docs/socket/privacy)## [📄️ App State Updates WA uses an encrypted form of communication to send chat/app updates. This has been implemented mostly and you can send the following updates:](https://baileys.wiki/docs/socket/appstate-updates)## [📄️ Business Features Business only features are mostly implemented in Baileys, with the only thing missing being the modification of business profile data.](https://baileys.wiki/docs/socket/business-features)## [📄️ Handling Broadcast Lists/Status If you are](https://baileys.wiki/docs/socket/broadcast-lists)[Previous Migrate to v7.x.x](https://baileys.wiki/docs/migration/to-v7.0.0)[Next Configuration](https://baileys.wiki/docs/socket/configuration)
