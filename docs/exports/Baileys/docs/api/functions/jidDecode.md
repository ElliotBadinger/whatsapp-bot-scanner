# Source: https://baileys.wiki/docs/api/functions/jidDecode

<!-- Scraped from https://baileys.wiki/docs/api/functions/jidDecode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/jidDecode/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: jidDecode()
> **jidDecode**(`jid`): `undefined` | [`FullJid`](https://baileys.wiki/docs/api/type-aliases/FullJid)
Defined in: [src/WABinary/jid-utils.ts:55](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L55)
## Parameters[​](https://baileys.wiki/docs/api/functions/jidDecode/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/jidDecode/#jid "Direct link to jid")
`undefined` | `string`
## Returns[​](https://baileys.wiki/docs/api/functions/jidDecode/#returns "Direct link to Returns")
`undefined` | [`FullJid`](https://baileys.wiki/docs/api/type-aliases/FullJid)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/jidDecode.md)
[Previous Function: isWABusinessPlatform()](https://baileys.wiki/docs/api/functions/isWABusinessPlatform)[Next Function: jidEncode()](https://baileys.wiki/docs/api/functions/jidEncode)
  * [Parameters](https://baileys.wiki/docs/api/functions/jidDecode/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/jidDecode/#jid)
  * [Returns](https://baileys.wiki/docs/api/functions/jidDecode/#returns)
