# Source: https://baileys.wiki/docs/api/functions/xmppPreKey

<!-- Scraped from https://baileys.wiki/docs/api/functions/xmppPreKey -->

[Skip to main content](https://baileys.wiki/docs/api/functions/xmppPreKey/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: xmppPreKey()
> **xmppPreKey**(`pair`, `id`): [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
Defined in: [src/Utils/signal.ts:81](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/signal.ts#L81)
## Parameters[​](https://baileys.wiki/docs/api/functions/xmppPreKey/#parameters "Direct link to Parameters")
### pair[​](https://baileys.wiki/docs/api/functions/xmppPreKey/#pair "Direct link to pair")
[`KeyPair`](https://baileys.wiki/docs/api/type-aliases/KeyPair)
### id[​](https://baileys.wiki/docs/api/functions/xmppPreKey/#id "Direct link to id")
`number`
## Returns[​](https://baileys.wiki/docs/api/functions/xmppPreKey/#returns "Direct link to Returns")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/xmppPreKey.md)
[Previous Function: writeRandomPadMax16()](https://baileys.wiki/docs/api/functions/writeRandomPadMax16)[Next Function: xmppSignedPreKey()](https://baileys.wiki/docs/api/functions/xmppSignedPreKey)
  * [Parameters](https://baileys.wiki/docs/api/functions/xmppPreKey/#parameters)
    * [pair](https://baileys.wiki/docs/api/functions/xmppPreKey/#pair)
    * [id](https://baileys.wiki/docs/api/functions/xmppPreKey/#id)
  * [Returns](https://baileys.wiki/docs/api/functions/xmppPreKey/#returns)
