# Source: https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe

<!-- Scraped from https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe -->

[Skip to main content](https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages.ts:955](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L955)
Given a list of message keys, aggregates them by chat & sender. Useful for sending read receipts in bulk
## Parameters[​](https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe/#parameters "Direct link to Parameters")
### keys[​](https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe/#keys "Direct link to keys")
[`WAMessageKey`](https://baileys.wiki/docs/api/type-aliases/WAMessageKey)[]
## Returns[​](https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe/#returns "Direct link to Returns")
`object`[]
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/aggregateMessageKeysNotFromMe.md)
[Previous Function: aesEncryptGCM()](https://baileys.wiki/docs/api/functions/aesEncryptGCM)[Next Function: areJidsSameUser()](https://baileys.wiki/docs/api/functions/areJidsSameUser)
  * [Parameters](https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe/#parameters)
    * [keys](https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe/#keys)
  * [Returns](https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe/#returns)
