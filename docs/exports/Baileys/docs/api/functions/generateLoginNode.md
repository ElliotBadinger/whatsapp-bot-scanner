# Source: https://baileys.wiki/docs/api/functions/generateLoginNode

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateLoginNode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateLoginNode/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: generateLoginNode()
> **generateLoginNode**(`userJid`, `config`): [`IClientPayload`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IClientPayload)
Defined in: [src/Utils/validate-connection.ts:66](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/validate-connection.ts#L66)
## Parameters[​](https://baileys.wiki/docs/api/functions/generateLoginNode/#parameters "Direct link to Parameters")
### userJid[​](https://baileys.wiki/docs/api/functions/generateLoginNode/#userjid "Direct link to userJid")
`string`
### config[​](https://baileys.wiki/docs/api/functions/generateLoginNode/#config "Direct link to config")
[`SocketConfig`](https://baileys.wiki/docs/api/type-aliases/SocketConfig)
## Returns[​](https://baileys.wiki/docs/api/functions/generateLoginNode/#returns "Direct link to Returns")
[`IClientPayload`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IClientPayload)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateLoginNode.md)
[Previous Function: generateLinkPreviewIfRequired()](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired)[Next Function: generateMdTagPrefix()](https://baileys.wiki/docs/api/functions/generateMdTagPrefix)
  * [Parameters](https://baileys.wiki/docs/api/functions/generateLoginNode/#parameters)
    * [userJid](https://baileys.wiki/docs/api/functions/generateLoginNode/#userjid)
    * [config](https://baileys.wiki/docs/api/functions/generateLoginNode/#config)
  * [Returns](https://baileys.wiki/docs/api/functions/generateLoginNode/#returns)
