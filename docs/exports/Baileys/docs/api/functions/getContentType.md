...
<!-- Scraped from https://baileys.wiki/docs/api/functions/getContentType -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getContentType/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages.ts:715](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages.ts#L715)
Get the key to access the true type of content
## Parameters[​](https://baileys.wiki/docs/api/functions/getContentType/#parameters "Direct link to Parameters")
### content[​](https://baileys.wiki/docs/api/functions/getContentType/#content "Direct link to content")
`undefined` | [`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
## Returns[​](https://baileys.wiki/docs/api/functions/getContentType/#returns "Direct link to Returns")
`undefined` | keyof IMessage
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getContentType.md)
[Previous Function: getCodeFromWSError()](https://baileys.wiki/docs/api/functions/getCodeFromWSError)[Next Function: getDecryptionJid()](https://baileys.wiki/docs/api/functions/getDecryptionJid)
  * [Parameters](https://baileys.wiki/docs/api/functions/getContentType/#parameters)
    * [content](https://baileys.wiki/docs/api/functions/getContentType/#content)
  * [Returns](https://baileys.wiki/docs/api/functions/getContentType/#returns)
