# Source: https://baileys.wiki/docs/api/functions/addTransactionCapability

<!-- Scraped from https://baileys.wiki/docs/api/functions/addTransactionCapability -->

[Skip to main content](https://baileys.wiki/docs/api/functions/addTransactionCapability/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: addTransactionCapability()
> **addTransactionCapability**(`state`, `logger`, `__namedParameters`): [`SignalKeyStoreWithTransaction`](https://baileys.wiki/docs/api/type-aliases/SignalKeyStoreWithTransaction)
Defined in: [src/Utils/auth-utils.ts:114](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/auth-utils.ts#L114)
Adds DB-like transaction capability to the SignalKeyStore Uses AsyncLocalStorage for automatic context management
## Parameters[​](https://baileys.wiki/docs/api/functions/addTransactionCapability/#parameters "Direct link to Parameters")
### state[​](https://baileys.wiki/docs/api/functions/addTransactionCapability/#state "Direct link to state")
[`SignalKeyStore`](https://baileys.wiki/docs/api/type-aliases/SignalKeyStore)
the key store to apply this capability to
### logger[​](https://baileys.wiki/docs/api/functions/addTransactionCapability/#logger "Direct link to logger")
`ILogger`
logger to log events
### __namedParameters[​](https://baileys.wiki/docs/api/functions/addTransactionCapability/#__namedparameters "Direct link to __namedParameters")
[`TransactionCapabilityOptions`](https://baileys.wiki/docs/api/type-aliases/TransactionCapabilityOptions)
## Returns[​](https://baileys.wiki/docs/api/functions/addTransactionCapability/#returns "Direct link to Returns")
...
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/addTransactionCapability.md)
[Previous Enumeration: XWAPaths](https://baileys.wiki/docs/api/enumerations/XWAPaths)[Next Function: aesDecrypt()](https://baileys.wiki/docs/api/functions/aesDecrypt)
  * [Parameters](https://baileys.wiki/docs/api/functions/addTransactionCapability/#parameters)
    * [state](https://baileys.wiki/docs/api/functions/addTransactionCapability/#state)
    * [logger](https://baileys.wiki/docs/api/functions/addTransactionCapability/#logger)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/addTransactionCapability/#__namedparameters)
  * [Returns](https://baileys.wiki/docs/api/functions/addTransactionCapability/#returns)
