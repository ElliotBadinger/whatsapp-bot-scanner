...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/addTransactionCapability/#**namedparameters "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/addTransactionCapability/#parameters)
  ...
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/addTransactionCapability/#__namedparameters)
