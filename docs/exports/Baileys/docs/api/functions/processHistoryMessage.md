...
<!-- Scraped from https://baileys.wiki/docs/api/functions/processHistoryMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/processHistoryMessage/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/history.ts:28](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/history.ts#L28)

## Parameters[​](https://baileys.wiki/docs/api/functions/processHistoryMessage/#parameters "Direct link to Parameters")

### item[​](https://baileys.wiki/docs/api/functions/processHistoryMessage/#item "Direct link to item")

[`IHistorySync`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IHistorySync)

## Returns[​](https://baileys.wiki/docs/api/functions/processHistoryMessage/#returns "Direct link to Returns")

`object`

### chats[​](https://baileys.wiki/docs/api/functions/processHistoryMessage/#chats "Direct link to chats")

> **chats** : [`Chat`](https://baileys.wiki/docs/api/type-aliases/Chat)[]

### contacts[​](https://baileys.wiki/docs/api/functions/processHistoryMessage/#contacts "Direct link to contacts")

> **contacts** : [`Contact`](https://baileys.wiki/docs/api/interfaces/Contact)[]

### messages[​](https://baileys.wiki/docs/api/functions/processHistoryMessage/#messages "Direct link to messages")

> **messages** : [`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)[]

### progress[​](https://baileys.wiki/docs/api/functions/processHistoryMessage/#progress "Direct link to progress")

> **progress** : `undefined` | `null` | `number` = `item.progress`

### syncType[​](https://baileys.wiki/docs/api/functions/processHistoryMessage/#synctype "Direct link to syncType")

> **syncType** : `undefined` | `null` | [`HistorySyncType`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/HistorySync/enumerations/HistorySyncType) = `item.syncType`
> [](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/processHistoryMessage.md)
> [Previous Function: prepareWAMessageMedia()](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia)[Next Function: processSyncAction()](https://baileys.wiki/docs/api/functions/processSyncAction)

- [Parameters](https://baileys.wiki/docs/api/functions/processHistoryMessage/#parameters)
  - [item](https://baileys.wiki/docs/api/functions/processHistoryMessage/#item)
- [Returns](https://baileys.wiki/docs/api/functions/processHistoryMessage/#returns)
  - [chats](https://baileys.wiki/docs/api/functions/processHistoryMessage/#chats)
  - [contacts](https://baileys.wiki/docs/api/functions/processHistoryMessage/#contacts)
  - [messages](https://baileys.wiki/docs/api/functions/processHistoryMessage/#messages)
  - [progress](https://baileys.wiki/docs/api/functions/processHistoryMessage/#progress)
  - [syncType](https://baileys.wiki/docs/api/functions/processHistoryMessage/#synctype)
