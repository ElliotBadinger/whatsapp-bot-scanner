# Source: https://baileys.wiki/docs/api/functions/generateWAMessageContent

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateWAMessageContent -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateWAMessageContent/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: generateWAMessageContent()
> **generateWAMessageContent**(`message`, `options`): `Promise`<[`Message`](https://baileys.wiki/docs/api/namespaces/proto/classes/Message)>
Defined in: [src/Utils/messages.ts:369](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages.ts#L369)
## Parameters[​](https://baileys.wiki/docs/api/functions/generateWAMessageContent/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/generateWAMessageContent/#message "Direct link to message")
[`AnyMessageContent`](https://baileys.wiki/docs/api/type-aliases/AnyMessageContent)
### options[​](https://baileys.wiki/docs/api/functions/generateWAMessageContent/#options "Direct link to options")
[`MessageContentGenerationOptions`](https://baileys.wiki/docs/api/type-aliases/MessageContentGenerationOptions)
## Returns[​](https://baileys.wiki/docs/api/functions/generateWAMessageContent/#returns "Direct link to Returns")
`Promise`<[`Message`](https://baileys.wiki/docs/api/namespaces/proto/classes/Message)>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateWAMessageContent.md)
[Previous Function: generateWAMessage()](https://baileys.wiki/docs/api/functions/generateWAMessage)[Next Function: generateWAMessageFromContent()](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent)
  * [Parameters](https://baileys.wiki/docs/api/functions/generateWAMessageContent/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/generateWAMessageContent/#message)
    * [options](https://baileys.wiki/docs/api/functions/generateWAMessageContent/#options)
  * [Returns](https://baileys.wiki/docs/api/functions/generateWAMessageContent/#returns)
