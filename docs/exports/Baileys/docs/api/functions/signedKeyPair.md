# Source: https://baileys.wiki/docs/api/functions/signedKeyPair

<!-- Scraped from https://baileys.wiki/docs/api/functions/signedKeyPair -->

[Skip to main content](https://baileys.wiki/docs/api/functions/signedKeyPair/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/crypto.ts:37](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/crypto.ts#L37)

## Parameters[​](https://baileys.wiki/docs/api/functions/signedKeyPair/#parameters "Direct link to Parameters")

### identityKeyPair[​](https://baileys.wiki/docs/api/functions/signedKeyPair/#identitykeypair "Direct link to identityKeyPair")

[`KeyPair`](https://baileys.wiki/docs/api/type-aliases/KeyPair)

### keyId[​](https://baileys.wiki/docs/api/functions/signedKeyPair/#keyid "Direct link to keyId")

`number`

## Returns[​](https://baileys.wiki/docs/api/functions/signedKeyPair/#returns "Direct link to Returns")

`object`

### keyId[​](https://baileys.wiki/docs/api/functions/signedKeyPair/#keyid-1 "Direct link to keyId")

> **keyId** : `number`

### keyPair[​](https://baileys.wiki/docs/api/functions/signedKeyPair/#keypair "Direct link to keyPair")

> **keyPair** : [`KeyPair`](https://baileys.wiki/docs/api/type-aliases/KeyPair) = `preKey`

### signature[​](https://baileys.wiki/docs/api/functions/signedKeyPair/#signature "Direct link to signature")

> **signature** : `Uint8Array`<`ArrayBufferLike`>
> [](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/signedKeyPair.md)
> [Previous Function: shouldIncrementChatUnread()](https://baileys.wiki/docs/api/functions/shouldIncrementChatUnread)[Next Function: toBuffer()](https://baileys.wiki/docs/api/functions/toBuffer)

- [Parameters](https://baileys.wiki/docs/api/functions/signedKeyPair/#parameters)
  - [identityKeyPair](https://baileys.wiki/docs/api/functions/signedKeyPair/#identitykeypair)
  - [keyId](https://baileys.wiki/docs/api/functions/signedKeyPair/#keyid)
- [Returns](https://baileys.wiki/docs/api/functions/signedKeyPair/#returns)
  - [keyId](https://baileys.wiki/docs/api/functions/signedKeyPair/#keyid-1)
  - [keyPair](https://baileys.wiki/docs/api/functions/signedKeyPair/#keypair)
  - [signature](https://baileys.wiki/docs/api/functions/signedKeyPair/#signature)
