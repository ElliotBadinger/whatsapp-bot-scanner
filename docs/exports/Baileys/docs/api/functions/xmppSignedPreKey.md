# Source: https://baileys.wiki/docs/api/functions/xmppSignedPreKey

<!-- Scraped from https://baileys.wiki/docs/api/functions/xmppSignedPreKey -->

[Skip to main content](https://baileys.wiki/docs/api/functions/xmppSignedPreKey/#__docusaurus_skipToContent_fallback)
...
- [](https://baileys.wiki/)
- functions
- Function: xmppSignedPreKey()

On this page

# Function: xmppSignedPreKey()

> **xmppSignedPreKey**(`key`): [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
> Defined in: [src/Utils/signal.ts:71](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/signal.ts#L71)

## Parameters[​](https://baileys.wiki/docs/api/functions/xmppSignedPreKey/#parameters "Direct link to Parameters")

### key[​](https://baileys.wiki/docs/api/functions/xmppSignedPreKey/#key "Direct link to key")

[`SignedKeyPair`](https://baileys.wiki/docs/api/type-aliases/SignedKeyPair)

## Returns[​](https://baileys.wiki/docs/api/functions/xmppSignedPreKey/#returns "Direct link to Returns")

[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/xmppSignedPreKey.md)
[Previous Function: xmppPreKey()](https://baileys.wiki/docs/api/functions/xmppPreKey)[Next baileys](https://baileys.wiki/docs/api/)

- [Parameters](https://baileys.wiki/docs/api/functions/xmppSignedPreKey/#parameters)
  - [key](https://baileys.wiki/docs/api/functions/xmppSignedPreKey/#key)
- [Returns](https://baileys.wiki/docs/api/functions/xmppSignedPreKey/#returns)
