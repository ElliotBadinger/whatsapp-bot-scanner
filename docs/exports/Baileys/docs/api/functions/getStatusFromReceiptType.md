# Source: https://baileys.wiki/docs/api/functions/getStatusFromReceiptType

<!-- Scraped from https://baileys.wiki/docs/api/functions/getStatusFromReceiptType -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getStatusFromReceiptType/#__docusaurus_skipToContent_fallback)
...
> **getStatusFromReceiptType**(`type`): `undefined` | [`Status`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/WebMessageInfo/enumerations/Status)
> Defined in: [src/Utils/generics.ts:342](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L342)
> Given a type of receipt, returns what the new status of the message should be

## Parameters[​](https://baileys.wiki/docs/api/functions/getStatusFromReceiptType/#parameters "Direct link to Parameters")

### type[​](https://baileys.wiki/docs/api/functions/getStatusFromReceiptType/#type "Direct link to type")

type from receipt
`undefined` | `string`

## Returns[​](https://baileys.wiki/docs/api/functions/getStatusFromReceiptType/#returns "Direct link to Returns")

`undefined` | [`Status`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/WebMessageInfo/enumerations/Status)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getStatusFromReceiptType.md)
[Previous Function: getStatusCodeForMediaRetry()](https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry)[Next Function: getStream()](https://baileys.wiki/docs/api/functions/getStream)

- [Parameters](https://baileys.wiki/docs/api/functions/getStatusFromReceiptType/#parameters)
  - [type](https://baileys.wiki/docs/api/functions/getStatusFromReceiptType/#type)
- [Returns](https://baileys.wiki/docs/api/functions/getStatusFromReceiptType/#returns)
