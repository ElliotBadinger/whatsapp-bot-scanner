# Source: https://baileys.wiki/docs/api/functions/generateParticipantHashV2

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateParticipantHashV2 -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateParticipantHashV2/#__docusaurus_skipToContent_fallback)
...
- [](https://baileys.wiki/)
- functions
- Function: generateParticipantHashV2()
...
> Defined in: [src/Utils/generics.ts:72](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L72)

## Parameters[​](https://baileys.wiki/docs/api/functions/generateParticipantHashV2/#parameters "Direct link to Parameters")

### participants[​](https://baileys.wiki/docs/api/functions/generateParticipantHashV2/#participants "Direct link to participants")

`string`[]

## Returns[​](https://baileys.wiki/docs/api/functions/generateParticipantHashV2/#returns "Direct link to Returns")

`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateParticipantHashV2.md)
[Previous Function: generateOrGetPreKeys()](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys)[Next Function: generateProfilePicture()](https://baileys.wiki/docs/api/functions/generateProfilePicture)

- [Parameters](https://baileys.wiki/docs/api/functions/generateParticipantHashV2/#parameters)
  - [participants](https://baileys.wiki/docs/api/functions/generateParticipantHashV2/#participants)
- [Returns](https://baileys.wiki/docs/api/functions/generateParticipantHashV2/#returns)
