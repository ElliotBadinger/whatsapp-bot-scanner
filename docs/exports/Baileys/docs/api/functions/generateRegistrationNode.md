...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#**namedparameters "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#parameters)
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#__namedparameters)
