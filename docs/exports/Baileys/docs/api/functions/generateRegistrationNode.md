# Source: https://baileys.wiki/docs/api/functions/generateRegistrationNode

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateRegistrationNode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: generateRegistrationNode()
> **generateRegistrationNode**(`__namedParameters`, `config`): [`ClientPayload`](https://baileys.wiki/docs/api/namespaces/proto/classes/ClientPayload)
Defined in: [src/Utils/validate-connection.ts:88](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/validate-connection.ts#L88)
## Parameters[​](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#__namedparameters "Direct link to __namedParameters")
[`SignalCreds`](https://baileys.wiki/docs/api/type-aliases/SignalCreds)
### config[​](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#config "Direct link to config")
[`SocketConfig`](https://baileys.wiki/docs/api/type-aliases/SocketConfig)
## Returns[​](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#returns "Direct link to Returns")
[`ClientPayload`](https://baileys.wiki/docs/api/namespaces/proto/classes/ClientPayload)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateRegistrationNode.md)
[Previous Function: generateRegistrationId()](https://baileys.wiki/docs/api/functions/generateRegistrationId)[Next Function: generateSignalPubKey()](https://baileys.wiki/docs/api/functions/generateSignalPubKey)
  * [Parameters](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#__namedparameters)
    * [config](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#config)
  * [Returns](https://baileys.wiki/docs/api/functions/generateRegistrationNode/#returns)
