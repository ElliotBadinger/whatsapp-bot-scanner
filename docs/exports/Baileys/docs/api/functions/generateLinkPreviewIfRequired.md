# Source: https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#__docusaurus_skipToContent_fallback)
...
> **generateLinkPreviewIfRequired**(`text`, `getUrlInfo`, `logger`): `Promise`<`undefined` | [`WAUrlInfo`](https://baileys.wiki/docs/api/interfaces/WAUrlInfo)>
> Defined in: [src/Utils/messages.ts:84](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L84)

## Parameters[​](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#parameters "Direct link to Parameters")

### text[​](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#text "Direct link to text")

`string`

### getUrlInfo[​](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#geturlinfo "Direct link to getUrlInfo")

`undefined` | (`text`) => `Promise`<`undefined` | [`WAUrlInfo`](https://baileys.wiki/docs/api/interfaces/WAUrlInfo)>

### logger[​](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#logger "Direct link to logger")

`undefined` | `ILogger`

## Returns[​](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#returns "Direct link to Returns")

`Promise`<`undefined` | [`WAUrlInfo`](https://baileys.wiki/docs/api/interfaces/WAUrlInfo)>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateLinkPreviewIfRequired.md)
[Previous Function: generateForwardMessageContent()](https://baileys.wiki/docs/api/functions/generateForwardMessageContent)[Next Function: generateLoginNode()](https://baileys.wiki/docs/api/functions/generateLoginNode)

- [Parameters](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#parameters)
  - [text](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#text)
  - [getUrlInfo](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#geturlinfo)
  - [logger](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#logger)
- [Returns](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired/#returns)
