# Source: https://baileys.wiki/docs/api/functions/aesEncrypt

<!-- Scraped from https://baileys.wiki/docs/api/functions/aesEncrypt -->

[Skip to main content](https://baileys.wiki/docs/api/functions/aesEncrypt/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/crypto.ts:96](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/crypto.ts#L96)
## Parameters[​](https://baileys.wiki/docs/api/functions/aesEncrypt/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/aesEncrypt/#buffer "Direct link to buffer")
`Uint8Array`<`ArrayBufferLike`> | `Buffer`<`ArrayBufferLike`>
### key[​](https://baileys.wiki/docs/api/functions/aesEncrypt/#key "Direct link to key")
`Buffer`
## Returns[​](https://baileys.wiki/docs/api/functions/aesEncrypt/#returns "Direct link to Returns")
`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/aesEncrypt.md)
[Previous Function: aesEncrypWithIV()](https://baileys.wiki/docs/api/functions/aesEncrypWithIV)[Next Function: aesEncryptCTR()](https://baileys.wiki/docs/api/functions/aesEncryptCTR)
  * [Parameters](https://baileys.wiki/docs/api/functions/aesEncrypt/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/aesEncrypt/#buffer)
    * [key](https://baileys.wiki/docs/api/functions/aesEncrypt/#key)
  * [Returns](https://baileys.wiki/docs/api/functions/aesEncrypt/#returns)
