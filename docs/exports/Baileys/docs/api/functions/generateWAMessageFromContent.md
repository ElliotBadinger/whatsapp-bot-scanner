# Source: https://baileys.wiki/docs/api/functions/generateWAMessageFromContent

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateWAMessageFromContent -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: generateWAMessageFromContent()
> **generateWAMessageFromContent**(`jid`, `message`, `options`): [`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)
Defined in: [src/Utils/messages.ts:623](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages.ts#L623)
## Parameters[​](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#jid "Direct link to jid")
`string`
### message[​](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#message "Direct link to message")
[`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
### options[​](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#options "Direct link to options")
[`MessageGenerationOptionsFromContent`](https://baileys.wiki/docs/api/type-aliases/MessageGenerationOptionsFromContent)
## Returns[​](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#returns "Direct link to Returns")
[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateWAMessageFromContent.md)
[Previous Function: generateWAMessageContent()](https://baileys.wiki/docs/api/functions/generateWAMessageContent)[Next Function: getAggregateResponsesInEventMessage()](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage)
  * [Parameters](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#jid)
    * [message](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#message)
    * [options](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#options)
  * [Returns](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent/#returns)
