# Source: https://baileys.wiki/docs/api/functions/extractSyncdPatches

<!-- Scraped from https://baileys.wiki/docs/api/functions/extractSyncdPatches -->

[Skip to main content](https://baileys.wiki/docs/api/functions/extractSyncdPatches/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: extractSyncdPatches()
> **extractSyncdPatches**(`result`, `options`): `Promise`<{ `critical_block`: { `hasMorePatches`: `boolean`; `patches`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]; `snapshot`: [`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot); }; `critical_unblock_low`: { `hasMorePatches`: `boolean`; `patches`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]; `snapshot`: [`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot); }; `regular`: { `hasMorePatches`: `boolean`; `patches`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]; `snapshot`: [`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot); }; `regular_high`: { `hasMorePatches`: `boolean`; `patches`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]; `snapshot`: [`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot); }; `regular_low`: { `hasMorePatches`: `boolean`; `patches`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]; `snapshot`: [`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot); }; }>
Defined in: [src/Utils/chat-utils.ts:304](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/chat-utils.ts#L304)
## Parameters[​](https://baileys.wiki/docs/api/functions/extractSyncdPatches/#parameters "Direct link to Parameters")
### result[​](https://baileys.wiki/docs/api/functions/extractSyncdPatches/#result "Direct link to result")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
### options[​](https://baileys.wiki/docs/api/functions/extractSyncdPatches/#options "Direct link to options")
`RequestInit`
## Returns[​](https://baileys.wiki/docs/api/functions/extractSyncdPatches/#returns "Direct link to Returns")
`Promise`<{ `critical_block`: { `hasMorePatches`: `boolean`; `patches`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]; `snapshot`: [`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot); }; `critical_unblock_low`: { `hasMorePatches`: `boolean`; `patches`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]; `snapshot`: [`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot); }; `regular`: { `hasMorePatches`: `boolean`; `patches`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]; `snapshot`: [`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot); }; `regular_high`: { `hasMorePatches`: `boolean`; `patches`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]; `snapshot`: [`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot); }; `regular_low`: { `hasMorePatches`: `boolean`; `patches`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]; `snapshot`: [`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot); }; }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/extractSyncdPatches.md)
[Previous Function: extractMessageContent()](https://baileys.wiki/docs/api/functions/extractMessageContent)[Next Function: extractUrlFromText()](https://baileys.wiki/docs/api/functions/extractUrlFromText)
  * [Parameters](https://baileys.wiki/docs/api/functions/extractSyncdPatches/#parameters)
    * [result](https://baileys.wiki/docs/api/functions/extractSyncdPatches/#result)
    * [options](https://baileys.wiki/docs/api/functions/extractSyncdPatches/#options)
  * [Returns](https://baileys.wiki/docs/api/functions/extractSyncdPatches/#returns)
