# Source: https://baileys.wiki/docs/api/functions/encodeWAMessage

<!-- Scraped from https://baileys.wiki/docs/api/functions/encodeWAMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/encodeWAMessage/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:78](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/generics.ts#L78)
## Parameters[​](https://baileys.wiki/docs/api/functions/encodeWAMessage/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/encodeWAMessage/#message "Direct link to message")
[`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
## Returns[​](https://baileys.wiki/docs/api/functions/encodeWAMessage/#returns "Direct link to Returns")
`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/encodeWAMessage.md)
[Previous Function: encodeWAM()](https://baileys.wiki/docs/api/functions/encodeWAM)[Next Function: encryptMediaRetryRequest()](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest)
  * [Parameters](https://baileys.wiki/docs/api/functions/encodeWAMessage/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/encodeWAMessage/#message)
  * [Returns](https://baileys.wiki/docs/api/functions/encodeWAMessage/#returns)
