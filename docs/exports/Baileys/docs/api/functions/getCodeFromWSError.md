# Source: https://baileys.wiki/docs/api/functions/getCodeFromWSError

<!-- Scraped from https://baileys.wiki/docs/api/functions/getCodeFromWSError -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getCodeFromWSError/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/generics.ts:406](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L406)

## Parameters[​](https://baileys.wiki/docs/api/functions/getCodeFromWSError/#parameters "Direct link to Parameters")

### error[​](https://baileys.wiki/docs/api/functions/getCodeFromWSError/#error "Direct link to error")

`Error`

## Returns[​](https://baileys.wiki/docs/api/functions/getCodeFromWSError/#returns "Direct link to Returns")

`number`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getCodeFromWSError.md)
[Previous Function: getChatId()](https://baileys.wiki/docs/api/functions/getChatId)[Next Function: getContentType()](https://baileys.wiki/docs/api/functions/getContentType)

- [Parameters](https://baileys.wiki/docs/api/functions/getCodeFromWSError/#parameters)
  - [error](https://baileys.wiki/docs/api/functions/getCodeFromWSError/#error)
- [Returns](https://baileys.wiki/docs/api/functions/getCodeFromWSError/#returns)
