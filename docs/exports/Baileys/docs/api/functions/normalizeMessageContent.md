...
<!-- Scraped from https://baileys.wiki/docs/api/functions/normalizeMessageContent -->

[Skip to main content](https://baileys.wiki/docs/api/functions/normalizeMessageContent/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: normalizeMessageContent()
> **normalizeMessageContent**(`content`): `undefined` | [`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
Defined in: [src/Utils/messages.ts:729](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages.ts#L729)
...
## Parameters[​](https://baileys.wiki/docs/api/functions/normalizeMessageContent/#parameters "Direct link to Parameters")
### content[​](https://baileys.wiki/docs/api/functions/normalizeMessageContent/#content "Direct link to content")
`undefined` | `null` | [`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
## Returns[​](https://baileys.wiki/docs/api/functions/normalizeMessageContent/#returns "Direct link to Returns")
`undefined` | [`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/normalizeMessageContent.md)
[Previous Function: newLTHashState()](https://baileys.wiki/docs/api/functions/newLTHashState)[Next Function: parseAndInjectE2ESessions()](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions)
  * [Parameters](https://baileys.wiki/docs/api/functions/normalizeMessageContent/#parameters)
    * [content](https://baileys.wiki/docs/api/functions/normalizeMessageContent/#content)
  * [Returns](https://baileys.wiki/docs/api/functions/normalizeMessageContent/#returns)
