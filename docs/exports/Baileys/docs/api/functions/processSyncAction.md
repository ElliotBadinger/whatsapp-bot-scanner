# Source: https://baileys.wiki/docs/api/functions/processSyncAction

<!-- Scraped from https://baileys.wiki/docs/api/functions/processSyncAction -->

[Skip to main content](https://baileys.wiki/docs/api/functions/processSyncAction/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/chat-utils.ts:756](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/chat-utils.ts#L756)

## Parameters[​](https://baileys.wiki/docs/api/functions/processSyncAction/#parameters "Direct link to Parameters")

### syncAction[​](https://baileys.wiki/docs/api/functions/processSyncAction/#syncaction "Direct link to syncAction")

[`ChatMutation`](https://baileys.wiki/docs/api/type-aliases/ChatMutation)

### ev[​](https://baileys.wiki/docs/api/functions/processSyncAction/#ev "Direct link to ev")

[`BaileysEventEmitter`](https://baileys.wiki/docs/api/interfaces/BaileysEventEmitter)

### me[​](https://baileys.wiki/docs/api/functions/processSyncAction/#me "Direct link to me")

[`Contact`](https://baileys.wiki/docs/api/interfaces/Contact)

### initialSyncOpts?[​](https://baileys.wiki/docs/api/functions/processSyncAction/#initialsyncopts "Direct link to initialSyncOpts?")

[`InitialAppStateSyncOptions`](https://baileys.wiki/docs/api/type-aliases/InitialAppStateSyncOptions)

### logger?[​](https://baileys.wiki/docs/api/functions/processSyncAction/#logger "Direct link to logger?")

`ILogger`

## Returns[​](https://baileys.wiki/docs/api/functions/processSyncAction/#returns "Direct link to Returns")

`void`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/processSyncAction.md)
[Previous Function: processHistoryMessage()](https://baileys.wiki/docs/api/functions/processHistoryMessage)[Next Function: promiseTimeout()](https://baileys.wiki/docs/api/functions/promiseTimeout)

- [Parameters](https://baileys.wiki/docs/api/functions/processSyncAction/#parameters)
  - [syncAction](https://baileys.wiki/docs/api/functions/processSyncAction/#syncaction)
  - [ev](https://baileys.wiki/docs/api/functions/processSyncAction/#ev)
  - [me](https://baileys.wiki/docs/api/functions/processSyncAction/#me)
  - [initialSyncOpts?](https://baileys.wiki/docs/api/functions/processSyncAction/#initialsyncopts)
  - [logger?](https://baileys.wiki/docs/api/functions/processSyncAction/#logger)
- [Returns](https://baileys.wiki/docs/api/functions/processSyncAction/#returns)
