# Source: https://baileys.wiki/docs/api/functions/decryptEventResponse

<!-- Scraped from https://baileys.wiki/docs/api/functions/decryptEventResponse -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decryptEventResponse/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: decryptEventResponse()
> **decryptEventResponse**(`response`, `ctx`): [`EventResponseMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/classes/EventResponseMessage)
Defined in: [src/Utils/process-message.ts:197](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/process-message.ts#L197)
Decrypt an event response
## Parameters[​](https://baileys.wiki/docs/api/functions/decryptEventResponse/#parameters "Direct link to Parameters")
### response[​](https://baileys.wiki/docs/api/functions/decryptEventResponse/#response "Direct link to response")
[`IPollEncValue`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IPollEncValue)
encrypted event response
### ctx[​](https://baileys.wiki/docs/api/functions/decryptEventResponse/#ctx "Direct link to ctx")
`EventContext`
additional info about the event required for decryption
## Returns[​](https://baileys.wiki/docs/api/functions/decryptEventResponse/#returns "Direct link to Returns")
[`EventResponseMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/classes/EventResponseMessage)
event response message
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decryptEventResponse.md)
[Previous Function: decompressingIfRequired()](https://baileys.wiki/docs/api/functions/decompressingIfRequired)[Next Function: decryptMediaRetryData()](https://baileys.wiki/docs/api/functions/decryptMediaRetryData)
  * [Parameters](https://baileys.wiki/docs/api/functions/decryptEventResponse/#parameters)
    * [response](https://baileys.wiki/docs/api/functions/decryptEventResponse/#response)
    * [ctx](https://baileys.wiki/docs/api/functions/decryptEventResponse/#ctx)
  * [Returns](https://baileys.wiki/docs/api/functions/decryptEventResponse/#returns)
