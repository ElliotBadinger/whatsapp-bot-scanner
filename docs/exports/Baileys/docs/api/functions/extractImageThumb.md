# Source: https://baileys.wiki/docs/api/functions/extractImageThumb

<!-- Scraped from https://baileys.wiki/docs/api/functions/extractImageThumb -->

[Skip to main content](https://baileys.wiki/docs/api/functions/extractImageThumb/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/messages-media.ts:134](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L134)

## Parameters[​](https://baileys.wiki/docs/api/functions/extractImageThumb/#parameters "Direct link to Parameters")

### bufferOrFilePath[​](https://baileys.wiki/docs/api/functions/extractImageThumb/#bufferorfilepath "Direct link to bufferOrFilePath")

`string` | `Buffer`<`ArrayBufferLike`> | `Readable`

### width[​](https://baileys.wiki/docs/api/functions/extractImageThumb/#width "Direct link to width")

`number` = `32`

## Returns[​](https://baileys.wiki/docs/api/functions/extractImageThumb/#returns "Direct link to Returns")

`Promise`<{ `buffer`: `any`; `original`: { `height`: `any`; `width`: `any`; }; }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/extractImageThumb.md)
[Previous Function: extractDeviceJids()](https://baileys.wiki/docs/api/functions/extractDeviceJids)[Next Function: extractMessageContent()](https://baileys.wiki/docs/api/functions/extractMessageContent)

- [Parameters](https://baileys.wiki/docs/api/functions/extractImageThumb/#parameters)
  - [bufferOrFilePath](https://baileys.wiki/docs/api/functions/extractImageThumb/#bufferorfilepath)
  - [width](https://baileys.wiki/docs/api/functions/extractImageThumb/#width)
- [Returns](https://baileys.wiki/docs/api/functions/extractImageThumb/#returns)
