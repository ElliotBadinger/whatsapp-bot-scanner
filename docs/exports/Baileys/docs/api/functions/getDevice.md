# Source: https://baileys.wiki/docs/api/functions/getDevice

<!-- Scraped from https://baileys.wiki/docs/api/functions/getDevice -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getDevice/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages.ts:806](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L806)
Returns the device predicted by message ID
## Parameters[​](https://baileys.wiki/docs/api/functions/getDevice/#parameters "Direct link to Parameters")
### id[​](https://baileys.wiki/docs/api/functions/getDevice/#id "Direct link to id")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/getDevice/#returns "Direct link to Returns")
`"web"` | `"unknown"` | `"android"` | `"ios"` | `"desktop"`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getDevice.md)
[Previous Function: getDecryptionJid()](https://baileys.wiki/docs/api/functions/getDecryptionJid)[Next Function: getErrorCodeFromStreamError()](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError)
  * [Parameters](https://baileys.wiki/docs/api/functions/getDevice/#parameters)
    * [id](https://baileys.wiki/docs/api/functions/getDevice/#id)
  * [Returns](https://baileys.wiki/docs/api/functions/getDevice/#returns)
