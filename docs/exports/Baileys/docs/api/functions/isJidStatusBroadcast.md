# Source: https://baileys.wiki/docs/api/functions/isJidStatusBroadcast

<!-- Scraped from https://baileys.wiki/docs/api/functions/isJidStatusBroadcast -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isJidStatusBroadcast/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/WABinary/jid-utils.ts:101](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L101)
> is the jid the status broadcast

## Parameters[​](https://baileys.wiki/docs/api/functions/isJidStatusBroadcast/#parameters "Direct link to Parameters")

### jid[​](https://baileys.wiki/docs/api/functions/isJidStatusBroadcast/#jid "Direct link to jid")

`string`

## Returns[​](https://baileys.wiki/docs/api/functions/isJidStatusBroadcast/#returns "Direct link to Returns")

`jid is "status@broadcast"`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isJidStatusBroadcast.md)
[Previous Function: isJidNewsletter()](https://baileys.wiki/docs/api/functions/isJidNewsletter)[Next Function: isLidUser()](https://baileys.wiki/docs/api/functions/isLidUser)

- [Parameters](https://baileys.wiki/docs/api/functions/isJidStatusBroadcast/#parameters)
  - [jid](https://baileys.wiki/docs/api/functions/isJidStatusBroadcast/#jid)
- [Returns](https://baileys.wiki/docs/api/functions/isJidStatusBroadcast/#returns)
