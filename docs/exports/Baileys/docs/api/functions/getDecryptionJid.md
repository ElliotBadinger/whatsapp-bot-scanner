# Source: https://baileys.wiki/docs/api/functions/getDecryptionJid

<!-- Scraped from https://baileys.wiki/docs/api/functions/getDecryptionJid -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getDecryptionJid/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: getDecryptionJid()


On this page
# Function: getDecryptionJid()
> **getDecryptionJid**(`sender`, `repository`): `Promise`<`string`>
Defined in: [src/Utils/decode-wa-message.ts:22](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/decode-wa-message.ts#L22)
## Parameters[​](https://baileys.wiki/docs/api/functions/getDecryptionJid/#parameters "Direct link to Parameters")
### sender[​](https://baileys.wiki/docs/api/functions/getDecryptionJid/#sender "Direct link to sender")
`string`
### repository[​](https://baileys.wiki/docs/api/functions/getDecryptionJid/#repository "Direct link to repository")
[`SignalRepositoryWithLIDStore`](https://baileys.wiki/docs/api/interfaces/SignalRepositoryWithLIDStore)
## Returns[​](https://baileys.wiki/docs/api/functions/getDecryptionJid/#returns "Direct link to Returns")
`Promise`<`string`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getDecryptionJid.md)
[Previous Function: getContentType()](https://baileys.wiki/docs/api/functions/getContentType)[Next Function: getDevice()](https://baileys.wiki/docs/api/functions/getDevice)
  * [Parameters](https://baileys.wiki/docs/api/functions/getDecryptionJid/#parameters)
    * [sender](https://baileys.wiki/docs/api/functions/getDecryptionJid/#sender)
    * [repository](https://baileys.wiki/docs/api/functions/getDecryptionJid/#repository)
  * [Returns](https://baileys.wiki/docs/api/functions/getDecryptionJid/#returns)
