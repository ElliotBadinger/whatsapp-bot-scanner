# Source: https://baileys.wiki/docs/api/functions/isLidUser

<!-- Scraped from https://baileys.wiki/docs/api/functions/isLidUser -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isLidUser/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/jid-utils.ts:95](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L95)
is the jid a LID
## Parameters[​](https://baileys.wiki/docs/api/functions/isLidUser/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/isLidUser/#jid "Direct link to jid")
`undefined` | `string`
## Returns[​](https://baileys.wiki/docs/api/functions/isLidUser/#returns "Direct link to Returns")
`undefined` | `boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isLidUser.md)
[Previous Function: isJidStatusBroadcast()](https://baileys.wiki/docs/api/functions/isJidStatusBroadcast)[Next Function: isPnUser()](https://baileys.wiki/docs/api/functions/isPnUser)
  * [Parameters](https://baileys.wiki/docs/api/functions/isLidUser/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/isLidUser/#jid)
  * [Returns](https://baileys.wiki/docs/api/functions/isLidUser/#returns)
