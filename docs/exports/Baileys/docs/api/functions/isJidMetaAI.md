# Source: https://baileys.wiki/docs/api/functions/isJidMetaAI

<!-- Scraped from https://baileys.wiki/docs/api/functions/isJidMetaAI -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isJidMetaAI/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: isJidMetaAI()


On this page
# Function: isJidMetaAI()
> **isJidMetaAI**(`jid`): `undefined` | `boolean`
Defined in: [src/WABinary/jid-utils.ts:91](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/WABinary/jid-utils.ts#L91)
is the jid Meta AI
## Parameters[​](https://baileys.wiki/docs/api/functions/isJidMetaAI/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/isJidMetaAI/#jid "Direct link to jid")
`undefined` | `string`
## Returns[​](https://baileys.wiki/docs/api/functions/isJidMetaAI/#returns "Direct link to Returns")
`undefined` | `boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isJidMetaAI.md)
[Previous Function: isJidGroup()](https://baileys.wiki/docs/api/functions/isJidGroup)[Next Function: isJidNewsletter()](https://baileys.wiki/docs/api/functions/isJidNewsletter)
  * [Parameters](https://baileys.wiki/docs/api/functions/isJidMetaAI/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/isJidMetaAI/#jid)
  * [Returns](https://baileys.wiki/docs/api/functions/isJidMetaAI/#returns)
