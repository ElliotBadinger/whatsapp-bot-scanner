# Source: https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore

<!-- Scraped from https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore -->

[Skip to main content](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#__docusaurus_skipToContent_fallback)
...
> **makeCacheableSignalKeyStore**(`store`, `logger`?, `_cache`?): [`SignalKeyStore`](https://baileys.wiki/docs/api/type-aliases/SignalKeyStore)
> Defined in: [src/Utils/auth-utils.ts:36](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/auth-utils.ts#L36)
> Adds caching capability to a SignalKeyStore

## Parameters[​](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#parameters "Direct link to Parameters")

### store[​](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#store "Direct link to store")

[`SignalKeyStore`](https://baileys.wiki/docs/api/type-aliases/SignalKeyStore)
the store to add caching to

### logger?[​](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#logger "Direct link to logger?")

`ILogger`
to log trace events

### \_cache?[​](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#_cache "Direct link to _cache?")

[`CacheStore`](https://baileys.wiki/docs/api/type-aliases/CacheStore)
cache store to use

## Returns[​](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#returns "Direct link to Returns")

[`SignalKeyStore`](https://baileys.wiki/docs/api/type-aliases/SignalKeyStore)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/makeCacheableSignalKeyStore.md)
[Previous Function: jidNormalizedUser()](https://baileys.wiki/docs/api/functions/jidNormalizedUser)[Next Function: makeEventBuffer()](https://baileys.wiki/docs/api/functions/makeEventBuffer)

- [Parameters](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#parameters)
  - [store](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#store)
  - [logger?](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#logger)
  - [\_cache?](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#_cache)
- [Returns](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore/#returns)
