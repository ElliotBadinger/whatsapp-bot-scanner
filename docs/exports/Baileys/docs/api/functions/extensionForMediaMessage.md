# Source: https://baileys.wiki/docs/api/functions/extensionForMediaMessage

<!-- Scraped from https://baileys.wiki/docs/api/functions/extensionForMediaMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/extensionForMediaMessage/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:628](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages-media.ts#L628)
## Parameters[​](https://baileys.wiki/docs/api/functions/extensionForMediaMessage/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/extensionForMediaMessage/#message "Direct link to message")
[`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
## Returns[​](https://baileys.wiki/docs/api/functions/extensionForMediaMessage/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/extensionForMediaMessage.md)
[Previous Function: encryptedStream()](https://baileys.wiki/docs/api/functions/encryptedStream)[Next Function: extractAddressingContext()](https://baileys.wiki/docs/api/functions/extractAddressingContext)
  * [Parameters](https://baileys.wiki/docs/api/functions/extensionForMediaMessage/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/extensionForMediaMessage/#message)
  * [Returns](https://baileys.wiki/docs/api/functions/extensionForMediaMessage/#returns)
