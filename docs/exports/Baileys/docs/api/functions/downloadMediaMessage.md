# Source: https://baileys.wiki/docs/api/functions/downloadMediaMessage

<!-- Scraped from https://baileys.wiki/docs/api/functions/downloadMediaMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: downloadMediaMessage()
> **downloadMediaMessage** <`Type`>(`message`, `type`, `options`, `ctx`?): `Promise`<`Type` _extends_ `"buffer"` ? `Buffer`<`ArrayBufferLike`> : `Transform`>
Defined in: [src/Utils/messages.ts:985](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages.ts#L985)
Downloads the given message. Throws an error if it's not a media message
## Type Parameters[​](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#type-parameters "Direct link to Type Parameters")
• **Type** _extends_ `"buffer"` | `"stream"`
## Parameters[​](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#message "Direct link to message")
[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)
### type[​](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#type "Direct link to type")
`Type`
### options[​](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#options "Direct link to options")
[`MediaDownloadOptions`](https://baileys.wiki/docs/api/type-aliases/MediaDownloadOptions)
### ctx?[​](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#ctx "Direct link to ctx?")
`DownloadMediaMessageContext`
## Returns[​](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#returns "Direct link to Returns")
`Promise`<`Type` _extends_ `"buffer"` ? `Buffer`<`ArrayBufferLike`> : `Transform`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/downloadMediaMessage.md)
[Previous Function: downloadHistory()](https://baileys.wiki/docs/api/functions/downloadHistory)[Next Function: encodeBase64EncodedStringForUpload()](https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload)
  * [Type Parameters](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#type-parameters)
  * [Parameters](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#message)
    * [type](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#type)
    * [options](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#options)
    * [ctx?](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#ctx)
  * [Returns](https://baileys.wiki/docs/api/functions/downloadMediaMessage/#returns)
