# Source: https://baileys.wiki/docs/api/functions/getChatId

<!-- Scraped from https://baileys.wiki/docs/api/functions/getChatId -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getChatId/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/process-message.ts:131](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/process-message.ts#L131)
Get the ID of the chat from the given key. Typically -- that'll be the remoteJid, but for broadcasts, it'll be the participant
## Parameters[​](https://baileys.wiki/docs/api/functions/getChatId/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/getChatId/#__namedparameters "Direct link to __namedParameters")
[`WAMessageKey`](https://baileys.wiki/docs/api/type-aliases/WAMessageKey)
## Returns[​](https://baileys.wiki/docs/api/functions/getChatId/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getChatId.md)
[Previous Function: getCallStatusFromNode()](https://baileys.wiki/docs/api/functions/getCallStatusFromNode)[Next Function: getCodeFromWSError()](https://baileys.wiki/docs/api/functions/getCodeFromWSError)
  * [Parameters](https://baileys.wiki/docs/api/functions/getChatId/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/getChatId/#__namedparameters)
  * [Returns](https://baileys.wiki/docs/api/functions/getChatId/#returns)
