...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/getChatId/#**namedparameters "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/getChatId/#parameters)
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/getChatId/#__namedparameters)
