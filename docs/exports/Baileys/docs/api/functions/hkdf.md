# Source: https://baileys.wiki/docs/api/functions/hkdf

<!-- Scraped from https://baileys.wiki/docs/api/functions/hkdf -->

[Skip to main content](https://baileys.wiki/docs/api/functions/hkdf/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/crypto.ts:126](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/crypto.ts#L126)
## Parameters[​](https://baileys.wiki/docs/api/functions/hkdf/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/hkdf/#buffer "Direct link to buffer")
`Uint8Array`<`ArrayBufferLike`> | `Buffer`<`ArrayBufferLike`>
### expandedLength[​](https://baileys.wiki/docs/api/functions/hkdf/#expandedlength "Direct link to expandedLength")
`number`
### info[​](https://baileys.wiki/docs/api/functions/hkdf/#info "Direct link to info")
#### info?[​](https://baileys.wiki/docs/api/functions/hkdf/#info-1 "Direct link to info?")
`string`
#### salt?[​](https://baileys.wiki/docs/api/functions/hkdf/#salt "Direct link to salt?")
`Buffer`<`ArrayBufferLike`>
## Returns[​](https://baileys.wiki/docs/api/functions/hkdf/#returns "Direct link to Returns")
`Promise`<`Buffer`<`ArrayBufferLike`>>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/hkdf.md)
[Previous Function: getWAUploadToServer()](https://baileys.wiki/docs/api/functions/getWAUploadToServer)[Next Function: hkdfInfoKey()](https://baileys.wiki/docs/api/functions/hkdfInfoKey)
  * [Parameters](https://baileys.wiki/docs/api/functions/hkdf/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/hkdf/#buffer)
    * [expandedLength](https://baileys.wiki/docs/api/functions/hkdf/#expandedlength)
    * [info](https://baileys.wiki/docs/api/functions/hkdf/#info)
  * [Returns](https://baileys.wiki/docs/api/functions/hkdf/#returns)
