# Source: https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion

<!-- Scraped from https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion -->

[Skip to main content](https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: fetchLatestBaileysVersion()
> **fetchLatestBaileysVersion**(`options`): `Promise`<{ `error`: `undefined`; `isLatest`: `boolean`; `version`: [`WAVersion`](https://baileys.wiki/docs/api/type-aliases/WAVersion); } | { `error`: `unknown`; `isLatest`: `boolean`; `version`: [`WAVersion`](https://baileys.wiki/docs/api/type-aliases/WAVersion); }>
Defined in: [src/Utils/generics.ts:234](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L234)
...
## Parameters[​](https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion/#parameters "Direct link to Parameters")
### options[​](https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion/#options "Direct link to options")
`RequestInit` = `{}`
## Returns[​](https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion/#returns "Direct link to Returns")
...
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/fetchLatestBaileysVersion.md)
[Previous Function: extractUrlFromText()](https://baileys.wiki/docs/api/functions/extractUrlFromText)[Next Function: fetchLatestWaWebVersion()](https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion)
  * [Parameters](https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion/#parameters)
    * [options](https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion/#options)
  * [Returns](https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion/#returns)
