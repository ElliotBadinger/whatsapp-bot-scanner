# Source: https://baileys.wiki/docs/api/functions/aesEncryptGCM

<!-- Scraped from https://baileys.wiki/docs/api/functions/aesEncryptGCM -->

[Skip to main content](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/crypto.ts:52](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/crypto.ts#L52)
> encrypt AES 256 GCM; where the tag tag is suffixed to the ciphertext

## Parameters[​](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#parameters "Direct link to Parameters")

### plaintext[​](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#plaintext "Direct link to plaintext")

`Uint8Array`

### key[​](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#key "Direct link to key")

`Uint8Array`

### iv[​](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#iv "Direct link to iv")

`Uint8Array`

### additionalData[​](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#additionaldata "Direct link to additionalData")

`Uint8Array`

## Returns[​](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#returns "Direct link to Returns")

`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/aesEncryptGCM.md)
[Previous Function: aesEncryptCTR()](https://baileys.wiki/docs/api/functions/aesEncryptCTR)[Next Function: aggregateMessageKeysNotFromMe()](https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe)

- [Parameters](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#parameters)
  - [plaintext](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#plaintext)
  - [key](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#key)
  - [iv](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#iv)
  - [additionalData](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#additionaldata)
- [Returns](https://baileys.wiki/docs/api/functions/aesEncryptGCM/#returns)
