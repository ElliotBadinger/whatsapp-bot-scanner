# Source: https://baileys.wiki/docs/api/functions/bytesToCrockford

<!-- Scraped from https://baileys.wiki/docs/api/functions/bytesToCrockford -->

[Skip to main content](https://baileys.wiki/docs/api/functions/bytesToCrockford/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/generics.ts:446](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L446)

## Parameters[​](https://baileys.wiki/docs/api/functions/bytesToCrockford/#parameters "Direct link to Parameters")

### buffer[​](https://baileys.wiki/docs/api/functions/bytesToCrockford/#buffer "Direct link to buffer")

`Buffer`

## Returns[​](https://baileys.wiki/docs/api/functions/bytesToCrockford/#returns "Direct link to Returns")

`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/bytesToCrockford.md)
[Previous Function: bindWaitForEvent()](https://baileys.wiki/docs/api/functions/bindWaitForEvent)[Next Function: chatModificationToAppPatch()](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch)

- [Parameters](https://baileys.wiki/docs/api/functions/bytesToCrockford/#parameters)
  - [buffer](https://baileys.wiki/docs/api/functions/bytesToCrockford/#buffer)
- [Returns](https://baileys.wiki/docs/api/functions/bytesToCrockford/#returns)
