# Source: https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage

<!-- Scraped from https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/messages.ts:930](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L930)
> Aggregates all event responses in an event message.

## Parameters[​](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage/#parameters "Direct link to Parameters")

### msg[​](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage/#msg "Direct link to msg")

`Pick`<[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage), `"eventResponses"`>
the event creation message

### meId?[​](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage/#meid "Direct link to meId?")

`string`
your jid

## Returns[​](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage/#returns "Direct link to Returns")

`ResponseAggregation`[]
A list of response types & their responders
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getAggregateResponsesInEventMessage.md)
[Previous Function: generateWAMessageFromContent()](https://baileys.wiki/docs/api/functions/generateWAMessageFromContent)[Next Function: getAggregateVotesInPollMessage()](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage)

- [Parameters](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage/#parameters)
  - [msg](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage/#msg)
  - [meId?](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage/#meid)
- [Returns](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage/#returns)
