# Source: https://baileys.wiki/docs/api/functions/assertNodeErrorFree

<!-- Scraped from https://baileys.wiki/docs/api/functions/assertNodeErrorFree -->

[Skip to main content](https://baileys.wiki/docs/api/functions/assertNodeErrorFree/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/WABinary/generic-utils.ts:52](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/generic-utils.ts#L52)

## Parameters[​](https://baileys.wiki/docs/api/functions/assertNodeErrorFree/#parameters "Direct link to Parameters")

### node[​](https://baileys.wiki/docs/api/functions/assertNodeErrorFree/#node "Direct link to node")

[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)

## Returns[​](https://baileys.wiki/docs/api/functions/assertNodeErrorFree/#returns "Direct link to Returns")

`void`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/assertNodeErrorFree.md)
[Previous Function: assertMediaContent()](https://baileys.wiki/docs/api/functions/assertMediaContent)[Next Function: binaryNodeToString()](https://baileys.wiki/docs/api/functions/binaryNodeToString)

- [Parameters](https://baileys.wiki/docs/api/functions/assertNodeErrorFree/#parameters)
  - [node](https://baileys.wiki/docs/api/functions/assertNodeErrorFree/#node)
- [Returns](https://baileys.wiki/docs/api/functions/assertNodeErrorFree/#returns)
