# Source: https://baileys.wiki/docs/api/functions/newLTHashState

<!-- Scraped from https://baileys.wiki/docs/api/functions/newLTHashState -->

[Skip to main content](https://baileys.wiki/docs/api/functions/newLTHashState/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: newLTHashState()


On this page
# Function: newLTHashState()
> **newLTHashState**(): [`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState)
Defined in: [src/Utils/chat-utils.ts:138](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/chat-utils.ts#L138)
## Returns[​](https://baileys.wiki/docs/api/functions/newLTHashState/#returns "Direct link to Returns")
[`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/newLTHashState.md)
[Previous Function: mediaMessageSHA256B64()](https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64)[Next Function: normalizeMessageContent()](https://baileys.wiki/docs/api/functions/normalizeMessageContent)
  * [Returns](https://baileys.wiki/docs/api/functions/newLTHashState/#returns)
