# Source: https://baileys.wiki/docs/api/functions/aesDecrypt

<!-- Scraped from https://baileys.wiki/docs/api/functions/aesDecrypt -->

[Skip to main content](https://baileys.wiki/docs/api/functions/aesDecrypt/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/crypto.ts:85](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/crypto.ts#L85)
decrypt AES 256 CBC; where the IV is prefixed to the buffer
## Parameters[​](https://baileys.wiki/docs/api/functions/aesDecrypt/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/aesDecrypt/#buffer "Direct link to buffer")
`Buffer`
### key[​](https://baileys.wiki/docs/api/functions/aesDecrypt/#key "Direct link to key")
`Buffer`
## Returns[​](https://baileys.wiki/docs/api/functions/aesDecrypt/#returns "Direct link to Returns")
`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/aesDecrypt.md)
[Previous Function: addTransactionCapability()](https://baileys.wiki/docs/api/functions/addTransactionCapability)[Next Function: aesDecryptCTR()](https://baileys.wiki/docs/api/functions/aesDecryptCTR)
  * [Parameters](https://baileys.wiki/docs/api/functions/aesDecrypt/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/aesDecrypt/#buffer)
    * [key](https://baileys.wiki/docs/api/functions/aesDecrypt/#key)
  * [Returns](https://baileys.wiki/docs/api/functions/aesDecrypt/#returns)
