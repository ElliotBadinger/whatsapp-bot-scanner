# Source: https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64

<!-- Scraped from https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64 -->

[Skip to main content](https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:218](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages-media.ts#L218)
gets the SHA256 of the given media message
## Parameters[​](https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64/#message "Direct link to message")
[`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
## Returns[​](https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64/#returns "Direct link to Returns")
`undefined` | `null` | `string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/mediaMessageSHA256B64.md)
[Previous Function: md5()](https://baileys.wiki/docs/api/functions/md5)[Next Function: newLTHashState()](https://baileys.wiki/docs/api/functions/newLTHashState)
  * [Parameters](https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64/#message)
  * [Returns](https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64/#returns)
