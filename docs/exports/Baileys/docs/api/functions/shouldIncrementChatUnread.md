# Source: https://baileys.wiki/docs/api/functions/shouldIncrementChatUnread

<!-- Scraped from https://baileys.wiki/docs/api/functions/shouldIncrementChatUnread -->

[Skip to main content](https://baileys.wiki/docs/api/functions/shouldIncrementChatUnread/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/process-message.ts:125](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/process-message.ts#L125)

## Parameters[​](https://baileys.wiki/docs/api/functions/shouldIncrementChatUnread/#parameters "Direct link to Parameters")

### message[​](https://baileys.wiki/docs/api/functions/shouldIncrementChatUnread/#message "Direct link to message")

[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)

## Returns[​](https://baileys.wiki/docs/api/functions/shouldIncrementChatUnread/#returns "Direct link to Returns")

`boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/shouldIncrementChatUnread.md)
[Previous Function: sha256()](https://baileys.wiki/docs/api/functions/sha256)[Next Function: signedKeyPair()](https://baileys.wiki/docs/api/functions/signedKeyPair)

- [Parameters](https://baileys.wiki/docs/api/functions/shouldIncrementChatUnread/#parameters)
  - [message](https://baileys.wiki/docs/api/functions/shouldIncrementChatUnread/#message)
- [Returns](https://baileys.wiki/docs/api/functions/shouldIncrementChatUnread/#returns)
