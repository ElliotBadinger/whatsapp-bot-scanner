# Source: https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren

<!-- Scraped from https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: getAllBinaryNodeChildren()
> **getAllBinaryNodeChildren**(`__namedParameters`): [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)[]
Defined in: [src/WABinary/generic-utils.ts:15](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/WABinary/generic-utils.ts#L15)
## Parameters[​](https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren/#__namedparameters "Direct link to __namedParameters")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
## Returns[​](https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren/#returns "Direct link to Returns")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)[]
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getAllBinaryNodeChildren.md)
[Previous Function: getAggregateVotesInPollMessage()](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage)[Next Function: getAudioDuration()](https://baileys.wiki/docs/api/functions/getAudioDuration)
  * [Parameters](https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren/#__namedparameters)
  * [Returns](https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren/#returns)
