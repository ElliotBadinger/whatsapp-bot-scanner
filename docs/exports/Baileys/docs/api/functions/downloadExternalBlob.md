# Source: https://baileys.wiki/docs/api/functions/downloadExternalBlob

<!-- Scraped from https://baileys.wiki/docs/api/functions/downloadExternalBlob -->

[Skip to main content](https://baileys.wiki/docs/api/functions/downloadExternalBlob/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/chat-utils.ts:356](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/chat-utils.ts#L356)
## Parameters[​](https://baileys.wiki/docs/api/functions/downloadExternalBlob/#parameters "Direct link to Parameters")
### blob[​](https://baileys.wiki/docs/api/functions/downloadExternalBlob/#blob "Direct link to blob")
[`IExternalBlobReference`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IExternalBlobReference)
### options[​](https://baileys.wiki/docs/api/functions/downloadExternalBlob/#options "Direct link to options")
`RequestInit`
## Returns[​](https://baileys.wiki/docs/api/functions/downloadExternalBlob/#returns "Direct link to Returns")
`Promise`<`Buffer`<`ArrayBuffer`>>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/downloadExternalBlob.md)
[Previous Function: downloadEncryptedContent()](https://baileys.wiki/docs/api/functions/downloadEncryptedContent)[Next Function: downloadExternalPatch()](https://baileys.wiki/docs/api/functions/downloadExternalPatch)
  * [Parameters](https://baileys.wiki/docs/api/functions/downloadExternalBlob/#parameters)
    * [blob](https://baileys.wiki/docs/api/functions/downloadExternalBlob/#blob)
    * [options](https://baileys.wiki/docs/api/functions/downloadExternalBlob/#options)
  * [Returns](https://baileys.wiki/docs/api/functions/downloadExternalBlob/#returns)
