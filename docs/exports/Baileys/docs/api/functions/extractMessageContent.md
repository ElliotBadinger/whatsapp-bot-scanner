...
<!-- Scraped from https://baileys.wiki/docs/api/functions/extractMessageContent -->

[Skip to main content](https://baileys.wiki/docs/api/functions/extractMessageContent/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: extractMessageContent()
> **extractMessageContent**(`content`): `undefined` | [`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
Defined in: [src/Utils/messages.ts:762](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L762)
...
## Parameters[​](https://baileys.wiki/docs/api/functions/extractMessageContent/#parameters "Direct link to Parameters")
### content[​](https://baileys.wiki/docs/api/functions/extractMessageContent/#content "Direct link to content")
`undefined` | `null` | [`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
## Returns[​](https://baileys.wiki/docs/api/functions/extractMessageContent/#returns "Direct link to Returns")
`undefined` | [`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/extractMessageContent.md)
[Previous Function: extractImageThumb()](https://baileys.wiki/docs/api/functions/extractImageThumb)[Next Function: extractSyncdPatches()](https://baileys.wiki/docs/api/functions/extractSyncdPatches)
  * [Parameters](https://baileys.wiki/docs/api/functions/extractMessageContent/#parameters)
    * [content](https://baileys.wiki/docs/api/functions/extractMessageContent/#content)
  * [Returns](https://baileys.wiki/docs/api/functions/extractMessageContent/#returns)
