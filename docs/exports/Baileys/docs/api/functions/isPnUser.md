# Source: https://baileys.wiki/docs/api/functions/isPnUser

<!-- Scraped from https://baileys.wiki/docs/api/functions/isPnUser -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isPnUser/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/jid-utils.ts:93](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L93)
is the jid a PN user
## Parameters[​](https://baileys.wiki/docs/api/functions/isPnUser/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/isPnUser/#jid "Direct link to jid")
`undefined` | `string`
## Returns[​](https://baileys.wiki/docs/api/functions/isPnUser/#returns "Direct link to Returns")
`undefined` | `boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isPnUser.md)
[Previous Function: isLidUser()](https://baileys.wiki/docs/api/functions/isLidUser)[Next Function: isRealMessage()](https://baileys.wiki/docs/api/functions/isRealMessage)
  * [Parameters](https://baileys.wiki/docs/api/functions/isPnUser/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/isPnUser/#jid)
  * [Returns](https://baileys.wiki/docs/api/functions/isPnUser/#returns)
