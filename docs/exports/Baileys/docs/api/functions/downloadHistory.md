...
<!-- Scraped from https://baileys.wiki/docs/api/functions/downloadHistory -->

[Skip to main content](https://baileys.wiki/docs/api/functions/downloadHistory/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: downloadHistory()
> **downloadHistory**(`msg`, `options`): `Promise`<[`HistorySync`](https://baileys.wiki/docs/api/namespaces/proto/classes/HistorySync)>
Defined in: [src/Utils/history.ts:12](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/history.ts#L12)
## Parameters[​](https://baileys.wiki/docs/api/functions/downloadHistory/#parameters "Direct link to Parameters")
### msg[​](https://baileys.wiki/docs/api/functions/downloadHistory/#msg "Direct link to msg")
...
### options[​](https://baileys.wiki/docs/api/functions/downloadHistory/#options "Direct link to options")
`RequestInit`
## Returns[​](https://baileys.wiki/docs/api/functions/downloadHistory/#returns "Direct link to Returns")
`Promise`<[`HistorySync`](https://baileys.wiki/docs/api/namespaces/proto/classes/HistorySync)>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/downloadHistory.md)
[Previous Function: downloadExternalPatch()](https://baileys.wiki/docs/api/functions/downloadExternalPatch)[Next Function: downloadMediaMessage()](https://baileys.wiki/docs/api/functions/downloadMediaMessage)
  * [Parameters](https://baileys.wiki/docs/api/functions/downloadHistory/#parameters)
    * [msg](https://baileys.wiki/docs/api/functions/downloadHistory/#msg)
    * [options](https://baileys.wiki/docs/api/functions/downloadHistory/#options)
  * [Returns](https://baileys.wiki/docs/api/functions/downloadHistory/#returns)
