# Source: https://baileys.wiki/docs/api/functions/prepareWAMessageMedia

<!-- Scraped from https://baileys.wiki/docs/api/functions/prepareWAMessageMedia -->

[Skip to main content](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: prepareWAMessageMedia()
> **prepareWAMessageMedia**(`message`, `options`): `Promise`<[`Message`](https://baileys.wiki/docs/api/namespaces/proto/classes/Message)>
Defined in: [src/Utils/messages.ts:116](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages.ts#L116)
## Parameters[​](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia/#message "Direct link to message")
[`AnyMediaMessageContent`](https://baileys.wiki/docs/api/type-aliases/AnyMediaMessageContent)
### options[​](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia/#options "Direct link to options")
[`MessageContentGenerationOptions`](https://baileys.wiki/docs/api/type-aliases/MessageContentGenerationOptions)
## Returns[​](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia/#returns "Direct link to Returns")
`Promise`<[`Message`](https://baileys.wiki/docs/api/namespaces/proto/classes/Message)>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/prepareWAMessageMedia.md)
[Previous Function: prepareDisappearingMessageSettingContent()](https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent)[Next Function: processHistoryMessage()](https://baileys.wiki/docs/api/functions/processHistoryMessage)
  * [Parameters](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia/#message)
    * [options](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia/#options)
  * [Returns](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia/#returns)
