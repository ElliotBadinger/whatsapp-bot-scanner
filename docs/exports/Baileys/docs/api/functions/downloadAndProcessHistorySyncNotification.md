...
<!-- Scraped from https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification -->

[Skip to main content](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification/#__docusaurus_skipToContent_fallback)
...
> **downloadAndProcessHistorySyncNotification**(`msg`, `options`): `Promise`<{ `chats`: [`Chat`](https://baileys.wiki/docs/api/type-aliases/Chat)[]; `contacts`: [`Contact`](https://baileys.wiki/docs/api/interfaces/Contact)[]; `messages`: [`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)[]; `progress`: `undefined` | `null` | `number`; `syncType`: `undefined` | `null` | [`HistorySyncType`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/HistorySync/enumerations/HistorySyncType); }>
> Defined in: [src/Utils/history.ts:95](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/history.ts#L95)

## Parameters[​](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification/#parameters "Direct link to Parameters")

### msg[​](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification/#msg "Direct link to msg")

[`IHistorySyncNotification`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IHistorySyncNotification)

### options[​](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification/#options "Direct link to options")

`RequestInit`

## Returns[​](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification/#returns "Direct link to Returns")

`Promise`<{ `chats`: [`Chat`](https://baileys.wiki/docs/api/type-aliases/Chat)[]; `contacts`: [`Contact`](https://baileys.wiki/docs/api/interfaces/Contact)[]; `messages`: [`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)[]; `progress`: `undefined` | `null` | `number`; `syncType`: `undefined` | `null` | [`HistorySyncType`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/HistorySync/enumerations/HistorySyncType); }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/downloadAndProcessHistorySyncNotification.md)
[Previous Function: derivePairingCodeKey()](https://baileys.wiki/docs/api/functions/derivePairingCodeKey)[Next Function: downloadContentFromMessage()](https://baileys.wiki/docs/api/functions/downloadContentFromMessage)

- [Parameters](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification/#parameters)
  - [msg](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification/#msg)
  - [options](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification/#options)
- [Returns](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification/#returns)
