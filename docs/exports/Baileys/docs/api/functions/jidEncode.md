# Source: https://baileys.wiki/docs/api/functions/jidEncode

<!-- Scraped from https://baileys.wiki/docs/api/functions/jidEncode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/jidEncode/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/jid-utils.ts:51](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L51)
## Parameters[​](https://baileys.wiki/docs/api/functions/jidEncode/#parameters "Direct link to Parameters")
### user[​](https://baileys.wiki/docs/api/functions/jidEncode/#user "Direct link to user")
`null` | `string` | `number`
### server[​](https://baileys.wiki/docs/api/functions/jidEncode/#server "Direct link to server")
[`JidServer`](https://baileys.wiki/docs/api/type-aliases/JidServer)
### device?[​](https://baileys.wiki/docs/api/functions/jidEncode/#device "Direct link to device?")
`number`
### agent?[​](https://baileys.wiki/docs/api/functions/jidEncode/#agent "Direct link to agent?")
`number`
## Returns[​](https://baileys.wiki/docs/api/functions/jidEncode/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/jidEncode.md)
[Previous Function: jidDecode()](https://baileys.wiki/docs/api/functions/jidDecode)[Next Function: jidNormalizedUser()](https://baileys.wiki/docs/api/functions/jidNormalizedUser)
  * [Parameters](https://baileys.wiki/docs/api/functions/jidEncode/#parameters)
    * [user](https://baileys.wiki/docs/api/functions/jidEncode/#user)
    * [server](https://baileys.wiki/docs/api/functions/jidEncode/#server)
    * [device?](https://baileys.wiki/docs/api/functions/jidEncode/#device)
    * [agent?](https://baileys.wiki/docs/api/functions/jidEncode/#agent)
  * [Returns](https://baileys.wiki/docs/api/functions/jidEncode/#returns)
