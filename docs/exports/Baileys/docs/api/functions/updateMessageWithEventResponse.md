# Source: https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse

<!-- Scraped from https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse -->

[Skip to main content](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages.ts:851](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L851)
Update the message with a new event response
## Parameters[​](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse/#parameters "Direct link to Parameters")
### msg[​](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse/#msg "Direct link to msg")
`Pick`<[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage), `"eventResponses"`>
### update[​](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse/#update "Direct link to update")
[`IEventResponse`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IEventResponse)
## Returns[​](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse/#returns "Direct link to Returns")
`void`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/updateMessageWithEventResponse.md)
[Previous Function: unpadRandomMax16()](https://baileys.wiki/docs/api/functions/unpadRandomMax16)[Next Function: updateMessageWithPollUpdate()](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate)
  * [Parameters](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse/#parameters)
    * [msg](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse/#msg)
    * [update](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse/#update)
  * [Returns](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse/#returns)
