# Source: https://baileys.wiki/docs/api/functions/assertMediaContent

<!-- Scraped from https://baileys.wiki/docs/api/functions/assertMediaContent -->

[Skip to main content](https://baileys.wiki/docs/api/functions/assertMediaContent/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: assertMediaContent()
> **assertMediaContent**(`content`): [`IVideoMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IVideoMessage) | [`IImageMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IImageMessage) | [`IAudioMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IAudioMessage) | [`IDocumentMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IDocumentMessage) | [`IStickerMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IStickerMessage)
Defined in: [src/Utils/messages.ts:1049](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L1049)
Checks whether the given message is a media message; if it is returns the inner content
## Parameters[​](https://baileys.wiki/docs/api/functions/assertMediaContent/#parameters "Direct link to Parameters")
### content[​](https://baileys.wiki/docs/api/functions/assertMediaContent/#content "Direct link to content")
`undefined` | `null` | [`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
## Returns[​](https://baileys.wiki/docs/api/functions/assertMediaContent/#returns "Direct link to Returns")
[`IVideoMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IVideoMessage) | [`IImageMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IImageMessage) | [`IAudioMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IAudioMessage) | [`IDocumentMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IDocumentMessage) | [`IStickerMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IStickerMessage)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/assertMediaContent.md)
[Previous Function: areJidsSameUser()](https://baileys.wiki/docs/api/functions/areJidsSameUser)[Next Function: assertNodeErrorFree()](https://baileys.wiki/docs/api/functions/assertNodeErrorFree)
  * [Parameters](https://baileys.wiki/docs/api/functions/assertMediaContent/#parameters)
    * [content](https://baileys.wiki/docs/api/functions/assertMediaContent/#content)
  * [Returns](https://baileys.wiki/docs/api/functions/assertMediaContent/#returns)
