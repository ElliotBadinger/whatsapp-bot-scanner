# Source: https://baileys.wiki/docs/api/functions/unixTimestampSeconds

<!-- Scraped from https://baileys.wiki/docs/api/functions/unixTimestampSeconds -->

[Skip to main content](https://baileys.wiki/docs/api/functions/unixTimestampSeconds/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:99](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/generics.ts#L99)
unix timestamp of a date in seconds
## Parameters[​](https://baileys.wiki/docs/api/functions/unixTimestampSeconds/#parameters "Direct link to Parameters")
### date[​](https://baileys.wiki/docs/api/functions/unixTimestampSeconds/#date "Direct link to date")
`Date` = `...`
## Returns[​](https://baileys.wiki/docs/api/functions/unixTimestampSeconds/#returns "Direct link to Returns")
`number`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/unixTimestampSeconds.md)
[Previous Function: trimUndefined()](https://baileys.wiki/docs/api/functions/trimUndefined)[Next Function: unpadRandomMax16()](https://baileys.wiki/docs/api/functions/unpadRandomMax16)
  * [Parameters](https://baileys.wiki/docs/api/functions/unixTimestampSeconds/#parameters)
    * [date](https://baileys.wiki/docs/api/functions/unixTimestampSeconds/#date)
  * [Returns](https://baileys.wiki/docs/api/functions/unixTimestampSeconds/#returns)
