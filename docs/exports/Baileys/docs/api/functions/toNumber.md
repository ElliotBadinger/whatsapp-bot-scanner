# Source: https://baileys.wiki/docs/api/functions/toNumber

<!-- Scraped from https://baileys.wiki/docs/api/functions/toNumber -->

[Skip to main content](https://baileys.wiki/docs/api/functions/toNumber/#__docusaurus_skipToContent_fallback)
...
> **toNumber**(`t`): `number`
> Defined in: [src/Utils/generics.ts:95](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L95)

## Parameters[​](https://baileys.wiki/docs/api/functions/toNumber/#parameters "Direct link to Parameters")

### t[​](https://baileys.wiki/docs/api/functions/toNumber/#t "Direct link to t")

`undefined` | `null` | `number` | `Long`

## Returns[​](https://baileys.wiki/docs/api/functions/toNumber/#returns "Direct link to Returns")

`number`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/toNumber.md)
[Previous Function: toBuffer()](https://baileys.wiki/docs/api/functions/toBuffer)[Next Function: toReadable()](https://baileys.wiki/docs/api/functions/toReadable)

- [Parameters](https://baileys.wiki/docs/api/functions/toNumber/#parameters)
  - [t](https://baileys.wiki/docs/api/functions/toNumber/#t)
- [Returns](https://baileys.wiki/docs/api/functions/toNumber/#returns)
