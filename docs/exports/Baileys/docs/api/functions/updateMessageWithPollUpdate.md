# Source: https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate

<!-- Scraped from https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate -->

[Skip to main content](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages.ts:839](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L839)
Update the message with a new poll update
## Parameters[​](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate/#parameters "Direct link to Parameters")
### msg[​](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate/#msg "Direct link to msg")
`Pick`<[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage), `"pollUpdates"`>
### update[​](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate/#update "Direct link to update")
[`IPollUpdate`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IPollUpdate)
## Returns[​](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate/#returns "Direct link to Returns")
`void`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/updateMessageWithPollUpdate.md)
[Previous Function: updateMessageWithEventResponse()](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse)[Next Function: updateMessageWithReaction()](https://baileys.wiki/docs/api/functions/updateMessageWithReaction)
  * [Parameters](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate/#parameters)
    * [msg](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate/#msg)
    * [update](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate/#update)
  * [Returns](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate/#returns)
