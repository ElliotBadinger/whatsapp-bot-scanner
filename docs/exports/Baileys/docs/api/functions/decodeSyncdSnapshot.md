# Source: https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot

<!-- Scraped from https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#__docusaurus_skipToContent_fallback)
...
> **decodeSyncdSnapshot**(`name`, `snapshot`, `getAppStateSyncKey`, `minimumVersionNumber`, `validateMacs`): `Promise`<{ `mutationMap`: [`ChatMutationMap`](https://baileys.wiki/docs/api/type-aliases/ChatMutationMap); `state`: [`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState); }>
> Defined in: [src/Utils/chat-utils.ts:372](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/chat-utils.ts#L372)

## Parameters[​](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#parameters "Direct link to Parameters")

### name[​](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#name "Direct link to name")

`"critical_unblock_low"` | `"regular_high"` | `"regular_low"` | `"critical_block"` | `"regular"`

### snapshot[​](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#snapshot "Direct link to snapshot")

[`ISyncdSnapshot`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdSnapshot)

### getAppStateSyncKey[​](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#getappstatesynckey "Direct link to getAppStateSyncKey")

`FetchAppStateSyncKey`

### minimumVersionNumber[​](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#minimumversionnumber "Direct link to minimumVersionNumber")

`undefined` | `number`

### validateMacs[​](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#validatemacs "Direct link to validateMacs")

`boolean` = `true`

## Returns[​](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#returns "Direct link to Returns")
...
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decodeSyncdSnapshot.md)
[Previous Function: decodeSyncdPatch()](https://baileys.wiki/docs/api/functions/decodeSyncdPatch)[Next Function: decompressingIfRequired()](https://baileys.wiki/docs/api/functions/decompressingIfRequired)

- [Parameters](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#parameters)
  - [name](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#name)
  - [snapshot](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#snapshot)
  - [getAppStateSyncKey](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#getappstatesynckey)
  - [minimumVersionNumber](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#minimumversionnumber)
  - [validateMacs](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#validatemacs)
- [Returns](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot/#returns)
