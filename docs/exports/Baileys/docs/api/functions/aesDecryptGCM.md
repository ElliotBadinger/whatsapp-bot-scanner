# Source: https://baileys.wiki/docs/api/functions/aesDecryptGCM

<!-- Scraped from https://baileys.wiki/docs/api/functions/aesDecryptGCM -->

[Skip to main content](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/crypto.ts:62](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/crypto.ts#L62)
decrypt AES 256 GCM; where the auth tag is suffixed to the ciphertext
## Parameters[​](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#parameters "Direct link to Parameters")
### ciphertext[​](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#ciphertext "Direct link to ciphertext")
`Uint8Array`
### key[​](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#key "Direct link to key")
`Uint8Array`
### iv[​](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#iv "Direct link to iv")
`Uint8Array`
### additionalData[​](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#additionaldata "Direct link to additionalData")
`Uint8Array`
## Returns[​](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#returns "Direct link to Returns")
`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/aesDecryptGCM.md)
[Previous Function: aesDecryptCTR()](https://baileys.wiki/docs/api/functions/aesDecryptCTR)[Next Function: aesDecryptWithIV()](https://baileys.wiki/docs/api/functions/aesDecryptWithIV)
  * [Parameters](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#parameters)
    * [ciphertext](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#ciphertext)
    * [key](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#key)
    * [iv](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#iv)
    * [additionalData](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#additionaldata)
  * [Returns](https://baileys.wiki/docs/api/functions/aesDecryptGCM/#returns)
