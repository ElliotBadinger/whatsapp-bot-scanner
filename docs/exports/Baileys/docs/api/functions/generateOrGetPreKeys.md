# Source: https://baileys.wiki/docs/api/functions/generateOrGetPreKeys

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateOrGetPreKeys -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/signal.ts:53](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/signal.ts#L53)

## Parameters[​](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#parameters "Direct link to Parameters")

### creds[​](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#creds "Direct link to creds")

[`AuthenticationCreds`](https://baileys.wiki/docs/api/type-aliases/AuthenticationCreds)

### range[​](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#range "Direct link to range")

`number`

## Returns[​](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#returns "Direct link to Returns")

`object`

### lastPreKeyId[​](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#lastprekeyid "Direct link to lastPreKeyId")

> **lastPreKeyId** : `number`

### newPreKeys[​](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#newprekeys "Direct link to newPreKeys")

> **newPreKeys** : `object`

#### Index Signature[​](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#index-signature "Direct link to Index Signature")

[`id`: `number`]: [`KeyPair`](https://baileys.wiki/docs/api/type-aliases/KeyPair)

### preKeysRange[​](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#prekeysrange "Direct link to preKeysRange")

> **preKeysRange** : readonly [`number`, `number`]
> [](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateOrGetPreKeys.md)
> [Previous Function: generateMessageIDV2()](https://baileys.wiki/docs/api/functions/generateMessageIDV2)[Next Function: generateParticipantHashV2()](https://baileys.wiki/docs/api/functions/generateParticipantHashV2)

- [Parameters](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#parameters)
  - [creds](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#creds)
  - [range](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#range)
- [Returns](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#returns)
  - [lastPreKeyId](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#lastprekeyid)
  - [newPreKeys](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#newprekeys)
  - [preKeysRange](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys/#prekeysrange)
