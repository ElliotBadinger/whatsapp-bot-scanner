...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#**namedparameters "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#parameters)
  ...
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#__namedparameters)
