# Source: https://baileys.wiki/docs/api/functions/configureSuccessfulPairing

<!-- Scraped from https://baileys.wiki/docs/api/functions/configureSuccessfulPairing -->

[Skip to main content](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/validate-connection.ts:147](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/validate-connection.ts#L147)
## Parameters[​](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#parameters "Direct link to Parameters")
### stanza[​](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#stanza "Direct link to stanza")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
### __namedParameters[​](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#__namedparameters "Direct link to __namedParameters")
`Pick`<[`AuthenticationCreds`](https://baileys.wiki/docs/api/type-aliases/AuthenticationCreds), `"signedIdentityKey"` | `"advSecretKey"` | `"signalIdentities"`>
## Returns[​](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#returns "Direct link to Returns")
`object`
### creds[​](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#creds "Direct link to creds")
> **creds** : `Partial`<[`AuthenticationCreds`](https://baileys.wiki/docs/api/type-aliases/AuthenticationCreds)> = `authUpdate`
### reply[​](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#reply "Direct link to reply")
> **reply** : [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/configureSuccessfulPairing.md)
[Previous Function: cleanMessage()](https://baileys.wiki/docs/api/functions/cleanMessage)[Next Function: createSignalIdentity()](https://baileys.wiki/docs/api/functions/createSignalIdentity)
  * [Parameters](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#parameters)
    * [stanza](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#stanza)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#__namedparameters)
  * [Returns](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#returns)
    * [creds](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#creds)
    * [reply](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing/#reply)
