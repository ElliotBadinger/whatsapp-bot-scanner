# Source: https://baileys.wiki/docs/api/functions/generateSignalPubKey

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateSignalPubKey -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateSignalPubKey/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/crypto.ts:10](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/crypto.ts#L10)
prefix version byte to the pub keys, required for some curve crypto functions
## Parameters[​](https://baileys.wiki/docs/api/functions/generateSignalPubKey/#parameters "Direct link to Parameters")
### pubKey[​](https://baileys.wiki/docs/api/functions/generateSignalPubKey/#pubkey "Direct link to pubKey")
`Uint8Array`<`ArrayBufferLike`> | `Buffer`<`ArrayBufferLike`>
## Returns[​](https://baileys.wiki/docs/api/functions/generateSignalPubKey/#returns "Direct link to Returns")
`Uint8Array`<`ArrayBufferLike`> | `Buffer`<`ArrayBufferLike`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateSignalPubKey.md)
[Previous Function: generateRegistrationNode()](https://baileys.wiki/docs/api/functions/generateRegistrationNode)[Next Function: generateThumbnail()](https://baileys.wiki/docs/api/functions/generateThumbnail)
  * [Parameters](https://baileys.wiki/docs/api/functions/generateSignalPubKey/#parameters)
    * [pubKey](https://baileys.wiki/docs/api/functions/generateSignalPubKey/#pubkey)
  * [Returns](https://baileys.wiki/docs/api/functions/generateSignalPubKey/#returns)
