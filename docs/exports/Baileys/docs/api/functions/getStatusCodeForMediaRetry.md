# Source: https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry

<!-- Scraped from https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: getStatusCodeForMediaRetry()


On this page
# Function: getStatusCodeForMediaRetry()
> **getStatusCodeForMediaRetry**(`code`): `200` | `404` | `412` | `418`
Defined in: [src/Utils/messages-media.ts:812](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages-media.ts#L812)
## Parameters[​](https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry/#parameters "Direct link to Parameters")
### code[​](https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry/#code "Direct link to code")
`number`
## Returns[​](https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry/#returns "Direct link to Returns")
`200` | `404` | `412` | `418`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getStatusCodeForMediaRetry.md)
[Previous Function: getServerFromDomainType()](https://baileys.wiki/docs/api/functions/getServerFromDomainType)[Next Function: getStatusFromReceiptType()](https://baileys.wiki/docs/api/functions/getStatusFromReceiptType)
  * [Parameters](https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry/#parameters)
    * [code](https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry/#code)
  * [Returns](https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry/#returns)
