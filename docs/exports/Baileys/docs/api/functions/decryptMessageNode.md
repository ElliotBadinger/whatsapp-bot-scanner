# Source: https://baileys.wiki/docs/api/functions/decryptMessageNode

<!-- Scraped from https://baileys.wiki/docs/api/functions/decryptMessageNode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decryptMessageNode/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/decode-wa-message.ts:226](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/decode-wa-message.ts#L226)

## Parameters[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#parameters "Direct link to Parameters")

### stanza[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#stanza "Direct link to stanza")

[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)

### meId[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#meid "Direct link to meId")

`string`

### meLid[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#melid "Direct link to meLid")

`string`

### repository[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#repository "Direct link to repository")

[`SignalRepositoryWithLIDStore`](https://baileys.wiki/docs/api/interfaces/SignalRepositoryWithLIDStore)

### logger[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#logger "Direct link to logger")

`ILogger`

## Returns[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#returns "Direct link to Returns")

`object`

### author[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#author "Direct link to author")

> **author** : `string`

### category[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#category "Direct link to category")

> **category** : `undefined` | `string` = `stanza.attrs.category`

### fullMessage[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#fullmessage "Direct link to fullMessage")

> **fullMessage** : [`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)

### decrypt()[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#decrypt "Direct link to decrypt()")

#### Returns[​](https://baileys.wiki/docs/api/functions/decryptMessageNode/#returns-1 "Direct link to Returns")

`Promise`<`void`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decryptMessageNode.md)
[Previous Function: decryptMediaRetryData()](https://baileys.wiki/docs/api/functions/decryptMediaRetryData)[Next Function: decryptPollVote()](https://baileys.wiki/docs/api/functions/decryptPollVote)

- [Parameters](https://baileys.wiki/docs/api/functions/decryptMessageNode/#parameters)
  - [stanza](https://baileys.wiki/docs/api/functions/decryptMessageNode/#stanza)
  - [meId](https://baileys.wiki/docs/api/functions/decryptMessageNode/#meid)
  - [meLid](https://baileys.wiki/docs/api/functions/decryptMessageNode/#melid)
  - [repository](https://baileys.wiki/docs/api/functions/decryptMessageNode/#repository)
  - [logger](https://baileys.wiki/docs/api/functions/decryptMessageNode/#logger)
- [Returns](https://baileys.wiki/docs/api/functions/decryptMessageNode/#returns)
  - [author](https://baileys.wiki/docs/api/functions/decryptMessageNode/#author)
  - [category](https://baileys.wiki/docs/api/functions/decryptMessageNode/#category)
  - [fullMessage](https://baileys.wiki/docs/api/functions/decryptMessageNode/#fullmessage)
  - [decrypt()](https://baileys.wiki/docs/api/functions/decryptMessageNode/#decrypt)
