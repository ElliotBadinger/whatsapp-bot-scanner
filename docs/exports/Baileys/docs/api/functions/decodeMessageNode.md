# Source: https://baileys.wiki/docs/api/functions/decodeMessageNode

<!-- Scraped from https://baileys.wiki/docs/api/functions/decodeMessageNode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decodeMessageNode/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/decode-wa-message.ts:122](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/decode-wa-message.ts#L122)
Decode the received node as a message.
## Parameters[​](https://baileys.wiki/docs/api/functions/decodeMessageNode/#parameters "Direct link to Parameters")
### stanza[​](https://baileys.wiki/docs/api/functions/decodeMessageNode/#stanza "Direct link to stanza")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
### meId[​](https://baileys.wiki/docs/api/functions/decodeMessageNode/#meid "Direct link to meId")
`string`
### meLid[​](https://baileys.wiki/docs/api/functions/decodeMessageNode/#melid "Direct link to meLid")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/decodeMessageNode/#returns "Direct link to Returns")
`object`
### author[​](https://baileys.wiki/docs/api/functions/decodeMessageNode/#author "Direct link to author")
> **author** : `string`
### fullMessage[​](https://baileys.wiki/docs/api/functions/decodeMessageNode/#fullmessage "Direct link to fullMessage")
> **fullMessage** : [`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)
### sender[​](https://baileys.wiki/docs/api/functions/decodeMessageNode/#sender "Direct link to sender")
> **sender** : `string`
## Note[​](https://baileys.wiki/docs/api/functions/decodeMessageNode/#note "Direct link to Note")
this will only parse the message, not decrypt it
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decodeMessageNode.md)
[Previous Function: decodeMediaRetryNode()](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode)[Next Function: decodePatches()](https://baileys.wiki/docs/api/functions/decodePatches)
  * [Parameters](https://baileys.wiki/docs/api/functions/decodeMessageNode/#parameters)
    * [stanza](https://baileys.wiki/docs/api/functions/decodeMessageNode/#stanza)
    * [meId](https://baileys.wiki/docs/api/functions/decodeMessageNode/#meid)
    * [meLid](https://baileys.wiki/docs/api/functions/decodeMessageNode/#melid)
  * [Returns](https://baileys.wiki/docs/api/functions/decodeMessageNode/#returns)
    * [author](https://baileys.wiki/docs/api/functions/decodeMessageNode/#author)
    * [fullMessage](https://baileys.wiki/docs/api/functions/decodeMessageNode/#fullmessage)
    * [sender](https://baileys.wiki/docs/api/functions/decodeMessageNode/#sender)
  * [Note](https://baileys.wiki/docs/api/functions/decodeMessageNode/#note)
