# Source: https://baileys.wiki/docs/api/functions/getMediaKeys

<!-- Scraped from https://baileys.wiki/docs/api/functions/getMediaKeys -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getMediaKeys/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: getMediaKeys()
> **getMediaKeys**(`buffer`, `mediaType`): `Promise`<[`MediaDecryptionKeyInfo`](https://baileys.wiki/docs/api/type-aliases/MediaDecryptionKeyInfo)>
Defined in: [src/Utils/messages-media.ts:95](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages-media.ts#L95)
generates all the keys required to encrypt/decrypt & sign a media message
## Parameters[​](https://baileys.wiki/docs/api/functions/getMediaKeys/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/getMediaKeys/#buffer "Direct link to buffer")
`undefined` | `null` | `string` | `Uint8Array`<`ArrayBufferLike`>
### mediaType[​](https://baileys.wiki/docs/api/functions/getMediaKeys/#mediatype "Direct link to mediaType")
...
## Returns[​](https://baileys.wiki/docs/api/functions/getMediaKeys/#returns "Direct link to Returns")
`Promise`<[`MediaDecryptionKeyInfo`](https://baileys.wiki/docs/api/type-aliases/MediaDecryptionKeyInfo)>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getMediaKeys.md)
[Previous Function: getKeyAuthor()](https://baileys.wiki/docs/api/functions/getKeyAuthor)[Next Function: getNextPreKeys()](https://baileys.wiki/docs/api/functions/getNextPreKeys)
  * [Parameters](https://baileys.wiki/docs/api/functions/getMediaKeys/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/getMediaKeys/#buffer)
    * [mediaType](https://baileys.wiki/docs/api/functions/getMediaKeys/#mediatype)
  * [Returns](https://baileys.wiki/docs/api/functions/getMediaKeys/#returns)
