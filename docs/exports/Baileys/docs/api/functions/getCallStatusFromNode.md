# Source: https://baileys.wiki/docs/api/functions/getCallStatusFromNode

<!-- Scraped from https://baileys.wiki/docs/api/functions/getCallStatusFromNode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getCallStatusFromNode/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: getCallStatusFromNode()
> **getCallStatusFromNode**(`__namedParameters`): [`WACallUpdateType`](https://baileys.wiki/docs/api/type-aliases/WACallUpdateType)
Defined in: [src/Utils/generics.ts:374](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/generics.ts#L374)
## Parameters[​](https://baileys.wiki/docs/api/functions/getCallStatusFromNode/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/getCallStatusFromNode/#__namedparameters "Direct link to __namedParameters")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
## Returns[​](https://baileys.wiki/docs/api/functions/getCallStatusFromNode/#returns "Direct link to Returns")
[`WACallUpdateType`](https://baileys.wiki/docs/api/type-aliases/WACallUpdateType)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getCallStatusFromNode.md)
[Previous Function: getBinaryNodeMessages()](https://baileys.wiki/docs/api/functions/getBinaryNodeMessages)[Next Function: getChatId()](https://baileys.wiki/docs/api/functions/getChatId)
  * [Parameters](https://baileys.wiki/docs/api/functions/getCallStatusFromNode/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/getCallStatusFromNode/#__namedparameters)
  * [Returns](https://baileys.wiki/docs/api/functions/getCallStatusFromNode/#returns)
