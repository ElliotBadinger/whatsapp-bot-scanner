...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/getCallStatusFromNode/#**namedparameters "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/getCallStatusFromNode/#parameters)
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/getCallStatusFromNode/#__namedparameters)
