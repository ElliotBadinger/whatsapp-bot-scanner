# Source: https://baileys.wiki/docs/api/functions/decompressingIfRequired

<!-- Scraped from https://baileys.wiki/docs/api/functions/decompressingIfRequired -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decompressingIfRequired/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/decode.ts:9](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/decode.ts#L9)
## Parameters[​](https://baileys.wiki/docs/api/functions/decompressingIfRequired/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/decompressingIfRequired/#buffer "Direct link to buffer")
`Buffer`
## Returns[​](https://baileys.wiki/docs/api/functions/decompressingIfRequired/#returns "Direct link to Returns")
`Promise`<`Buffer`<`ArrayBufferLike`>>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decompressingIfRequired.md)
[Previous Function: decodeSyncdSnapshot()](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot)[Next Function: decryptEventResponse()](https://baileys.wiki/docs/api/functions/decryptEventResponse)
  * [Parameters](https://baileys.wiki/docs/api/functions/decompressingIfRequired/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/decompressingIfRequired/#buffer)
  * [Returns](https://baileys.wiki/docs/api/functions/decompressingIfRequired/#returns)
