# Source: https://baileys.wiki/docs/api/functions/getNextPreKeysNode

<!-- Scraped from https://baileys.wiki/docs/api/functions/getNextPreKeysNode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getNextPreKeysNode/#__docusaurus_skipToContent_fallback)
...
> **getNextPreKeysNode**(`state`, `count`): `Promise`<{ `node`: [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode); `update`: `Partial`<[`AuthenticationCreds`](https://baileys.wiki/docs/api/type-aliases/AuthenticationCreds)>; }>
> Defined in: [src/Utils/signal.ts:193](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/signal.ts#L193)

## Parameters[​](https://baileys.wiki/docs/api/functions/getNextPreKeysNode/#parameters "Direct link to Parameters")

### state[​](https://baileys.wiki/docs/api/functions/getNextPreKeysNode/#state "Direct link to state")

[`AuthenticationState`](https://baileys.wiki/docs/api/type-aliases/AuthenticationState)

### count[​](https://baileys.wiki/docs/api/functions/getNextPreKeysNode/#count "Direct link to count")

`number`

## Returns[​](https://baileys.wiki/docs/api/functions/getNextPreKeysNode/#returns "Direct link to Returns")

`Promise`<{ `node`: [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode); `update`: `Partial`<[`AuthenticationCreds`](https://baileys.wiki/docs/api/type-aliases/AuthenticationCreds)>; }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getNextPreKeysNode.md)
[Previous Function: getNextPreKeys()](https://baileys.wiki/docs/api/functions/getNextPreKeys)[Next Function: getPlatformId()](https://baileys.wiki/docs/api/functions/getPlatformId)

- [Parameters](https://baileys.wiki/docs/api/functions/getNextPreKeysNode/#parameters)
  - [state](https://baileys.wiki/docs/api/functions/getNextPreKeysNode/#state)
  - [count](https://baileys.wiki/docs/api/functions/getNextPreKeysNode/#count)
- [Returns](https://baileys.wiki/docs/api/functions/getNextPreKeysNode/#returns)
