# Source: https://baileys.wiki/docs/api/functions/isJidGroup

<!-- Scraped from https://baileys.wiki/docs/api/functions/isJidGroup -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isJidGroup/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/WABinary/jid-utils.ts:99](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L99)
> is the jid a group

## Parameters[​](https://baileys.wiki/docs/api/functions/isJidGroup/#parameters "Direct link to Parameters")

### jid[​](https://baileys.wiki/docs/api/functions/isJidGroup/#jid "Direct link to jid")

`undefined` | `string`

## Returns[​](https://baileys.wiki/docs/api/functions/isJidGroup/#returns "Direct link to Returns")

`undefined` | `boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isJidGroup.md)
[Previous Function: isJidBroadcast()](https://baileys.wiki/docs/api/functions/isJidBroadcast)[Next Function: isJidMetaAI()](https://baileys.wiki/docs/api/functions/isJidMetaAI)

- [Parameters](https://baileys.wiki/docs/api/functions/isJidGroup/#parameters)
  - [jid](https://baileys.wiki/docs/api/functions/isJidGroup/#jid)
- [Returns](https://baileys.wiki/docs/api/functions/isJidGroup/#returns)
