# Source: https://baileys.wiki/docs/api/functions/isJidNewsletter

<!-- Scraped from https://baileys.wiki/docs/api/functions/isJidNewsletter -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isJidNewsletter/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/jid-utils.ts:103](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L103)
is the jid a newsletter
## Parameters[​](https://baileys.wiki/docs/api/functions/isJidNewsletter/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/isJidNewsletter/#jid "Direct link to jid")
`undefined` | `string`
## Returns[​](https://baileys.wiki/docs/api/functions/isJidNewsletter/#returns "Direct link to Returns")
`undefined` | `boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isJidNewsletter.md)
[Previous Function: isJidMetaAI()](https://baileys.wiki/docs/api/functions/isJidMetaAI)[Next Function: isJidStatusBroadcast()](https://baileys.wiki/docs/api/functions/isJidStatusBroadcast)
  * [Parameters](https://baileys.wiki/docs/api/functions/isJidNewsletter/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/isJidNewsletter/#jid)
  * [Returns](https://baileys.wiki/docs/api/functions/isJidNewsletter/#returns)
