# Source: https://baileys.wiki/docs/api/functions/getUrlInfo

<!-- Scraped from https://baileys.wiki/docs/api/functions/getUrlInfo -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getUrlInfo/#__docusaurus_skipToContent_fallback)
...
> **getUrlInfo**(`text`, `opts`): `Promise`<`undefined` | [`WAUrlInfo`](https://baileys.wiki/docs/api/interfaces/WAUrlInfo)>
> Defined in: [src/Utils/link-preview.ts:33](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/link-preview.ts#L33)
...
## Parameters[​](https://baileys.wiki/docs/api/functions/getUrlInfo/#parameters "Direct link to Parameters")

### text[​](https://baileys.wiki/docs/api/functions/getUrlInfo/#text "Direct link to text")

`string`
first matched URL in text

### opts[​](https://baileys.wiki/docs/api/functions/getUrlInfo/#opts "Direct link to opts")

[`URLGenerationOptions`](https://baileys.wiki/docs/api/type-aliases/URLGenerationOptions) = `...`

## Returns[​](https://baileys.wiki/docs/api/functions/getUrlInfo/#returns "Direct link to Returns")
...
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getUrlInfo.md)
[Previous Function: getUrlFromDirectPath()](https://baileys.wiki/docs/api/functions/getUrlFromDirectPath)[Next Function: getWAUploadToServer()](https://baileys.wiki/docs/api/functions/getWAUploadToServer)

- [Parameters](https://baileys.wiki/docs/api/functions/getUrlInfo/#parameters)
  - [text](https://baileys.wiki/docs/api/functions/getUrlInfo/#text)
  - [opts](https://baileys.wiki/docs/api/functions/getUrlInfo/#opts)
- [Returns](https://baileys.wiki/docs/api/functions/getUrlInfo/#returns)
