# Source: https://baileys.wiki/docs/api/functions/getBinaryNodeChild

<!-- Scraped from https://baileys.wiki/docs/api/functions/getBinaryNodeChild -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getBinaryNodeChild/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: getBinaryNodeChild()
> **getBinaryNodeChild**(`node`, `childTag`): `undefined` | [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
Defined in: [src/WABinary/generic-utils.ts:23](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/generic-utils.ts#L23)
## Parameters[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChild/#parameters "Direct link to Parameters")
### node[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChild/#node "Direct link to node")
`undefined` | [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
### childTag[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChild/#childtag "Direct link to childTag")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChild/#returns "Direct link to Returns")
`undefined` | [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getBinaryNodeChild.md)
[Previous Function: getAudioWaveform()](https://baileys.wiki/docs/api/functions/getAudioWaveform)[Next Function: getBinaryNodeChildBuffer()](https://baileys.wiki/docs/api/functions/getBinaryNodeChildBuffer)
  * [Parameters](https://baileys.wiki/docs/api/functions/getBinaryNodeChild/#parameters)
    * [node](https://baileys.wiki/docs/api/functions/getBinaryNodeChild/#node)
    * [childTag](https://baileys.wiki/docs/api/functions/getBinaryNodeChild/#childtag)
  * [Returns](https://baileys.wiki/docs/api/functions/getBinaryNodeChild/#returns)
