# Source: https://baileys.wiki/docs/api/functions/updateMessageWithReaction

<!-- Scraped from https://baileys.wiki/docs/api/functions/updateMessageWithReaction -->

[Skip to main content](https://baileys.wiki/docs/api/functions/updateMessageWithReaction/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages.ts:829](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L829)
Update the message with a new reaction
## Parameters[​](https://baileys.wiki/docs/api/functions/updateMessageWithReaction/#parameters "Direct link to Parameters")
### msg[​](https://baileys.wiki/docs/api/functions/updateMessageWithReaction/#msg "Direct link to msg")
`Pick`<[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage), `"reactions"`>
### reaction[​](https://baileys.wiki/docs/api/functions/updateMessageWithReaction/#reaction "Direct link to reaction")
[`IReaction`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IReaction)
## Returns[​](https://baileys.wiki/docs/api/functions/updateMessageWithReaction/#returns "Direct link to Returns")
`void`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/updateMessageWithReaction.md)
[Previous Function: updateMessageWithPollUpdate()](https://baileys.wiki/docs/api/functions/updateMessageWithPollUpdate)[Next Function: updateMessageWithReceipt()](https://baileys.wiki/docs/api/functions/updateMessageWithReceipt)
  * [Parameters](https://baileys.wiki/docs/api/functions/updateMessageWithReaction/#parameters)
    * [msg](https://baileys.wiki/docs/api/functions/updateMessageWithReaction/#msg)
    * [reaction](https://baileys.wiki/docs/api/functions/updateMessageWithReaction/#reaction)
  * [Returns](https://baileys.wiki/docs/api/functions/updateMessageWithReaction/#returns)
