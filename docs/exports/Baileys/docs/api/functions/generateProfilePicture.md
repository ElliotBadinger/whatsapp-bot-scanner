# Source: https://baileys.wiki/docs/api/functions/generateProfilePicture

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateProfilePicture -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateProfilePicture/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/messages-media.ts:175](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L175)

## Parameters[​](https://baileys.wiki/docs/api/functions/generateProfilePicture/#parameters "Direct link to Parameters")

### mediaUpload[​](https://baileys.wiki/docs/api/functions/generateProfilePicture/#mediaupload "Direct link to mediaUpload")

[`WAMediaUpload`](https://baileys.wiki/docs/api/type-aliases/WAMediaUpload)

### dimensions?[​](https://baileys.wiki/docs/api/functions/generateProfilePicture/#dimensions "Direct link to dimensions?")

#### height[​](https://baileys.wiki/docs/api/functions/generateProfilePicture/#height "Direct link to height")

`number`

#### width[​](https://baileys.wiki/docs/api/functions/generateProfilePicture/#width "Direct link to width")

`number`

## Returns[​](https://baileys.wiki/docs/api/functions/generateProfilePicture/#returns "Direct link to Returns")

`Promise`<{ `img`: `Buffer`<`ArrayBufferLike`>; }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateProfilePicture.md)
[Previous Function: generateParticipantHashV2()](https://baileys.wiki/docs/api/functions/generateParticipantHashV2)[Next Function: generateRegistrationId()](https://baileys.wiki/docs/api/functions/generateRegistrationId)

- [Parameters](https://baileys.wiki/docs/api/functions/generateProfilePicture/#parameters)
  - [mediaUpload](https://baileys.wiki/docs/api/functions/generateProfilePicture/#mediaupload)
  - [dimensions?](https://baileys.wiki/docs/api/functions/generateProfilePicture/#dimensions)
- [Returns](https://baileys.wiki/docs/api/functions/generateProfilePicture/#returns)
