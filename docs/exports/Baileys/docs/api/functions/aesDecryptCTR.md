# Source: https://baileys.wiki/docs/api/functions/aesDecryptCTR

<!-- Scraped from https://baileys.wiki/docs/api/functions/aesDecryptCTR -->

[Skip to main content](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/crypto.ts:79](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/crypto.ts#L79)

## Parameters[​](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#parameters "Direct link to Parameters")

### ciphertext[​](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#ciphertext "Direct link to ciphertext")

`Uint8Array`

### key[​](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#key "Direct link to key")

`Uint8Array`

### iv[​](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#iv "Direct link to iv")

`Uint8Array`

## Returns[​](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#returns "Direct link to Returns")

`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/aesDecryptCTR.md)
[Previous Function: aesDecrypt()](https://baileys.wiki/docs/api/functions/aesDecrypt)[Next Function: aesDecryptGCM()](https://baileys.wiki/docs/api/functions/aesDecryptGCM)

- [Parameters](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#parameters)
  - [ciphertext](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#ciphertext)
  - [key](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#key)
  - [iv](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#iv)
- [Returns](https://baileys.wiki/docs/api/functions/aesDecryptCTR/#returns)
