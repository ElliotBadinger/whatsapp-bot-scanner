# Source: https://baileys.wiki/docs/api/functions/getPlatformId

<!-- Scraped from https://baileys.wiki/docs/api/functions/getPlatformId -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getPlatformId/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/browser-utils.ts:28](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/browser-utils.ts#L28)
## Parameters[​](https://baileys.wiki/docs/api/functions/getPlatformId/#parameters "Direct link to Parameters")
### browser[​](https://baileys.wiki/docs/api/functions/getPlatformId/#browser "Direct link to browser")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/getPlatformId/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getPlatformId.md)
[Previous Function: getNextPreKeysNode()](https://baileys.wiki/docs/api/functions/getNextPreKeysNode)[Next Function: getPreKeys()](https://baileys.wiki/docs/api/functions/getPreKeys)
  * [Parameters](https://baileys.wiki/docs/api/functions/getPlatformId/#parameters)
    * [browser](https://baileys.wiki/docs/api/functions/getPlatformId/#browser)
  * [Returns](https://baileys.wiki/docs/api/functions/getPlatformId/#returns)
