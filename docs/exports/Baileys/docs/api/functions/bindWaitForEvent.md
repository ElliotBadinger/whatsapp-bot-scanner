# Source: https://baileys.wiki/docs/api/functions/bindWaitForEvent

<!-- Scraped from https://baileys.wiki/docs/api/functions/bindWaitForEvent -->

[Skip to main content](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:200](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L200)
## Type Parameters[​](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#type-parameters "Direct link to Type Parameters")
• **T** _extends_ keyof [`BaileysEventMap`](https://baileys.wiki/docs/api/type-aliases/BaileysEventMap)
## Parameters[​](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#parameters "Direct link to Parameters")
### ev[​](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#ev "Direct link to ev")
[`BaileysEventEmitter`](https://baileys.wiki/docs/api/interfaces/BaileysEventEmitter)
### event[​](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#event "Direct link to event")
`T`
## Returns[​](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#returns "Direct link to Returns")
`Function`
### Parameters[​](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#parameters-1 "Direct link to Parameters")
#### check[​](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#check "Direct link to check")
(`u`) => `Promise`<`undefined` | `boolean`>
#### timeoutMs?[​](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#timeoutms "Direct link to timeoutMs?")
`number`
### Returns[​](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#returns-1 "Direct link to Returns")
`Promise`<`void`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/bindWaitForEvent.md)
[Previous Function: bindWaitForConnectionUpdate()](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate)[Next Function: bytesToCrockford()](https://baileys.wiki/docs/api/functions/bytesToCrockford)
  * [Type Parameters](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#type-parameters)
  * [Parameters](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#parameters)
    * [ev](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#ev)
    * [event](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#event)
  * [Returns](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#returns)
    * [Parameters](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#parameters-1)
    * [Returns](https://baileys.wiki/docs/api/functions/bindWaitForEvent/#returns-1)
