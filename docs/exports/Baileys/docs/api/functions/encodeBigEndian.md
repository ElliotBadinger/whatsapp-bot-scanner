# Source: https://baileys.wiki/docs/api/functions/encodeBigEndian

<!-- Scraped from https://baileys.wiki/docs/api/functions/encodeBigEndian -->

[Skip to main content](https://baileys.wiki/docs/api/functions/encodeBigEndian/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:84](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L84)
## Parameters[​](https://baileys.wiki/docs/api/functions/encodeBigEndian/#parameters "Direct link to Parameters")
### e[​](https://baileys.wiki/docs/api/functions/encodeBigEndian/#e "Direct link to e")
`number`
### t[​](https://baileys.wiki/docs/api/functions/encodeBigEndian/#t "Direct link to t")
`number` = `4`
## Returns[​](https://baileys.wiki/docs/api/functions/encodeBigEndian/#returns "Direct link to Returns")
`Uint8Array`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/encodeBigEndian.md)
[Previous Function: encodeBase64EncodedStringForUpload()](https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload)[Next Function: encodeBinaryNode()](https://baileys.wiki/docs/api/functions/encodeBinaryNode)
  * [Parameters](https://baileys.wiki/docs/api/functions/encodeBigEndian/#parameters)
    * [e](https://baileys.wiki/docs/api/functions/encodeBigEndian/#e)
    * [t](https://baileys.wiki/docs/api/functions/encodeBigEndian/#t)
  * [Returns](https://baileys.wiki/docs/api/functions/encodeBigEndian/#returns)
