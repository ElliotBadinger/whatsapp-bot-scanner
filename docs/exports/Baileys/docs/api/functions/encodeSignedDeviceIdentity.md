# Source: https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity

<!-- Scraped from https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity -->

[Skip to main content](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/validate-connection.ts:244](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/validate-connection.ts#L244)
## Parameters[​](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity/#parameters "Direct link to Parameters")
### account[​](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity/#account "Direct link to account")
[`IADVSignedDeviceIdentity`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IADVSignedDeviceIdentity)
### includeSignatureKey[​](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity/#includesignaturekey "Direct link to includeSignatureKey")
`boolean`
## Returns[​](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity/#returns "Direct link to Returns")
`Uint8Array`<`ArrayBufferLike`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/encodeSignedDeviceIdentity.md)
[Previous Function: encodeNewsletterMessage()](https://baileys.wiki/docs/api/functions/encodeNewsletterMessage)[Next Function: encodeSyncdPatch()](https://baileys.wiki/docs/api/functions/encodeSyncdPatch)
  * [Parameters](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity/#parameters)
    * [account](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity/#account)
    * [includeSignatureKey](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity/#includesignaturekey)
  * [Returns](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity/#returns)
