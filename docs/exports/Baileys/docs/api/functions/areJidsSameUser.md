# Source: https://baileys.wiki/docs/api/functions/areJidsSameUser

<!-- Scraped from https://baileys.wiki/docs/api/functions/areJidsSameUser -->

[Skip to main content](https://baileys.wiki/docs/api/functions/areJidsSameUser/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/WABinary/jid-utils.ts:88](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L88)
> is the jid a user

## Parameters[​](https://baileys.wiki/docs/api/functions/areJidsSameUser/#parameters "Direct link to Parameters")

### jid1[​](https://baileys.wiki/docs/api/functions/areJidsSameUser/#jid1 "Direct link to jid1")

`undefined` | `string`

### jid2[​](https://baileys.wiki/docs/api/functions/areJidsSameUser/#jid2 "Direct link to jid2")

`undefined` | `string`

## Returns[​](https://baileys.wiki/docs/api/functions/areJidsSameUser/#returns "Direct link to Returns")

`boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/areJidsSameUser.md)
[Previous Function: aggregateMessageKeysNotFromMe()](https://baileys.wiki/docs/api/functions/aggregateMessageKeysNotFromMe)[Next Function: assertMediaContent()](https://baileys.wiki/docs/api/functions/assertMediaContent)

- [Parameters](https://baileys.wiki/docs/api/functions/areJidsSameUser/#parameters)
  - [jid1](https://baileys.wiki/docs/api/functions/areJidsSameUser/#jid1)
  - [jid2](https://baileys.wiki/docs/api/functions/areJidsSameUser/#jid2)
- [Returns](https://baileys.wiki/docs/api/functions/areJidsSameUser/#returns)
