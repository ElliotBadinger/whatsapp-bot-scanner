# Source: https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError

<!-- Scraped from https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/generics.ts:359](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L359)
> Stream errors generally provide a reason, map that to a baileys DisconnectReason

## Parameters[​](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#parameters "Direct link to Parameters")

### node[​](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#node "Direct link to node")

[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)

## Returns[​](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#returns "Direct link to Returns")

`object`

### reason[​](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#reason "Direct link to reason")

> **reason** : `string`

### statusCode[​](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#statuscode "Direct link to statusCode")

> **statusCode** : `number`
> [](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getErrorCodeFromStreamError.md)
> [Previous Function: getDevice()](https://baileys.wiki/docs/api/functions/getDevice)[Next Function: getHistoryMsg()](https://baileys.wiki/docs/api/functions/getHistoryMsg)

- [Parameters](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#parameters)
  - [node](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#node)
- [Returns](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#returns)
  - [reason](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#reason)
  - [statusCode](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError/#statuscode)
