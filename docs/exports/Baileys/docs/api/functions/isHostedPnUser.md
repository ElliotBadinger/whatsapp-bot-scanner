# Source: https://baileys.wiki/docs/api/functions/isHostedPnUser

<!-- Scraped from https://baileys.wiki/docs/api/functions/isHostedPnUser -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isHostedPnUser/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/jid-utils.ts:105](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L105)
is the jid a hosted PN
## Parameters[​](https://baileys.wiki/docs/api/functions/isHostedPnUser/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/isHostedPnUser/#jid "Direct link to jid")
`undefined` | `string`
## Returns[​](https://baileys.wiki/docs/api/functions/isHostedPnUser/#returns "Direct link to Returns")
`undefined` | `boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isHostedPnUser.md)
[Previous Function: isHostedLidUser()](https://baileys.wiki/docs/api/functions/isHostedLidUser)[Next Function: isJidBot()](https://baileys.wiki/docs/api/functions/isJidBot)
  * [Parameters](https://baileys.wiki/docs/api/functions/isHostedPnUser/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/isHostedPnUser/#jid)
  * [Returns](https://baileys.wiki/docs/api/functions/isHostedPnUser/#returns)
