# Source: https://baileys.wiki/docs/api/functions/extractUrlFromText

<!-- Scraped from https://baileys.wiki/docs/api/functions/extractUrlFromText -->

[Skip to main content](https://baileys.wiki/docs/api/functions/extractUrlFromText/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages.ts:82](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages.ts#L82)
Uses a regex to test whether the string contains a URL, and returns the URL if it does.
## Parameters[​](https://baileys.wiki/docs/api/functions/extractUrlFromText/#parameters "Direct link to Parameters")
### text[​](https://baileys.wiki/docs/api/functions/extractUrlFromText/#text "Direct link to text")
`string`
eg. hello <https://google.com>
## Returns[​](https://baileys.wiki/docs/api/functions/extractUrlFromText/#returns "Direct link to Returns")
`undefined` | `string`
the URL, eg. <https://google.com>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/extractUrlFromText.md)
[Previous Function: extractSyncdPatches()](https://baileys.wiki/docs/api/functions/extractSyncdPatches)[Next Function: fetchLatestBaileysVersion()](https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion)
  * [Parameters](https://baileys.wiki/docs/api/functions/extractUrlFromText/#parameters)
    * [text](https://baileys.wiki/docs/api/functions/extractUrlFromText/#text)
  * [Returns](https://baileys.wiki/docs/api/functions/extractUrlFromText/#returns)
