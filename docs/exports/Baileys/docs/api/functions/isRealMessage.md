# Source: https://baileys.wiki/docs/api/functions/isRealMessage

<!-- Scraped from https://baileys.wiki/docs/api/functions/isRealMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isRealMessage/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/process-message.ts:111](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/process-message.ts#L111)
## Parameters[​](https://baileys.wiki/docs/api/functions/isRealMessage/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/isRealMessage/#message "Direct link to message")
[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)
## Returns[​](https://baileys.wiki/docs/api/functions/isRealMessage/#returns "Direct link to Returns")
`boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isRealMessage.md)
[Previous Function: isPnUser()](https://baileys.wiki/docs/api/functions/isPnUser)[Next Function: isWABusinessPlatform()](https://baileys.wiki/docs/api/functions/isWABusinessPlatform)
  * [Parameters](https://baileys.wiki/docs/api/functions/isRealMessage/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/isRealMessage/#message)
  * [Returns](https://baileys.wiki/docs/api/functions/isRealMessage/#returns)
