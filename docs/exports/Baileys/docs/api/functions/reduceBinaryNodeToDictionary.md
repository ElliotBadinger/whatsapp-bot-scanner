# Source: https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary

<!-- Scraped from https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary -->

[Skip to main content](https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/generic-utils.ts:59](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/WABinary/generic-utils.ts#L59)
## Parameters[​](https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary/#parameters "Direct link to Parameters")
### node[​](https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary/#node "Direct link to node")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
### tag[​](https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary/#tag "Direct link to tag")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary/#returns "Direct link to Returns")
`object`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/reduceBinaryNodeToDictionary.md)
[Previous Function: promiseTimeout()](https://baileys.wiki/docs/api/functions/promiseTimeout)[Next Function: sha256()](https://baileys.wiki/docs/api/functions/sha256)
  * [Parameters](https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary/#parameters)
    * [node](https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary/#node)
    * [tag](https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary/#tag)
  * [Returns](https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary/#returns)
