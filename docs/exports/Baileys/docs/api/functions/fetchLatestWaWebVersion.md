# Source: https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion

<!-- Scraped from https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion -->

[Skip to main content](https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion/#__docusaurus_skipToContent_fallback)
...
> **fetchLatestWaWebVersion**(`options`): `Promise`<{ `error`: `undefined`; `isLatest`: `boolean`; `version`: [`WAVersion`](https://baileys.wiki/docs/api/type-aliases/WAVersion); } | { `error`: `unknown`; `isLatest`: `boolean`; `version`: [`WAVersion`](https://baileys.wiki/docs/api/type-aliases/WAVersion); }>
> Defined in: [src/Utils/generics.ts:275](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L275)
...
## Parameters[​](https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion/#parameters "Direct link to Parameters")

### options[​](https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion/#options "Direct link to options")

`RequestInit` = `{}`

## Returns[​](https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion/#returns "Direct link to Returns")

`Promise`<{ `error`: `undefined`; `isLatest`: `boolean`; `version`: [`WAVersion`](https://baileys.wiki/docs/api/type-aliases/WAVersion); } | { `error`: `unknown`; `isLatest`: `boolean`; `version`: [`WAVersion`](https://baileys.wiki/docs/api/type-aliases/WAVersion); }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/fetchLatestWaWebVersion.md)
[Previous Function: fetchLatestBaileysVersion()](https://baileys.wiki/docs/api/functions/fetchLatestBaileysVersion)[Next Function: generateForwardMessageContent()](https://baileys.wiki/docs/api/functions/generateForwardMessageContent)

- [Parameters](https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion/#parameters)
  - [options](https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion/#options)
- [Returns](https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion/#returns)
