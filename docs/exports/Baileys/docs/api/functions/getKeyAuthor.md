# Source: https://baileys.wiki/docs/api/functions/getKeyAuthor

<!-- Scraped from https://baileys.wiki/docs/api/functions/getKeyAuthor -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getKeyAuthor/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/generics.ts:47](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L47)

## Parameters[​](https://baileys.wiki/docs/api/functions/getKeyAuthor/#parameters "Direct link to Parameters")

### key[​](https://baileys.wiki/docs/api/functions/getKeyAuthor/#key "Direct link to key")

`undefined` | `null` | [`WAMessageKey`](https://baileys.wiki/docs/api/type-aliases/WAMessageKey)

### meId[​](https://baileys.wiki/docs/api/functions/getKeyAuthor/#meid "Direct link to meId")

`string` = `'me'`

## Returns[​](https://baileys.wiki/docs/api/functions/getKeyAuthor/#returns "Direct link to Returns")

`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getKeyAuthor.md)
[Previous Function: getHttpStream()](https://baileys.wiki/docs/api/functions/getHttpStream)[Next Function: getMediaKeys()](https://baileys.wiki/docs/api/functions/getMediaKeys)

- [Parameters](https://baileys.wiki/docs/api/functions/getKeyAuthor/#parameters)
  - [key](https://baileys.wiki/docs/api/functions/getKeyAuthor/#key)
  - [meId](https://baileys.wiki/docs/api/functions/getKeyAuthor/#meid)
- [Returns](https://baileys.wiki/docs/api/functions/getKeyAuthor/#returns)
