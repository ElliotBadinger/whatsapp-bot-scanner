...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#**namedparameters "Direct link to \_\_namedParameters")

[`MediaDecryptionKeyInfo`](https://baileys.wiki/docs/api/type-aliases/MediaDecryptionKeyInfo)

### **namedParameters[​](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#**namedparameters-1 "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#parameters)
  ...
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#__namedparameters)
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#__namedparameters-1)
