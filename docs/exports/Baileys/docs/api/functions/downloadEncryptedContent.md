# Source: https://baileys.wiki/docs/api/functions/downloadEncryptedContent

<!-- Scraped from https://baileys.wiki/docs/api/functions/downloadEncryptedContent -->

[Skip to main content](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:526](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L526)
...
## Parameters[​](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#parameters "Direct link to Parameters")
### downloadUrl[​](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#downloadurl "Direct link to downloadUrl")
`string`
### __namedParameters[​](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#__namedparameters "Direct link to __namedParameters")
[`MediaDecryptionKeyInfo`](https://baileys.wiki/docs/api/type-aliases/MediaDecryptionKeyInfo)
### __namedParameters[​](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#__namedparameters-1 "Direct link to __namedParameters")
[`MediaDownloadOptions`](https://baileys.wiki/docs/api/type-aliases/MediaDownloadOptions) = `{}`
## Returns[​](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#returns "Direct link to Returns")
`Promise`<`Transform`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/downloadEncryptedContent.md)
[Previous Function: downloadContentFromMessage()](https://baileys.wiki/docs/api/functions/downloadContentFromMessage)[Next Function: downloadExternalBlob()](https://baileys.wiki/docs/api/functions/downloadExternalBlob)
  * [Parameters](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#parameters)
    * [downloadUrl](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#downloadurl)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#__namedparameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#__namedparameters-1)
  * [Returns](https://baileys.wiki/docs/api/functions/downloadEncryptedContent/#returns)
