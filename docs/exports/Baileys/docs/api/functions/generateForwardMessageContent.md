# Source: https://baileys.wiki/docs/api/functions/generateForwardMessageContent

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateForwardMessageContent -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateForwardMessageContent/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: generateForwardMessageContent()
> **generateForwardMessageContent**(`message`, `forceForward`?): [`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
Defined in: [src/Utils/messages.ts:338](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages.ts#L338)
Generate forwarded message content like WA does
## Parameters[​](https://baileys.wiki/docs/api/functions/generateForwardMessageContent/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/generateForwardMessageContent/#message "Direct link to message")
[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)
the message to forward
### forceForward?[​](https://baileys.wiki/docs/api/functions/generateForwardMessageContent/#forceforward "Direct link to forceForward?")
`boolean`
## Returns[​](https://baileys.wiki/docs/api/functions/generateForwardMessageContent/#returns "Direct link to Returns")
[`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateForwardMessageContent.md)
[Previous Function: fetchLatestWaWebVersion()](https://baileys.wiki/docs/api/functions/fetchLatestWaWebVersion)[Next Function: generateLinkPreviewIfRequired()](https://baileys.wiki/docs/api/functions/generateLinkPreviewIfRequired)
  * [Parameters](https://baileys.wiki/docs/api/functions/generateForwardMessageContent/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/generateForwardMessageContent/#message)
    * [forceForward?](https://baileys.wiki/docs/api/functions/generateForwardMessageContent/#forceforward)
  * [Returns](https://baileys.wiki/docs/api/functions/generateForwardMessageContent/#returns)
