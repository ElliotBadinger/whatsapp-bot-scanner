# Source: https://baileys.wiki/docs/api/functions/chatModificationToAppPatch

<!-- Scraped from https://baileys.wiki/docs/api/functions/chatModificationToAppPatch -->

[Skip to main content](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: chatModificationToAppPatch()
> **chatModificationToAppPatch**(`mod`, `jid`): [`WAPatchCreate`](https://baileys.wiki/docs/api/type-aliases/WAPatchCreate)
Defined in: [src/Utils/chat-utils.ts:489](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/chat-utils.ts#L489)
## Parameters[​](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch/#parameters "Direct link to Parameters")
### mod[​](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch/#mod "Direct link to mod")
[`ChatModification`](https://baileys.wiki/docs/api/type-aliases/ChatModification)
### jid[​](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch/#jid "Direct link to jid")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch/#returns "Direct link to Returns")
[`WAPatchCreate`](https://baileys.wiki/docs/api/type-aliases/WAPatchCreate)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/chatModificationToAppPatch.md)
[Previous Function: bytesToCrockford()](https://baileys.wiki/docs/api/functions/bytesToCrockford)[Next Function: cleanMessage()](https://baileys.wiki/docs/api/functions/cleanMessage)
  * [Parameters](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch/#parameters)
    * [mod](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch/#mod)
    * [jid](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch/#jid)
  * [Returns](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch/#returns)
