# Source: https://baileys.wiki/docs/api/functions/writeRandomPadMax16

<!-- Scraped from https://baileys.wiki/docs/api/functions/writeRandomPadMax16 -->

[Skip to main content](https://baileys.wiki/docs/api/functions/writeRandomPadMax16/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:50](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/generics.ts#L50)
## Parameters[​](https://baileys.wiki/docs/api/functions/writeRandomPadMax16/#parameters "Direct link to Parameters")
### msg[​](https://baileys.wiki/docs/api/functions/writeRandomPadMax16/#msg "Direct link to msg")
`Uint8Array`
## Returns[​](https://baileys.wiki/docs/api/functions/writeRandomPadMax16/#returns "Direct link to Returns")
`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/writeRandomPadMax16.md)
[Previous Function: useMultiFileAuthState()](https://baileys.wiki/docs/api/functions/useMultiFileAuthState)[Next Function: xmppPreKey()](https://baileys.wiki/docs/api/functions/xmppPreKey)
  * [Parameters](https://baileys.wiki/docs/api/functions/writeRandomPadMax16/#parameters)
    * [msg](https://baileys.wiki/docs/api/functions/writeRandomPadMax16/#msg)
  * [Returns](https://baileys.wiki/docs/api/functions/writeRandomPadMax16/#returns)
