# Source: https://baileys.wiki/docs/api/functions/getRawMediaUploadData

<!-- Scraped from https://baileys.wiki/docs/api/functions/getRawMediaUploadData -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/messages-media.ts:53](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L53)

## Parameters[​](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#parameters "Direct link to Parameters")

### media[​](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#media "Direct link to media")

[`WAMediaUpload`](https://baileys.wiki/docs/api/type-aliases/WAMediaUpload)

### mediaType[​](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#mediatype "Direct link to mediaType")
...
### logger?[​](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#logger "Direct link to logger?")

`ILogger`

## Returns[​](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#returns "Direct link to Returns")

`Promise`<{ `fileLength`: `number`; `filePath`: `string`; `fileSha256`: `Buffer`<`ArrayBufferLike`>; }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getRawMediaUploadData.md)
[Previous Function: getPreKeys()](https://baileys.wiki/docs/api/functions/getPreKeys)[Next Function: getServerFromDomainType()](https://baileys.wiki/docs/api/functions/getServerFromDomainType)

- [Parameters](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#parameters)
  - [media](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#media)
  - [mediaType](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#mediatype)
  - [logger?](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#logger)
- [Returns](https://baileys.wiki/docs/api/functions/getRawMediaUploadData/#returns)
