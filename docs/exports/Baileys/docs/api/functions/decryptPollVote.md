# Source: https://baileys.wiki/docs/api/functions/decryptPollVote

<!-- Scraped from https://baileys.wiki/docs/api/functions/decryptPollVote -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decryptPollVote/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: decryptPollVote()
> **decryptPollVote**(`vote`, `ctx`): [`PollVoteMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/classes/PollVoteMessage)
Defined in: [src/Utils/process-message.ts:167](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/process-message.ts#L167)
Decrypt a poll vote
## Parameters[​](https://baileys.wiki/docs/api/functions/decryptPollVote/#parameters "Direct link to Parameters")
### vote[​](https://baileys.wiki/docs/api/functions/decryptPollVote/#vote "Direct link to vote")
[`IPollEncValue`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IPollEncValue)
encrypted vote
### ctx[​](https://baileys.wiki/docs/api/functions/decryptPollVote/#ctx "Direct link to ctx")
`PollContext`
additional info about the poll required for decryption
## Returns[​](https://baileys.wiki/docs/api/functions/decryptPollVote/#returns "Direct link to Returns")
[`PollVoteMessage`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/classes/PollVoteMessage)
list of SHA256 options
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decryptPollVote.md)
[Previous Function: decryptMessageNode()](https://baileys.wiki/docs/api/functions/decryptMessageNode)[Next Function: delay()](https://baileys.wiki/docs/api/functions/delay)
  * [Parameters](https://baileys.wiki/docs/api/functions/decryptPollVote/#parameters)
    * [vote](https://baileys.wiki/docs/api/functions/decryptPollVote/#vote)
    * [ctx](https://baileys.wiki/docs/api/functions/decryptPollVote/#ctx)
  * [Returns](https://baileys.wiki/docs/api/functions/decryptPollVote/#returns)
