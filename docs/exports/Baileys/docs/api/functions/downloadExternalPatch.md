# Source: https://baileys.wiki/docs/api/functions/downloadExternalPatch

<!-- Scraped from https://baileys.wiki/docs/api/functions/downloadExternalPatch -->

[Skip to main content](https://baileys.wiki/docs/api/functions/downloadExternalPatch/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: downloadExternalPatch()
> **downloadExternalPatch**(`blob`, `options`): `Promise`<[`SyncdMutations`](https://baileys.wiki/docs/api/namespaces/proto/classes/SyncdMutations)>
Defined in: [src/Utils/chat-utils.ts:366](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/chat-utils.ts#L366)
## Parameters[​](https://baileys.wiki/docs/api/functions/downloadExternalPatch/#parameters "Direct link to Parameters")
### blob[​](https://baileys.wiki/docs/api/functions/downloadExternalPatch/#blob "Direct link to blob")
[`IExternalBlobReference`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IExternalBlobReference)
### options[​](https://baileys.wiki/docs/api/functions/downloadExternalPatch/#options "Direct link to options")
`RequestInit`
## Returns[​](https://baileys.wiki/docs/api/functions/downloadExternalPatch/#returns "Direct link to Returns")
`Promise`<[`SyncdMutations`](https://baileys.wiki/docs/api/namespaces/proto/classes/SyncdMutations)>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/downloadExternalPatch.md)
[Previous Function: downloadExternalBlob()](https://baileys.wiki/docs/api/functions/downloadExternalBlob)[Next Function: downloadHistory()](https://baileys.wiki/docs/api/functions/downloadHistory)
  * [Parameters](https://baileys.wiki/docs/api/functions/downloadExternalPatch/#parameters)
    * [blob](https://baileys.wiki/docs/api/functions/downloadExternalPatch/#blob)
    * [options](https://baileys.wiki/docs/api/functions/downloadExternalPatch/#options)
  * [Returns](https://baileys.wiki/docs/api/functions/downloadExternalPatch/#returns)
