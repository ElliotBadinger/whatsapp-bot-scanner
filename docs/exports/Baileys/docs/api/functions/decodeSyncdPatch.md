# Source: https://baileys.wiki/docs/api/functions/decodeSyncdPatch

<!-- Scraped from https://baileys.wiki/docs/api/functions/decodeSyncdPatch -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/chat-utils.ts:270](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/chat-utils.ts#L270)
## Parameters[​](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#parameters "Direct link to Parameters")
### msg[​](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#msg "Direct link to msg")
[`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)
### name[​](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#name "Direct link to name")
`"critical_unblock_low"` | `"regular_high"` | `"regular_low"` | `"critical_block"` | `"regular"`
### initialState[​](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#initialstate "Direct link to initialState")
[`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState)
### getAppStateSyncKey[​](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#getappstatesynckey "Direct link to getAppStateSyncKey")
`FetchAppStateSyncKey`
### onMutation[​](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#onmutation "Direct link to onMutation")
(`mutation`) => `void`
### validateMacs[​](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#validatemacs "Direct link to validateMacs")
`boolean`
## Returns[​](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#returns "Direct link to Returns")
`Promise`<{ `hash`: `Buffer`<`ArrayBuffer`>; `indexValueMap`: {}; }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decodeSyncdPatch.md)
[Previous Function: decodeSyncdMutations()](https://baileys.wiki/docs/api/functions/decodeSyncdMutations)[Next Function: decodeSyncdSnapshot()](https://baileys.wiki/docs/api/functions/decodeSyncdSnapshot)
  * [Parameters](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#parameters)
    * [msg](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#msg)
    * [name](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#name)
    * [initialState](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#initialstate)
    * [getAppStateSyncKey](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#getappstatesynckey)
    * [onMutation](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#onmutation)
    * [validateMacs](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#validatemacs)
  * [Returns](https://baileys.wiki/docs/api/functions/decodeSyncdPatch/#returns)
