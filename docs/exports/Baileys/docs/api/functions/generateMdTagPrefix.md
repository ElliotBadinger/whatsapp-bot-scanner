# Source: https://baileys.wiki/docs/api/functions/generateMdTagPrefix

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateMdTagPrefix -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateMdTagPrefix/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:327](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/generics.ts#L327)
unique message tag prefix for MD clients
## Returns[​](https://baileys.wiki/docs/api/functions/generateMdTagPrefix/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateMdTagPrefix.md)
[Previous Function: generateLoginNode()](https://baileys.wiki/docs/api/functions/generateLoginNode)[Next Function: generateMessageID()](https://baileys.wiki/docs/api/functions/generateMessageID)
  * [Returns](https://baileys.wiki/docs/api/functions/generateMdTagPrefix/#returns)
