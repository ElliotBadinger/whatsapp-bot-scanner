...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/encryptedStream/#**namedparameters "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/encryptedStream/#parameters)
  ...
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/encryptedStream/#__namedparameters)
