# Source: https://baileys.wiki/docs/api/functions/encryptedStream

<!-- Scraped from https://baileys.wiki/docs/api/functions/encryptedStream -->

[Skip to main content](https://baileys.wiki/docs/api/functions/encryptedStream/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:384](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages-media.ts#L384)
## Parameters[​](https://baileys.wiki/docs/api/functions/encryptedStream/#parameters "Direct link to Parameters")
### media[​](https://baileys.wiki/docs/api/functions/encryptedStream/#media "Direct link to media")
[`WAMediaUpload`](https://baileys.wiki/docs/api/type-aliases/WAMediaUpload)
### mediaType[​](https://baileys.wiki/docs/api/functions/encryptedStream/#mediatype "Direct link to mediaType")
...
### __namedParameters[​](https://baileys.wiki/docs/api/functions/encryptedStream/#__namedparameters "Direct link to __namedParameters")
`EncryptedStreamOptions` = `{}`
## Returns[​](https://baileys.wiki/docs/api/functions/encryptedStream/#returns "Direct link to Returns")
...
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/encryptedStream.md)
[Previous Function: encryptMediaRetryRequest()](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest)[Next Function: extensionForMediaMessage()](https://baileys.wiki/docs/api/functions/extensionForMediaMessage)
  * [Parameters](https://baileys.wiki/docs/api/functions/encryptedStream/#parameters)
    * [media](https://baileys.wiki/docs/api/functions/encryptedStream/#media)
    * [mediaType](https://baileys.wiki/docs/api/functions/encryptedStream/#mediatype)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/encryptedStream/#__namedparameters)
  * [Returns](https://baileys.wiki/docs/api/functions/encryptedStream/#returns)
