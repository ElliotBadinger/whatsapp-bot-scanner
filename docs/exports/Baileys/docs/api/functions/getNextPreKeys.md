...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/getNextPreKeys/#**namedparameters "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/getNextPreKeys/#parameters)
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/getNextPreKeys/#__namedparameters)
