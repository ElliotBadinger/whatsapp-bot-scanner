# Source: https://baileys.wiki/docs/api/functions/getNextPreKeys

<!-- Scraped from https://baileys.wiki/docs/api/functions/getNextPreKeys -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getNextPreKeys/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: getNextPreKeys()
> **getNextPreKeys**(`__namedParameters`, `count`): `Promise`<{ `preKeys`: {}; `update`: `Partial`<[`AuthenticationCreds`](https://baileys.wiki/docs/api/type-aliases/AuthenticationCreds)>; }>
Defined in: [src/Utils/signal.ts:178](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/signal.ts#L178)
get the next N keys for upload or processing
## Parameters[​](https://baileys.wiki/docs/api/functions/getNextPreKeys/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/getNextPreKeys/#__namedparameters "Direct link to __namedParameters")
[`AuthenticationState`](https://baileys.wiki/docs/api/type-aliases/AuthenticationState)
### count[​](https://baileys.wiki/docs/api/functions/getNextPreKeys/#count "Direct link to count")
`number`
number of pre-keys to get or generate
## Returns[​](https://baileys.wiki/docs/api/functions/getNextPreKeys/#returns "Direct link to Returns")
`Promise`<{ `preKeys`: {}; `update`: `Partial`<[`AuthenticationCreds`](https://baileys.wiki/docs/api/type-aliases/AuthenticationCreds)>; }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getNextPreKeys.md)
[Previous Function: getMediaKeys()](https://baileys.wiki/docs/api/functions/getMediaKeys)[Next Function: getNextPreKeysNode()](https://baileys.wiki/docs/api/functions/getNextPreKeysNode)
  * [Parameters](https://baileys.wiki/docs/api/functions/getNextPreKeys/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/getNextPreKeys/#__namedparameters)
    * [count](https://baileys.wiki/docs/api/functions/getNextPreKeys/#count)
  * [Returns](https://baileys.wiki/docs/api/functions/getNextPreKeys/#returns)
