# Source: https://baileys.wiki/docs/api/functions/createSignalIdentity

<!-- Scraped from https://baileys.wiki/docs/api/functions/createSignalIdentity -->

[Skip to main content](https://baileys.wiki/docs/api/functions/createSignalIdentity/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: createSignalIdentity()
> **createSignalIdentity**(`wid`, `accountSignatureKey`): [`SignalIdentity`](https://baileys.wiki/docs/api/type-aliases/SignalIdentity)
Defined in: [src/Utils/signal.ts:37](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/signal.ts#L37)
## Parameters[​](https://baileys.wiki/docs/api/functions/createSignalIdentity/#parameters "Direct link to Parameters")
### wid[​](https://baileys.wiki/docs/api/functions/createSignalIdentity/#wid "Direct link to wid")
`string`
### accountSignatureKey[​](https://baileys.wiki/docs/api/functions/createSignalIdentity/#accountsignaturekey "Direct link to accountSignatureKey")
`Uint8Array`
## Returns[​](https://baileys.wiki/docs/api/functions/createSignalIdentity/#returns "Direct link to Returns")
[`SignalIdentity`](https://baileys.wiki/docs/api/type-aliases/SignalIdentity)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/createSignalIdentity.md)
[Previous Function: configureSuccessfulPairing()](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing)[Next Function: debouncedTimeout()](https://baileys.wiki/docs/api/functions/debouncedTimeout)
  * [Parameters](https://baileys.wiki/docs/api/functions/createSignalIdentity/#parameters)
    * [wid](https://baileys.wiki/docs/api/functions/createSignalIdentity/#wid)
    * [accountSignatureKey](https://baileys.wiki/docs/api/functions/createSignalIdentity/#accountsignaturekey)
  * [Returns](https://baileys.wiki/docs/api/functions/createSignalIdentity/#returns)
