# Source: https://baileys.wiki/docs/api/functions/isJidBot

<!-- Scraped from https://baileys.wiki/docs/api/functions/isJidBot -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isJidBot/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/jid-utils.ts:111](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/WABinary/jid-utils.ts#L111)
## Parameters[​](https://baileys.wiki/docs/api/functions/isJidBot/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/isJidBot/#jid "Direct link to jid")
`undefined` | `string`
## Returns[​](https://baileys.wiki/docs/api/functions/isJidBot/#returns "Direct link to Returns")
`undefined` | `boolean` | `""`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isJidBot.md)
[Previous Function: isHostedPnUser()](https://baileys.wiki/docs/api/functions/isHostedPnUser)[Next Function: isJidBroadcast()](https://baileys.wiki/docs/api/functions/isJidBroadcast)
  * [Parameters](https://baileys.wiki/docs/api/functions/isJidBot/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/isJidBot/#jid)
  * [Returns](https://baileys.wiki/docs/api/functions/isJidBot/#returns)
