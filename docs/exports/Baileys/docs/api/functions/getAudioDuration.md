# Source: https://baileys.wiki/docs/api/functions/getAudioDuration

<!-- Scraped from https://baileys.wiki/docs/api/functions/getAudioDuration -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getAudioDuration/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:223](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L223)
## Parameters[​](https://baileys.wiki/docs/api/functions/getAudioDuration/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/getAudioDuration/#buffer "Direct link to buffer")
`string` | `Buffer`<`ArrayBufferLike`> | `Readable`
## Returns[​](https://baileys.wiki/docs/api/functions/getAudioDuration/#returns "Direct link to Returns")
`Promise`<`undefined` | `number`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getAudioDuration.md)
[Previous Function: getAllBinaryNodeChildren()](https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren)[Next Function: getAudioWaveform()](https://baileys.wiki/docs/api/functions/getAudioWaveform)
  * [Parameters](https://baileys.wiki/docs/api/functions/getAudioDuration/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/getAudioDuration/#buffer)
  * [Returns](https://baileys.wiki/docs/api/functions/getAudioDuration/#returns)
