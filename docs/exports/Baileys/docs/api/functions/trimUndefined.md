# Source: https://baileys.wiki/docs/api/functions/trimUndefined

<!-- Scraped from https://baileys.wiki/docs/api/functions/trimUndefined -->

[Skip to main content](https://baileys.wiki/docs/api/functions/trimUndefined/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:434](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/generics.ts#L434)
## Parameters[​](https://baileys.wiki/docs/api/functions/trimUndefined/#parameters "Direct link to Parameters")
### obj[​](https://baileys.wiki/docs/api/functions/trimUndefined/#obj "Direct link to obj")
## Returns[​](https://baileys.wiki/docs/api/functions/trimUndefined/#returns "Direct link to Returns")
`object`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/trimUndefined.md)
[Previous Function: transferDevice()](https://baileys.wiki/docs/api/functions/transferDevice)[Next Function: unixTimestampSeconds()](https://baileys.wiki/docs/api/functions/unixTimestampSeconds)
  * [Parameters](https://baileys.wiki/docs/api/functions/trimUndefined/#parameters)
    * [obj](https://baileys.wiki/docs/api/functions/trimUndefined/#obj)
  * [Returns](https://baileys.wiki/docs/api/functions/trimUndefined/#returns)
