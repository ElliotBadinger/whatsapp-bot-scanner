# Source: https://baileys.wiki/docs/api/functions/extractDeviceJids

<!-- Scraped from https://baileys.wiki/docs/api/functions/extractDeviceJids -->

[Skip to main content](https://baileys.wiki/docs/api/functions/extractDeviceJids/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: extractDeviceJids()


On this page
# Function: extractDeviceJids()
> **extractDeviceJids**(`result`, `myJid`, `myLid`, `excludeZeroDevices`): [`FullJid`](https://baileys.wiki/docs/api/type-aliases/FullJid)[]
Defined in: [src/Utils/signal.ts:134](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/signal.ts#L134)
## Parameters[​](https://baileys.wiki/docs/api/functions/extractDeviceJids/#parameters "Direct link to Parameters")
### result[​](https://baileys.wiki/docs/api/functions/extractDeviceJids/#result "Direct link to result")
[`USyncQueryResultList`](https://baileys.wiki/docs/api/type-aliases/USyncQueryResultList)[]
### myJid[​](https://baileys.wiki/docs/api/functions/extractDeviceJids/#myjid "Direct link to myJid")
`string`
### myLid[​](https://baileys.wiki/docs/api/functions/extractDeviceJids/#mylid "Direct link to myLid")
`string`
### excludeZeroDevices[​](https://baileys.wiki/docs/api/functions/extractDeviceJids/#excludezerodevices "Direct link to excludeZeroDevices")
`boolean`
## Returns[​](https://baileys.wiki/docs/api/functions/extractDeviceJids/#returns "Direct link to Returns")
[`FullJid`](https://baileys.wiki/docs/api/type-aliases/FullJid)[]
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/extractDeviceJids.md)
[Previous Function: extractAddressingContext()](https://baileys.wiki/docs/api/functions/extractAddressingContext)[Next Function: extractImageThumb()](https://baileys.wiki/docs/api/functions/extractImageThumb)
  * [Parameters](https://baileys.wiki/docs/api/functions/extractDeviceJids/#parameters)
    * [result](https://baileys.wiki/docs/api/functions/extractDeviceJids/#result)
    * [myJid](https://baileys.wiki/docs/api/functions/extractDeviceJids/#myjid)
    * [myLid](https://baileys.wiki/docs/api/functions/extractDeviceJids/#mylid)
    * [excludeZeroDevices](https://baileys.wiki/docs/api/functions/extractDeviceJids/#excludezerodevices)
  * [Returns](https://baileys.wiki/docs/api/functions/extractDeviceJids/#returns)
