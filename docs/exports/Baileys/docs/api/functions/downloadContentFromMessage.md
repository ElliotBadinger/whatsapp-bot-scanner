...
<!-- Scraped from https://baileys.wiki/docs/api/functions/downloadContentFromMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:506](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages-media.ts#L506)
## Parameters[​](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#__namedparameters "Direct link to __namedParameters")
[`DownloadableMessage`](https://baileys.wiki/docs/api/type-aliases/DownloadableMessage)
### type[​](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#type "Direct link to type")
...
### opts[​](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#opts "Direct link to opts")
[`MediaDownloadOptions`](https://baileys.wiki/docs/api/type-aliases/MediaDownloadOptions) = `{}`
## Returns[​](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#returns "Direct link to Returns")
`Promise`<`Transform`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/downloadContentFromMessage.md)
[Previous Function: downloadAndProcessHistorySyncNotification()](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification)[Next Function: downloadEncryptedContent()](https://baileys.wiki/docs/api/functions/downloadEncryptedContent)
  * [Parameters](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#__namedparameters)
    * [type](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#type)
    * [opts](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#opts)
  * [Returns](https://baileys.wiki/docs/api/functions/downloadContentFromMessage/#returns)
