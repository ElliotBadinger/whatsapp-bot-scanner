...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/getPreKeys/#**namedparameters "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/getPreKeys/#parameters)
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/getPreKeys/#__namedparameters)
