# Source: https://baileys.wiki/docs/api/functions/getPreKeys

<!-- Scraped from https://baileys.wiki/docs/api/functions/getPreKeys -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getPreKeys/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/signal.ts:44](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/signal.ts#L44)
## Parameters[​](https://baileys.wiki/docs/api/functions/getPreKeys/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/getPreKeys/#__namedparameters "Direct link to __namedParameters")
[`SignalKeyStore`](https://baileys.wiki/docs/api/type-aliases/SignalKeyStore)
### min[​](https://baileys.wiki/docs/api/functions/getPreKeys/#min "Direct link to min")
`number`
### limit[​](https://baileys.wiki/docs/api/functions/getPreKeys/#limit "Direct link to limit")
`number`
## Returns[​](https://baileys.wiki/docs/api/functions/getPreKeys/#returns "Direct link to Returns")
`Promise`<{}>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getPreKeys.md)
[Previous Function: getPlatformId()](https://baileys.wiki/docs/api/functions/getPlatformId)[Next Function: getRawMediaUploadData()](https://baileys.wiki/docs/api/functions/getRawMediaUploadData)
  * [Parameters](https://baileys.wiki/docs/api/functions/getPreKeys/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/getPreKeys/#__namedparameters)
    * [min](https://baileys.wiki/docs/api/functions/getPreKeys/#min)
    * [limit](https://baileys.wiki/docs/api/functions/getPreKeys/#limit)
  * [Returns](https://baileys.wiki/docs/api/functions/getPreKeys/#returns)
