# Source: https://baileys.wiki/docs/api/functions/isJidBroadcast

<!-- Scraped from https://baileys.wiki/docs/api/functions/isJidBroadcast -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isJidBroadcast/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/WABinary/jid-utils.ts:97](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L97)
> is the jid a broadcast

## Parameters[​](https://baileys.wiki/docs/api/functions/isJidBroadcast/#parameters "Direct link to Parameters")

### jid[​](https://baileys.wiki/docs/api/functions/isJidBroadcast/#jid "Direct link to jid")

`undefined` | `string`

## Returns[​](https://baileys.wiki/docs/api/functions/isJidBroadcast/#returns "Direct link to Returns")

`undefined` | `boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isJidBroadcast.md)
[Previous Function: isJidBot()](https://baileys.wiki/docs/api/functions/isJidBot)[Next Function: isJidGroup()](https://baileys.wiki/docs/api/functions/isJidGroup)

- [Parameters](https://baileys.wiki/docs/api/functions/isJidBroadcast/#parameters)
  - [jid](https://baileys.wiki/docs/api/functions/isJidBroadcast/#jid)
- [Returns](https://baileys.wiki/docs/api/functions/isJidBroadcast/#returns)
