# Source: https://baileys.wiki/docs/api/functions/decodeBinaryNode

<!-- Scraped from https://baileys.wiki/docs/api/functions/decodeBinaryNode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decodeBinaryNode/#__docusaurus_skipToContent_fallback)
...
> **decodeBinaryNode**(`buff`): `Promise`<[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)>
> Defined in: [src/WABinary/decode.ts:278](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/decode.ts#L278)

## Parameters[​](https://baileys.wiki/docs/api/functions/decodeBinaryNode/#parameters "Direct link to Parameters")

### buff[​](https://baileys.wiki/docs/api/functions/decodeBinaryNode/#buff "Direct link to buff")

`Buffer`

## Returns[​](https://baileys.wiki/docs/api/functions/decodeBinaryNode/#returns "Direct link to Returns")

`Promise`<[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decodeBinaryNode.md)
[Previous Function: debouncedTimeout()](https://baileys.wiki/docs/api/functions/debouncedTimeout)[Next Function: decodeDecompressedBinaryNode()](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode)

- [Parameters](https://baileys.wiki/docs/api/functions/decodeBinaryNode/#parameters)
  - [buff](https://baileys.wiki/docs/api/functions/decodeBinaryNode/#buff)
- [Returns](https://baileys.wiki/docs/api/functions/decodeBinaryNode/#returns)
