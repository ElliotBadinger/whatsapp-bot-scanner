# Source: https://baileys.wiki/docs/api/functions/encodeNewsletterMessage

<!-- Scraped from https://baileys.wiki/docs/api/functions/encodeNewsletterMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/encodeNewsletterMessage/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: encodeNewsletterMessage()


On this page
# Function: encodeNewsletterMessage()
> **encodeNewsletterMessage**(`message`): `Uint8Array`
Defined in: [src/Utils/generics.ts:468](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L468)
## Parameters[​](https://baileys.wiki/docs/api/functions/encodeNewsletterMessage/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/encodeNewsletterMessage/#message "Direct link to message")
[`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
## Returns[​](https://baileys.wiki/docs/api/functions/encodeNewsletterMessage/#returns "Direct link to Returns")
`Uint8Array`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/encodeNewsletterMessage.md)
[Previous Function: encodeBinaryNode()](https://baileys.wiki/docs/api/functions/encodeBinaryNode)[Next Function: encodeSignedDeviceIdentity()](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity)
  * [Parameters](https://baileys.wiki/docs/api/functions/encodeNewsletterMessage/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/encodeNewsletterMessage/#message)
  * [Returns](https://baileys.wiki/docs/api/functions/encodeNewsletterMessage/#returns)
