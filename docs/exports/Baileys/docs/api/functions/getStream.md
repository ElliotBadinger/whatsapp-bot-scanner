# Source: https://baileys.wiki/docs/api/functions/getStream

<!-- Scraped from https://baileys.wiki/docs/api/functions/getStream -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getStream/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/messages-media.ts:303](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L303)

## Parameters[​](https://baileys.wiki/docs/api/functions/getStream/#parameters "Direct link to Parameters")

### item[​](https://baileys.wiki/docs/api/functions/getStream/#item "Direct link to item")

[`WAMediaUpload`](https://baileys.wiki/docs/api/type-aliases/WAMediaUpload)

### opts?[​](https://baileys.wiki/docs/api/functions/getStream/#opts "Direct link to opts?")

`RequestInit` & `object`

## Returns[​](https://baileys.wiki/docs/api/functions/getStream/#returns "Direct link to Returns")
...
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getStream.md)
[Previous Function: getStatusFromReceiptType()](https://baileys.wiki/docs/api/functions/getStatusFromReceiptType)[Next Function: getUrlFromDirectPath()](https://baileys.wiki/docs/api/functions/getUrlFromDirectPath)

- [Parameters](https://baileys.wiki/docs/api/functions/getStream/#parameters)
  - [item](https://baileys.wiki/docs/api/functions/getStream/#item)
  - [opts?](https://baileys.wiki/docs/api/functions/getStream/#opts)
- [Returns](https://baileys.wiki/docs/api/functions/getStream/#returns)
