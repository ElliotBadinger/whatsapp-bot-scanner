# Source: https://baileys.wiki/docs/api/functions/md5

<!-- Scraped from https://baileys.wiki/docs/api/functions/md5 -->

[Skip to main content](https://baileys.wiki/docs/api/functions/md5/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/crypto.ts:121](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/crypto.ts#L121)
## Parameters[​](https://baileys.wiki/docs/api/functions/md5/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/md5/#buffer "Direct link to buffer")
`Buffer`
## Returns[​](https://baileys.wiki/docs/api/functions/md5/#returns "Direct link to Returns")
`Buffer`<`ArrayBufferLike`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/md5.md)
[Previous Function: makeWASocket()](https://baileys.wiki/docs/api/functions/makeWASocket)[Next Function: mediaMessageSHA256B64()](https://baileys.wiki/docs/api/functions/mediaMessageSHA256B64)
  * [Parameters](https://baileys.wiki/docs/api/functions/md5/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/md5/#buffer)
  * [Returns](https://baileys.wiki/docs/api/functions/md5/#returns)
