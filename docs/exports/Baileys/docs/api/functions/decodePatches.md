# Source: https://baileys.wiki/docs/api/functions/decodePatches

<!-- Scraped from https://baileys.wiki/docs/api/functions/decodePatches -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decodePatches/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: decodePatches()
> **decodePatches**(`name`, `syncds`, `initial`, `getAppStateSyncKey`, `options`, `minimumVersionNumber`?, `logger`?, `validateMacs`?): `Promise`<{ `mutationMap`: [`ChatMutationMap`](https://baileys.wiki/docs/api/type-aliases/ChatMutationMap); `state`: [`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState); }>
Defined in: [src/Utils/chat-utils.ts:420](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/chat-utils.ts#L420)
## Parameters[​](https://baileys.wiki/docs/api/functions/decodePatches/#parameters "Direct link to Parameters")
### name[​](https://baileys.wiki/docs/api/functions/decodePatches/#name "Direct link to name")
`"critical_unblock_low"` | `"regular_high"` | `"regular_low"` | `"critical_block"` | `"regular"`
### syncds[​](https://baileys.wiki/docs/api/functions/decodePatches/#syncds "Direct link to syncds")
[`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch)[]
### initial[​](https://baileys.wiki/docs/api/functions/decodePatches/#initial "Direct link to initial")
[`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState)
### getAppStateSyncKey[​](https://baileys.wiki/docs/api/functions/decodePatches/#getappstatesynckey "Direct link to getAppStateSyncKey")
`FetchAppStateSyncKey`
### options[​](https://baileys.wiki/docs/api/functions/decodePatches/#options "Direct link to options")
`RequestInit`
### minimumVersionNumber?[​](https://baileys.wiki/docs/api/functions/decodePatches/#minimumversionnumber "Direct link to minimumVersionNumber?")
`number`
### logger?[​](https://baileys.wiki/docs/api/functions/decodePatches/#logger "Direct link to logger?")
`ILogger`
### validateMacs?[​](https://baileys.wiki/docs/api/functions/decodePatches/#validatemacs "Direct link to validateMacs?")
`boolean` = `true`
## Returns[​](https://baileys.wiki/docs/api/functions/decodePatches/#returns "Direct link to Returns")
`Promise`<{ `mutationMap`: [`ChatMutationMap`](https://baileys.wiki/docs/api/type-aliases/ChatMutationMap); `state`: [`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState); }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decodePatches.md)
[Previous Function: decodeMessageNode()](https://baileys.wiki/docs/api/functions/decodeMessageNode)[Next Function: decodeSyncdMutations()](https://baileys.wiki/docs/api/functions/decodeSyncdMutations)
  * [Parameters](https://baileys.wiki/docs/api/functions/decodePatches/#parameters)
    * [name](https://baileys.wiki/docs/api/functions/decodePatches/#name)
    * [syncds](https://baileys.wiki/docs/api/functions/decodePatches/#syncds)
    * [initial](https://baileys.wiki/docs/api/functions/decodePatches/#initial)
    * [getAppStateSyncKey](https://baileys.wiki/docs/api/functions/decodePatches/#getappstatesynckey)
    * [options](https://baileys.wiki/docs/api/functions/decodePatches/#options)
    * [minimumVersionNumber?](https://baileys.wiki/docs/api/functions/decodePatches/#minimumversionnumber)
    * [logger?](https://baileys.wiki/docs/api/functions/decodePatches/#logger)
    * [validateMacs?](https://baileys.wiki/docs/api/functions/decodePatches/#validatemacs)
  * [Returns](https://baileys.wiki/docs/api/functions/decodePatches/#returns)
