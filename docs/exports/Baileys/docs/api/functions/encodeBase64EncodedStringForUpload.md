# Source: https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload

<!-- Scraped from https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload -->

[Skip to main content](https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:172](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L172)
## Parameters[​](https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload/#parameters "Direct link to Parameters")
### b64[​](https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload/#b64 "Direct link to b64")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/encodeBase64EncodedStringForUpload.md)
[Previous Function: downloadMediaMessage()](https://baileys.wiki/docs/api/functions/downloadMediaMessage)[Next Function: encodeBigEndian()](https://baileys.wiki/docs/api/functions/encodeBigEndian)
  * [Parameters](https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload/#parameters)
    * [b64](https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload/#b64)
  * [Returns](https://baileys.wiki/docs/api/functions/encodeBase64EncodedStringForUpload/#returns)
