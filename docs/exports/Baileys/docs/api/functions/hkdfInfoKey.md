# Source: https://baileys.wiki/docs/api/functions/hkdfInfoKey

<!-- Scraped from https://baileys.wiki/docs/api/functions/hkdfInfoKey -->

[Skip to main content](https://baileys.wiki/docs/api/functions/hkdfInfoKey/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:48](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L48)
## Parameters[​](https://baileys.wiki/docs/api/functions/hkdfInfoKey/#parameters "Direct link to Parameters")
### type[​](https://baileys.wiki/docs/api/functions/hkdfInfoKey/#type "Direct link to type")
...
## Returns[​](https://baileys.wiki/docs/api/functions/hkdfInfoKey/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/hkdfInfoKey.md)
[Previous Function: hkdf()](https://baileys.wiki/docs/api/functions/hkdf)[Next Function: hmacSign()](https://baileys.wiki/docs/api/functions/hmacSign)
  * [Parameters](https://baileys.wiki/docs/api/functions/hkdfInfoKey/#parameters)
    * [type](https://baileys.wiki/docs/api/functions/hkdfInfoKey/#type)
  * [Returns](https://baileys.wiki/docs/api/functions/hkdfInfoKey/#returns)
