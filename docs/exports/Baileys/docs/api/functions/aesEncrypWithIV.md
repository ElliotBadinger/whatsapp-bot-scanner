# Source: https://baileys.wiki/docs/api/functions/aesEncrypWithIV

<!-- Scraped from https://baileys.wiki/docs/api/functions/aesEncrypWithIV -->

[Skip to main content](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/crypto.ts:103](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/crypto.ts#L103)
## Parameters[​](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#buffer "Direct link to buffer")
`Buffer`
### key[​](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#key "Direct link to key")
`Buffer`
### IV[​](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#iv "Direct link to IV")
`Buffer`
## Returns[​](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#returns "Direct link to Returns")
`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/aesEncrypWithIV.md)
[Previous Function: aesDecryptWithIV()](https://baileys.wiki/docs/api/functions/aesDecryptWithIV)[Next Function: aesEncrypt()](https://baileys.wiki/docs/api/functions/aesEncrypt)
  * [Parameters](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#buffer)
    * [key](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#key)
    * [IV](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#iv)
  * [Returns](https://baileys.wiki/docs/api/functions/aesEncrypWithIV/#returns)
