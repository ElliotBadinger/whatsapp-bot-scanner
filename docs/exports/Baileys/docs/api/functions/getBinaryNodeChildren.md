# Source: https://baileys.wiki/docs/api/functions/getBinaryNodeChildren

<!-- Scraped from https://baileys.wiki/docs/api/functions/getBinaryNodeChildren -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: getBinaryNodeChildren()
> **getBinaryNodeChildren**(`node`, `childTag`): [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)[]
Defined in: [src/WABinary/generic-utils.ts:7](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/WABinary/generic-utils.ts#L7)
## Parameters[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren/#parameters "Direct link to Parameters")
### node[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren/#node "Direct link to node")
`undefined` | [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
### childTag[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren/#childtag "Direct link to childTag")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren/#returns "Direct link to Returns")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)[]
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getBinaryNodeChildren.md)
[Previous Function: getBinaryNodeChildUInt()](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt)[Next Function: getBinaryNodeMessages()](https://baileys.wiki/docs/api/functions/getBinaryNodeMessages)
  * [Parameters](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren/#parameters)
    * [node](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren/#node)
    * [childTag](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren/#childtag)
  * [Returns](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren/#returns)
