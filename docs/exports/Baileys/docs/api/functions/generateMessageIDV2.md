# Source: https://baileys.wiki/docs/api/functions/generateMessageIDV2

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateMessageIDV2 -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateMessageIDV2/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:178](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L178)
## Parameters[​](https://baileys.wiki/docs/api/functions/generateMessageIDV2/#parameters "Direct link to Parameters")
### userId?[​](https://baileys.wiki/docs/api/functions/generateMessageIDV2/#userid "Direct link to userId?")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/generateMessageIDV2/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateMessageIDV2.md)
[Previous Function: generateMessageID()](https://baileys.wiki/docs/api/functions/generateMessageID)[Next Function: generateOrGetPreKeys()](https://baileys.wiki/docs/api/functions/generateOrGetPreKeys)
  * [Parameters](https://baileys.wiki/docs/api/functions/generateMessageIDV2/#parameters)
    * [userId?](https://baileys.wiki/docs/api/functions/generateMessageIDV2/#userid)
  * [Returns](https://baileys.wiki/docs/api/functions/generateMessageIDV2/#returns)
