# Source: https://baileys.wiki/docs/api/functions/jidNormalizedUser

<!-- Scraped from https://baileys.wiki/docs/api/functions/jidNormalizedUser -->

[Skip to main content](https://baileys.wiki/docs/api/functions/jidNormalizedUser/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/jid-utils.ts:113](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L113)
## Parameters[​](https://baileys.wiki/docs/api/functions/jidNormalizedUser/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/jidNormalizedUser/#jid "Direct link to jid")
`undefined` | `string`
## Returns[​](https://baileys.wiki/docs/api/functions/jidNormalizedUser/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/jidNormalizedUser.md)
[Previous Function: jidEncode()](https://baileys.wiki/docs/api/functions/jidEncode)[Next Function: makeCacheableSignalKeyStore()](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore)
  * [Parameters](https://baileys.wiki/docs/api/functions/jidNormalizedUser/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/jidNormalizedUser/#jid)
  * [Returns](https://baileys.wiki/docs/api/functions/jidNormalizedUser/#returns)
