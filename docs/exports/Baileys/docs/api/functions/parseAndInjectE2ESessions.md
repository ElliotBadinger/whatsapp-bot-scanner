# Source: https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions

<!-- Scraped from https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions -->

[Skip to main content](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: parseAndInjectE2ESessions()


On this page
# Function: parseAndInjectE2ESessions()
> **parseAndInjectE2ESessions**(`node`, `repository`): `Promise`<`void`>
Defined in: [src/Utils/signal.ts:90](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/signal.ts#L90)
## Parameters[​](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions/#parameters "Direct link to Parameters")
### node[​](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions/#node "Direct link to node")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
### repository[​](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions/#repository "Direct link to repository")
[`SignalRepositoryWithLIDStore`](https://baileys.wiki/docs/api/interfaces/SignalRepositoryWithLIDStore)
## Returns[​](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions/#returns "Direct link to Returns")
`Promise`<`void`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/parseAndInjectE2ESessions.md)
[Previous Function: normalizeMessageContent()](https://baileys.wiki/docs/api/functions/normalizeMessageContent)[Next Function: prepareDisappearingMessageSettingContent()](https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent)
  * [Parameters](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions/#parameters)
    * [node](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions/#node)
    * [repository](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions/#repository)
  * [Returns](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions/#returns)
