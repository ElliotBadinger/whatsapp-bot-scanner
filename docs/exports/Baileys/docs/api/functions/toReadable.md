# Source: https://baileys.wiki/docs/api/functions/toReadable

<!-- Scraped from https://baileys.wiki/docs/api/functions/toReadable -->

[Skip to main content](https://baileys.wiki/docs/api/functions/toReadable/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:286](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages-media.ts#L286)
## Parameters[​](https://baileys.wiki/docs/api/functions/toReadable/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/toReadable/#buffer "Direct link to buffer")
`Buffer`
## Returns[​](https://baileys.wiki/docs/api/functions/toReadable/#returns "Direct link to Returns")
`Readable`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/toReadable.md)
[Previous Function: toNumber()](https://baileys.wiki/docs/api/functions/toNumber)[Next Function: transferDevice()](https://baileys.wiki/docs/api/functions/transferDevice)
  * [Parameters](https://baileys.wiki/docs/api/functions/toReadable/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/toReadable/#buffer)
  * [Returns](https://baileys.wiki/docs/api/functions/toReadable/#returns)
