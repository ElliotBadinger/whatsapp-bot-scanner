# Source: https://baileys.wiki/docs/api/functions/generateMessageID

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateMessageID -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateMessageID/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/generics.ts:198](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L198)

## Returns[​](https://baileys.wiki/docs/api/functions/generateMessageID/#returns "Direct link to Returns")

`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateMessageID.md)
[Previous Function: generateMdTagPrefix()](https://baileys.wiki/docs/api/functions/generateMdTagPrefix)[Next Function: generateMessageIDV2()](https://baileys.wiki/docs/api/functions/generateMessageIDV2)

- [Returns](https://baileys.wiki/docs/api/functions/generateMessageID/#returns)
