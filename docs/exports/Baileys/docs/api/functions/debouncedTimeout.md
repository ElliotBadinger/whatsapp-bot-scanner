# Source: https://baileys.wiki/docs/api/functions/debouncedTimeout

<!-- Scraped from https://baileys.wiki/docs/api/functions/debouncedTimeout -->

[Skip to main content](https://baileys.wiki/docs/api/functions/debouncedTimeout/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/generics.ts:103](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L103)

## Parameters[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#parameters "Direct link to Parameters")

### intervalMs[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#intervalms "Direct link to intervalMs")

`number` = `1000`

### task?[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#task "Direct link to task?")

() => `void`

## Returns[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#returns "Direct link to Returns")

`object`

### cancel()[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#cancel "Direct link to cancel()")

> **cancel** : () => `void`

#### Returns[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#returns-1 "Direct link to Returns")

`void`

### setInterval()[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#setinterval "Direct link to setInterval()")

> **setInterval** : (`newInterval`) => `number`

#### Parameters[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#parameters-1 "Direct link to Parameters")

##### newInterval[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#newinterval "Direct link to newInterval")

`number`

#### Returns[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#returns-2 "Direct link to Returns")

`number`

### setTask()[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#settask "Direct link to setTask()")

> **setTask** : (`newTask`) => () => `void`

#### Parameters[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#parameters-2 "Direct link to Parameters")

##### newTask[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#newtask "Direct link to newTask")

() => `void`

#### Returns[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#returns-3 "Direct link to Returns")

`Function`

##### Returns[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#returns-4 "Direct link to Returns")

`void`

### start()[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#start "Direct link to start()")

> **start** : (`newIntervalMs`?, `newTask`?) => `void`

#### Parameters[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#parameters-3 "Direct link to Parameters")

##### newIntervalMs?[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#newintervalms "Direct link to newIntervalMs?")

`number`

##### newTask?[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#newtask-1 "Direct link to newTask?")

() => `void`

#### Returns[​](https://baileys.wiki/docs/api/functions/debouncedTimeout/#returns-5 "Direct link to Returns")

`void`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/debouncedTimeout.md)
[Previous Function: createSignalIdentity()](https://baileys.wiki/docs/api/functions/createSignalIdentity)[Next Function: decodeBinaryNode()](https://baileys.wiki/docs/api/functions/decodeBinaryNode)

- [Parameters](https://baileys.wiki/docs/api/functions/debouncedTimeout/#parameters)
  - [intervalMs](https://baileys.wiki/docs/api/functions/debouncedTimeout/#intervalms)
  - [task?](https://baileys.wiki/docs/api/functions/debouncedTimeout/#task)
- [Returns](https://baileys.wiki/docs/api/functions/debouncedTimeout/#returns)
  - [cancel()](https://baileys.wiki/docs/api/functions/debouncedTimeout/#cancel)
  - [setInterval()](https://baileys.wiki/docs/api/functions/debouncedTimeout/#setinterval)
  - [setTask()](https://baileys.wiki/docs/api/functions/debouncedTimeout/#settask)
  - [start()](https://baileys.wiki/docs/api/functions/debouncedTimeout/#start)
