# Source: https://baileys.wiki/docs/api/functions/getHttpStream

<!-- Scraped from https://baileys.wiki/docs/api/functions/getHttpStream -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getHttpStream/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/messages-media.ts:364](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L364)

## Parameters[​](https://baileys.wiki/docs/api/functions/getHttpStream/#parameters "Direct link to Parameters")

### url[​](https://baileys.wiki/docs/api/functions/getHttpStream/#url "Direct link to url")

`string` | `URL`

### options[​](https://baileys.wiki/docs/api/functions/getHttpStream/#options "Direct link to options")

`RequestInit` & `object` = `{}`

## Returns[​](https://baileys.wiki/docs/api/functions/getHttpStream/#returns "Direct link to Returns")

`Promise`<`Readable`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getHttpStream.md)
[Previous Function: getHistoryMsg()](https://baileys.wiki/docs/api/functions/getHistoryMsg)[Next Function: getKeyAuthor()](https://baileys.wiki/docs/api/functions/getKeyAuthor)

- [Parameters](https://baileys.wiki/docs/api/functions/getHttpStream/#parameters)
  - [url](https://baileys.wiki/docs/api/functions/getHttpStream/#url)
  - [options](https://baileys.wiki/docs/api/functions/getHttpStream/#options)
- [Returns](https://baileys.wiki/docs/api/functions/getHttpStream/#returns)
