# Source: https://baileys.wiki/docs/api/functions/generateThumbnail

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateThumbnail -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateThumbnail/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/messages-media.ts:327](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L327)
> generates a thumbnail for a given media, if required

## Parameters[​](https://baileys.wiki/docs/api/functions/generateThumbnail/#parameters "Direct link to Parameters")

### file[​](https://baileys.wiki/docs/api/functions/generateThumbnail/#file "Direct link to file")

`string`

### mediaType[​](https://baileys.wiki/docs/api/functions/generateThumbnail/#mediatype "Direct link to mediaType")

`"image"` | `"video"`

### options[​](https://baileys.wiki/docs/api/functions/generateThumbnail/#options "Direct link to options")

#### logger?[​](https://baileys.wiki/docs/api/functions/generateThumbnail/#logger "Direct link to logger?")

`ILogger`

## Returns[​](https://baileys.wiki/docs/api/functions/generateThumbnail/#returns "Direct link to Returns")

`Promise`<{ `originalImageDimensions`: `undefined` | { `height`: `number`; `width`: `number`; }; `thumbnail`: `undefined` | `string`; }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateThumbnail.md)
[Previous Function: generateSignalPubKey()](https://baileys.wiki/docs/api/functions/generateSignalPubKey)[Next Function: generateWAMessage()](https://baileys.wiki/docs/api/functions/generateWAMessage)

- [Parameters](https://baileys.wiki/docs/api/functions/generateThumbnail/#parameters)
  - [file](https://baileys.wiki/docs/api/functions/generateThumbnail/#file)
  - [mediaType](https://baileys.wiki/docs/api/functions/generateThumbnail/#mediatype)
  - [options](https://baileys.wiki/docs/api/functions/generateThumbnail/#options)
- [Returns](https://baileys.wiki/docs/api/functions/generateThumbnail/#returns)
