# Source: https://baileys.wiki/docs/api/functions/binaryNodeToString

<!-- Scraped from https://baileys.wiki/docs/api/functions/binaryNodeToString -->

[Skip to main content](https://baileys.wiki/docs/api/functions/binaryNodeToString/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/generic-utils.ts:100](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/generic-utils.ts#L100)
## Parameters[​](https://baileys.wiki/docs/api/functions/binaryNodeToString/#parameters "Direct link to Parameters")
### node[​](https://baileys.wiki/docs/api/functions/binaryNodeToString/#node "Direct link to node")
`undefined` | `string` | [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode) | `Uint8Array`<`ArrayBufferLike`> | [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)[]
### i[​](https://baileys.wiki/docs/api/functions/binaryNodeToString/#i "Direct link to i")
`number` = `0`
## Returns[​](https://baileys.wiki/docs/api/functions/binaryNodeToString/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/binaryNodeToString.md)
[Previous Function: assertNodeErrorFree()](https://baileys.wiki/docs/api/functions/assertNodeErrorFree)[Next Function: bindWaitForConnectionUpdate()](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate)
  * [Parameters](https://baileys.wiki/docs/api/functions/binaryNodeToString/#parameters)
    * [node](https://baileys.wiki/docs/api/functions/binaryNodeToString/#node)
    * [i](https://baileys.wiki/docs/api/functions/binaryNodeToString/#i)
  * [Returns](https://baileys.wiki/docs/api/functions/binaryNodeToString/#returns)
