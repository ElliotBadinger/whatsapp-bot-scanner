# Source: https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt

<!-- Scraped from https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/WABinary/generic-utils.ts:45](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/generic-utils.ts#L45)

## Parameters[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#parameters "Direct link to Parameters")

### node[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#node "Direct link to node")

[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)

### childTag[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#childtag "Direct link to childTag")

`string`

### length[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#length "Direct link to length")

`number`

## Returns[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#returns "Direct link to Returns")

`undefined` | `number`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getBinaryNodeChildUInt.md)
[Previous Function: getBinaryNodeChildString()](https://baileys.wiki/docs/api/functions/getBinaryNodeChildString)[Next Function: getBinaryNodeChildren()](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren)

- [Parameters](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#parameters)
  - [node](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#node)
  - [childTag](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#childtag)
  - [length](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#length)
- [Returns](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt/#returns)
