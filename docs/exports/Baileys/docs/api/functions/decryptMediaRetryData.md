# Source: https://baileys.wiki/docs/api/functions/decryptMediaRetryData

<!-- Scraped from https://baileys.wiki/docs/api/functions/decryptMediaRetryData -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: decryptMediaRetryData()
> **decryptMediaRetryData**(`__namedParameters`, `mediaKey`, `msgId`): `Promise`<[`MediaRetryNotification`](https://baileys.wiki/docs/api/namespaces/proto/classes/MediaRetryNotification)>
Defined in: [src/Utils/messages-media.ts:802](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L802)
## Parameters[​](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#__namedparameters "Direct link to __namedParameters")
#### ciphertext[​](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#ciphertext "Direct link to ciphertext")
`Uint8Array`
#### iv[​](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#iv "Direct link to iv")
`Uint8Array`
### mediaKey[​](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#mediakey "Direct link to mediaKey")
`Uint8Array`
### msgId[​](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#msgid "Direct link to msgId")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#returns "Direct link to Returns")
`Promise`<[`MediaRetryNotification`](https://baileys.wiki/docs/api/namespaces/proto/classes/MediaRetryNotification)>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decryptMediaRetryData.md)
[Previous Function: decryptEventResponse()](https://baileys.wiki/docs/api/functions/decryptEventResponse)[Next Function: decryptMessageNode()](https://baileys.wiki/docs/api/functions/decryptMessageNode)
  * [Parameters](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#__namedparameters)
    * [mediaKey](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#mediakey)
    * [msgId](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#msgid)
  * [Returns](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#returns)
