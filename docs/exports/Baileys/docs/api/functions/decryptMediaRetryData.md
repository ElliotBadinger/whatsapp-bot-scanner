...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#**namedparameters "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#parameters)
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/decryptMediaRetryData/#__namedparameters)
