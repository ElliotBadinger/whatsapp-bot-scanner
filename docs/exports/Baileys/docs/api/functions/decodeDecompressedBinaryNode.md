# Source: https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode

<!-- Scraped from https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: decodeDecompressedBinaryNode()
> **decodeDecompressedBinaryNode**(`buffer`, `opts`, `indexRef`): [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
Defined in: [src/WABinary/decode.ts:20](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/decode.ts#L20)
## Parameters[​](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#buffer "Direct link to buffer")
`Buffer`
### opts[​](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#opts "Direct link to opts")
`Pick`<`__module`, `"TAGS"` | `"DOUBLE_BYTE_TOKENS"` | `"SINGLE_BYTE_TOKENS"`>
### indexRef[​](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#indexref "Direct link to indexRef")
#### index[​](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#index "Direct link to index")
`number`
## Returns[​](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#returns "Direct link to Returns")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decodeDecompressedBinaryNode.md)
[Previous Function: decodeBinaryNode()](https://baileys.wiki/docs/api/functions/decodeBinaryNode)[Next Function: decodeMediaRetryNode()](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode)
  * [Parameters](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#buffer)
    * [opts](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#opts)
    * [indexRef](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#indexref)
  * [Returns](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode/#returns)
