# Source: https://baileys.wiki/docs/api/functions/getServerFromDomainType

<!-- Scraped from https://baileys.wiki/docs/api/functions/getServerFromDomainType -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getServerFromDomainType/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: getServerFromDomainType()
> **getServerFromDomainType**(`initialServer`, `domainType`?): [`JidServer`](https://baileys.wiki/docs/api/type-aliases/JidServer)
Defined in: [src/WABinary/jid-utils.ts:37](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/WABinary/jid-utils.ts#L37)
## Parameters[​](https://baileys.wiki/docs/api/functions/getServerFromDomainType/#parameters "Direct link to Parameters")
### initialServer[​](https://baileys.wiki/docs/api/functions/getServerFromDomainType/#initialserver "Direct link to initialServer")
`string`
### domainType?[​](https://baileys.wiki/docs/api/functions/getServerFromDomainType/#domaintype "Direct link to domainType?")
[`WAJIDDomains`](https://baileys.wiki/docs/api/enumerations/WAJIDDomains)
## Returns[​](https://baileys.wiki/docs/api/functions/getServerFromDomainType/#returns "Direct link to Returns")
[`JidServer`](https://baileys.wiki/docs/api/type-aliases/JidServer)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getServerFromDomainType.md)
[Previous Function: getRawMediaUploadData()](https://baileys.wiki/docs/api/functions/getRawMediaUploadData)[Next Function: getStatusCodeForMediaRetry()](https://baileys.wiki/docs/api/functions/getStatusCodeForMediaRetry)
  * [Parameters](https://baileys.wiki/docs/api/functions/getServerFromDomainType/#parameters)
    * [initialServer](https://baileys.wiki/docs/api/functions/getServerFromDomainType/#initialserver)
    * [domainType?](https://baileys.wiki/docs/api/functions/getServerFromDomainType/#domaintype)
  * [Returns](https://baileys.wiki/docs/api/functions/getServerFromDomainType/#returns)
