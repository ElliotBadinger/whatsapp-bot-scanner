# Source: https://baileys.wiki/docs/api/functions/decodeMediaRetryNode

<!-- Scraped from https://baileys.wiki/docs/api/functions/decodeMediaRetryNode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:769](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L769)
## Parameters[​](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#parameters "Direct link to Parameters")
### node[​](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#node "Direct link to node")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
## Returns[​](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#returns "Direct link to Returns")
`object`
### error?[​](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#error "Direct link to error?")
> `optional` **error** : `Boom`<`any`>
### key[​](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#key "Direct link to key")
> **key** : [`WAMessageKey`](https://baileys.wiki/docs/api/type-aliases/WAMessageKey)
### media?[​](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#media "Direct link to media?")
> `optional` **media** : `object`
#### media.ciphertext[​](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#mediaciphertext "Direct link to media.ciphertext")
> **ciphertext** : `Uint8Array`
#### media.iv[​](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#mediaiv "Direct link to media.iv")
> **iv** : `Uint8Array`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decodeMediaRetryNode.md)
[Previous Function: decodeDecompressedBinaryNode()](https://baileys.wiki/docs/api/functions/decodeDecompressedBinaryNode)[Next Function: decodeMessageNode()](https://baileys.wiki/docs/api/functions/decodeMessageNode)
  * [Parameters](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#parameters)
    * [node](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#node)
  * [Returns](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#returns)
    * [error?](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#error)
    * [key](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#key)
    * [media?](https://baileys.wiki/docs/api/functions/decodeMediaRetryNode/#media)
