# Source: https://baileys.wiki/docs/api/functions/initAuthCreds

<!-- Scraped from https://baileys.wiki/docs/api/functions/initAuthCreds -->

[Skip to main content](https://baileys.wiki/docs/api/functions/initAuthCreds/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: initAuthCreds()
> **initAuthCreds**(): [`AuthenticationCreds`](https://baileys.wiki/docs/api/type-aliases/AuthenticationCreds)
Defined in: [src/Utils/auth-utils.ts:309](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/auth-utils.ts#L309)
## Returns[​](https://baileys.wiki/docs/api/functions/initAuthCreds/#returns "Direct link to Returns")
[`AuthenticationCreds`](https://baileys.wiki/docs/api/type-aliases/AuthenticationCreds)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/initAuthCreds.md)
[Previous Function: hmacSign()](https://baileys.wiki/docs/api/functions/hmacSign)[Next Function: isHostedLidUser()](https://baileys.wiki/docs/api/functions/isHostedLidUser)
  * [Returns](https://baileys.wiki/docs/api/functions/initAuthCreds/#returns)
