# Source: https://baileys.wiki/docs/api/functions/aesDecryptWithIV

<!-- Scraped from https://baileys.wiki/docs/api/functions/aesDecryptWithIV -->

[Skip to main content](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/crypto.ts:90](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/crypto.ts#L90)
decrypt AES 256 CBC
## Parameters[​](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#buffer "Direct link to buffer")
`Buffer`
### key[​](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#key "Direct link to key")
`Buffer`
### IV[​](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#iv "Direct link to IV")
`Buffer`
## Returns[​](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#returns "Direct link to Returns")
`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/aesDecryptWithIV.md)
[Previous Function: aesDecryptGCM()](https://baileys.wiki/docs/api/functions/aesDecryptGCM)[Next Function: aesEncrypWithIV()](https://baileys.wiki/docs/api/functions/aesEncrypWithIV)
  * [Parameters](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#buffer)
    * [key](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#key)
    * [IV](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#iv)
  * [Returns](https://baileys.wiki/docs/api/functions/aesDecryptWithIV/#returns)
