# Source: https://baileys.wiki/docs/api/functions/hmacSign

<!-- Scraped from https://baileys.wiki/docs/api/functions/hmacSign -->

[Skip to main content](https://baileys.wiki/docs/api/functions/hmacSign/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/crypto.ts:109](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/crypto.ts#L109)

## Parameters[​](https://baileys.wiki/docs/api/functions/hmacSign/#parameters "Direct link to Parameters")

### buffer[​](https://baileys.wiki/docs/api/functions/hmacSign/#buffer "Direct link to buffer")

`Uint8Array`<`ArrayBufferLike`> | `Buffer`<`ArrayBufferLike`>

### key[​](https://baileys.wiki/docs/api/functions/hmacSign/#key "Direct link to key")

`Uint8Array`<`ArrayBufferLike`> | `Buffer`<`ArrayBufferLike`>

### variant[​](https://baileys.wiki/docs/api/functions/hmacSign/#variant "Direct link to variant")

`"sha256"` | `"sha512"`

## Returns[​](https://baileys.wiki/docs/api/functions/hmacSign/#returns "Direct link to Returns")

`Buffer`<`ArrayBufferLike`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/hmacSign.md)
[Previous Function: hkdfInfoKey()](https://baileys.wiki/docs/api/functions/hkdfInfoKey)[Next Function: initAuthCreds()](https://baileys.wiki/docs/api/functions/initAuthCreds)

- [Parameters](https://baileys.wiki/docs/api/functions/hmacSign/#parameters)
  - [buffer](https://baileys.wiki/docs/api/functions/hmacSign/#buffer)
  - [key](https://baileys.wiki/docs/api/functions/hmacSign/#key)
  - [variant](https://baileys.wiki/docs/api/functions/hmacSign/#variant)
- [Returns](https://baileys.wiki/docs/api/functions/hmacSign/#returns)
