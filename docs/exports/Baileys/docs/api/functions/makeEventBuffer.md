# Source: https://baileys.wiki/docs/api/functions/makeEventBuffer

<!-- Scraped from https://baileys.wiki/docs/api/functions/makeEventBuffer -->

[Skip to main content](https://baileys.wiki/docs/api/functions/makeEventBuffer/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/event-buffer.ts:70](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/event-buffer.ts#L70)
The event buffer logically consolidates different events into a single event making the data processing more efficient.
## Parameters[​](https://baileys.wiki/docs/api/functions/makeEventBuffer/#parameters "Direct link to Parameters")
### logger[​](https://baileys.wiki/docs/api/functions/makeEventBuffer/#logger "Direct link to logger")
`ILogger`
## Returns[​](https://baileys.wiki/docs/api/functions/makeEventBuffer/#returns "Direct link to Returns")
`BaileysBufferableEventEmitter`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/makeEventBuffer.md)
[Previous Function: makeCacheableSignalKeyStore()](https://baileys.wiki/docs/api/functions/makeCacheableSignalKeyStore)[Next Function: makeNoiseHandler()](https://baileys.wiki/docs/api/functions/makeNoiseHandler)
  * [Parameters](https://baileys.wiki/docs/api/functions/makeEventBuffer/#parameters)
    * [logger](https://baileys.wiki/docs/api/functions/makeEventBuffer/#logger)
  * [Returns](https://baileys.wiki/docs/api/functions/makeEventBuffer/#returns)
