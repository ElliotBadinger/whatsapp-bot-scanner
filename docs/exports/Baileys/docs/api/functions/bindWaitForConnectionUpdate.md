# Source: https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate

<!-- Scraped from https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate -->

[Skip to main content](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: bindWaitForConnectionUpdate()


On this page
# Function: bindWaitForConnectionUpdate()
> **bindWaitForConnectionUpdate**(`ev`): (`check`, `timeoutMs`?) => `Promise`<`void`>
Defined in: [src/Utils/generics.ts:228](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L228)
## Parameters[​](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#parameters "Direct link to Parameters")
### ev[​](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#ev "Direct link to ev")
[`BaileysEventEmitter`](https://baileys.wiki/docs/api/interfaces/BaileysEventEmitter)
## Returns[​](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#returns "Direct link to Returns")
`Function`
### Parameters[​](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#parameters-1 "Direct link to Parameters")
#### check[​](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#check "Direct link to check")
(`u`) => `Promise`<`undefined` | `boolean`>
#### timeoutMs?[​](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#timeoutms "Direct link to timeoutMs?")
`number`
### Returns[​](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#returns-1 "Direct link to Returns")
`Promise`<`void`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/bindWaitForConnectionUpdate.md)
[Previous Function: binaryNodeToString()](https://baileys.wiki/docs/api/functions/binaryNodeToString)[Next Function: bindWaitForEvent()](https://baileys.wiki/docs/api/functions/bindWaitForEvent)
  * [Parameters](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#parameters)
    * [ev](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#ev)
  * [Returns](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#returns)
    * [Parameters](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#parameters-1)
    * [Returns](https://baileys.wiki/docs/api/functions/bindWaitForConnectionUpdate/#returns-1)
