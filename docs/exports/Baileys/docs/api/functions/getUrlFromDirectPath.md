# Source: https://baileys.wiki/docs/api/functions/getUrlFromDirectPath

<!-- Scraped from https://baileys.wiki/docs/api/functions/getUrlFromDirectPath -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getUrlFromDirectPath/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/messages-media.ts:504](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L504)

## Parameters[​](https://baileys.wiki/docs/api/functions/getUrlFromDirectPath/#parameters "Direct link to Parameters")

### directPath[​](https://baileys.wiki/docs/api/functions/getUrlFromDirectPath/#directpath "Direct link to directPath")

`string`

## Returns[​](https://baileys.wiki/docs/api/functions/getUrlFromDirectPath/#returns "Direct link to Returns")

`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getUrlFromDirectPath.md)
[Previous Function: getStream()](https://baileys.wiki/docs/api/functions/getStream)[Next Function: getUrlInfo()](https://baileys.wiki/docs/api/functions/getUrlInfo)

- [Parameters](https://baileys.wiki/docs/api/functions/getUrlFromDirectPath/#parameters)
  - [directPath](https://baileys.wiki/docs/api/functions/getUrlFromDirectPath/#directpath)
- [Returns](https://baileys.wiki/docs/api/functions/getUrlFromDirectPath/#returns)
