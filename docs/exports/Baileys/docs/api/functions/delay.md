# Source: https://baileys.wiki/docs/api/functions/delay

<!-- Scraped from https://baileys.wiki/docs/api/functions/delay -->

[Skip to main content](https://baileys.wiki/docs/api/functions/delay/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:121](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L121)
## Parameters[​](https://baileys.wiki/docs/api/functions/delay/#parameters "Direct link to Parameters")
### ms[​](https://baileys.wiki/docs/api/functions/delay/#ms "Direct link to ms")
`number`
## Returns[​](https://baileys.wiki/docs/api/functions/delay/#returns "Direct link to Returns")
`Promise`<`void`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/delay.md)
[Previous Function: decryptPollVote()](https://baileys.wiki/docs/api/functions/decryptPollVote)[Next Function: delayCancellable()](https://baileys.wiki/docs/api/functions/delayCancellable)
  * [Parameters](https://baileys.wiki/docs/api/functions/delay/#parameters)
    * [ms](https://baileys.wiki/docs/api/functions/delay/#ms)
  * [Returns](https://baileys.wiki/docs/api/functions/delay/#returns)
