# Source: https://baileys.wiki/docs/api/functions/generateWAMessage

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateWAMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateWAMessage/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: generateWAMessage()
> **generateWAMessage**(`jid`, `content`, `options`): `Promise`<[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)>
Defined in: [src/Utils/messages.ts:707](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages.ts#L707)
## Parameters[​](https://baileys.wiki/docs/api/functions/generateWAMessage/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/generateWAMessage/#jid "Direct link to jid")
`string`
### content[​](https://baileys.wiki/docs/api/functions/generateWAMessage/#content "Direct link to content")
[`AnyMessageContent`](https://baileys.wiki/docs/api/type-aliases/AnyMessageContent)
### options[​](https://baileys.wiki/docs/api/functions/generateWAMessage/#options "Direct link to options")
[`MessageGenerationOptions`](https://baileys.wiki/docs/api/type-aliases/MessageGenerationOptions)
## Returns[​](https://baileys.wiki/docs/api/functions/generateWAMessage/#returns "Direct link to Returns")
`Promise`<[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateWAMessage.md)
[Previous Function: generateThumbnail()](https://baileys.wiki/docs/api/functions/generateThumbnail)[Next Function: generateWAMessageContent()](https://baileys.wiki/docs/api/functions/generateWAMessageContent)
  * [Parameters](https://baileys.wiki/docs/api/functions/generateWAMessage/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/generateWAMessage/#jid)
    * [content](https://baileys.wiki/docs/api/functions/generateWAMessage/#content)
    * [options](https://baileys.wiki/docs/api/functions/generateWAMessage/#options)
  * [Returns](https://baileys.wiki/docs/api/functions/generateWAMessage/#returns)
