...
<!-- Scraped from https://baileys.wiki/docs/api/functions/getHistoryMsg -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getHistoryMsg/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: getHistoryMsg()
> **getHistoryMsg**(`message`): [`IHistorySyncNotification`](https://baileys.wiki/docs/api/namespaces/proto/namespaces/Message/interfaces/IHistorySyncNotification)
Defined in: [src/Utils/history.ts:109](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/history.ts#L109)
## Parameters[​](https://baileys.wiki/docs/api/functions/getHistoryMsg/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/getHistoryMsg/#message "Direct link to message")
[`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
## Returns[​](https://baileys.wiki/docs/api/functions/getHistoryMsg/#returns "Direct link to Returns")
...
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getHistoryMsg.md)
[Previous Function: getErrorCodeFromStreamError()](https://baileys.wiki/docs/api/functions/getErrorCodeFromStreamError)[Next Function: getHttpStream()](https://baileys.wiki/docs/api/functions/getHttpStream)
  * [Parameters](https://baileys.wiki/docs/api/functions/getHistoryMsg/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/getHistoryMsg/#message)
  * [Returns](https://baileys.wiki/docs/api/functions/getHistoryMsg/#returns)
