# Source: https://baileys.wiki/docs/api/functions/derivePairingCodeKey

<!-- Scraped from https://baileys.wiki/docs/api/functions/derivePairingCodeKey -->

[Skip to main content](https://baileys.wiki/docs/api/functions/derivePairingCodeKey/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/crypto.ts:159](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/crypto.ts#L159)

## Parameters[​](https://baileys.wiki/docs/api/functions/derivePairingCodeKey/#parameters "Direct link to Parameters")

### pairingCode[​](https://baileys.wiki/docs/api/functions/derivePairingCodeKey/#pairingcode "Direct link to pairingCode")

`string`

### salt[​](https://baileys.wiki/docs/api/functions/derivePairingCodeKey/#salt "Direct link to salt")

`Buffer`

## Returns[​](https://baileys.wiki/docs/api/functions/derivePairingCodeKey/#returns "Direct link to Returns")

`Promise`<`Buffer`<`ArrayBufferLike`>>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/derivePairingCodeKey.md)
[Previous Function: delayCancellable()](https://baileys.wiki/docs/api/functions/delayCancellable)[Next Function: downloadAndProcessHistorySyncNotification()](https://baileys.wiki/docs/api/functions/downloadAndProcessHistorySyncNotification)

- [Parameters](https://baileys.wiki/docs/api/functions/derivePairingCodeKey/#parameters)
  - [pairingCode](https://baileys.wiki/docs/api/functions/derivePairingCodeKey/#pairingcode)
  - [salt](https://baileys.wiki/docs/api/functions/derivePairingCodeKey/#salt)
- [Returns](https://baileys.wiki/docs/api/functions/derivePairingCodeKey/#returns)
