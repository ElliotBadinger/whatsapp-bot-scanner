# Source: https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage

<!-- Scraped from https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages.ts:874](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L874)
Aggregates all poll updates in a poll.
## Parameters[​](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage/#parameters "Direct link to Parameters")
### msg[​](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage/#msg "Direct link to msg")
`Pick`<[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage), `"message"` | `"pollUpdates"`>
the poll creation message
### meId?[​](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage/#meid "Direct link to meId?")
`string`
your jid
## Returns[​](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage/#returns "Direct link to Returns")
`VoteAggregation`[]
A list of options & their voters
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getAggregateVotesInPollMessage.md)
[Previous Function: getAggregateResponsesInEventMessage()](https://baileys.wiki/docs/api/functions/getAggregateResponsesInEventMessage)[Next Function: getAllBinaryNodeChildren()](https://baileys.wiki/docs/api/functions/getAllBinaryNodeChildren)
  * [Parameters](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage/#parameters)
    * [msg](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage/#msg)
    * [meId?](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage/#meid)
  * [Returns](https://baileys.wiki/docs/api/functions/getAggregateVotesInPollMessage/#returns)
