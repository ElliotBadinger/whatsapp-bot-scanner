# Source: https://baileys.wiki/docs/api/functions/isWABusinessPlatform

<!-- Scraped from https://baileys.wiki/docs/api/functions/isWABusinessPlatform -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isWABusinessPlatform/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: isWABusinessPlatform()


On this page
# Function: isWABusinessPlatform()
> **isWABusinessPlatform**(`platform`): platform is "smba" | "smbi"
Defined in: [src/Utils/generics.ts:429](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/generics.ts#L429)
Is the given platform WA business
## Parameters[​](https://baileys.wiki/docs/api/functions/isWABusinessPlatform/#parameters "Direct link to Parameters")
### platform[​](https://baileys.wiki/docs/api/functions/isWABusinessPlatform/#platform "Direct link to platform")
`string`
AuthenticationCreds.platform
## Returns[​](https://baileys.wiki/docs/api/functions/isWABusinessPlatform/#returns "Direct link to Returns")
platform is "smba" | "smbi"
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isWABusinessPlatform.md)
[Previous Function: isRealMessage()](https://baileys.wiki/docs/api/functions/isRealMessage)[Next Function: jidDecode()](https://baileys.wiki/docs/api/functions/jidDecode)
  * [Parameters](https://baileys.wiki/docs/api/functions/isWABusinessPlatform/#parameters)
    * [platform](https://baileys.wiki/docs/api/functions/isWABusinessPlatform/#platform)
  * [Returns](https://baileys.wiki/docs/api/functions/isWABusinessPlatform/#returns)
