# Source: https://baileys.wiki/docs/api/functions/delayCancellable

<!-- Scraped from https://baileys.wiki/docs/api/functions/delayCancellable -->

[Skip to main content](https://baileys.wiki/docs/api/functions/delayCancellable/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/generics.ts:123](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L123)

## Parameters[​](https://baileys.wiki/docs/api/functions/delayCancellable/#parameters "Direct link to Parameters")

### ms[​](https://baileys.wiki/docs/api/functions/delayCancellable/#ms "Direct link to ms")

`number`

## Returns[​](https://baileys.wiki/docs/api/functions/delayCancellable/#returns "Direct link to Returns")

`object`

### cancel()[​](https://baileys.wiki/docs/api/functions/delayCancellable/#cancel "Direct link to cancel()")

> **cancel** : () => `void`

#### Returns[​](https://baileys.wiki/docs/api/functions/delayCancellable/#returns-1 "Direct link to Returns")

`void`

### delay[​](https://baileys.wiki/docs/api/functions/delayCancellable/#delay "Direct link to delay")

> **delay** : `Promise`<`void`>
> [](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/delayCancellable.md)
> [Previous Function: delay()](https://baileys.wiki/docs/api/functions/delay)[Next Function: derivePairingCodeKey()](https://baileys.wiki/docs/api/functions/derivePairingCodeKey)

- [Parameters](https://baileys.wiki/docs/api/functions/delayCancellable/#parameters)
  - [ms](https://baileys.wiki/docs/api/functions/delayCancellable/#ms)
- [Returns](https://baileys.wiki/docs/api/functions/delayCancellable/#returns)
  - [cancel()](https://baileys.wiki/docs/api/functions/delayCancellable/#cancel)
  - [delay](https://baileys.wiki/docs/api/functions/delayCancellable/#delay)
