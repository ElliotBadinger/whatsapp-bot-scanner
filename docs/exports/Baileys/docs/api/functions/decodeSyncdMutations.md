# Source: https://baileys.wiki/docs/api/functions/decodeSyncdMutations

<!-- Scraped from https://baileys.wiki/docs/api/functions/decodeSyncdMutations -->

[Skip to main content](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/chat-utils.ts:205](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/chat-utils.ts#L205)
## Parameters[​](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#parameters "Direct link to Parameters")
### msgMutations[​](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#msgmutations "Direct link to msgMutations")
([`ISyncdMutation`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdMutation) | [`ISyncdRecord`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdRecord))[]
### initialState[​](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#initialstate "Direct link to initialState")
[`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState)
### getAppStateSyncKey[​](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#getappstatesynckey "Direct link to getAppStateSyncKey")
`FetchAppStateSyncKey`
### onMutation[​](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#onmutation "Direct link to onMutation")
(`mutation`) => `void`
### validateMacs[​](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#validatemacs "Direct link to validateMacs")
`boolean`
## Returns[​](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#returns "Direct link to Returns")
`Promise`<{ `hash`: `Buffer`<`ArrayBuffer`>; `indexValueMap`: {}; }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/decodeSyncdMutations.md)
[Previous Function: decodePatches()](https://baileys.wiki/docs/api/functions/decodePatches)[Next Function: decodeSyncdPatch()](https://baileys.wiki/docs/api/functions/decodeSyncdPatch)
  * [Parameters](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#parameters)
    * [msgMutations](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#msgmutations)
    * [initialState](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#initialstate)
    * [getAppStateSyncKey](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#getappstatesynckey)
    * [onMutation](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#onmutation)
    * [validateMacs](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#validatemacs)
  * [Returns](https://baileys.wiki/docs/api/functions/decodeSyncdMutations/#returns)
