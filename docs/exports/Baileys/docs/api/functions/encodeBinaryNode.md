# Source: https://baileys.wiki/docs/api/functions/encodeBinaryNode

<!-- Scraped from https://baileys.wiki/docs/api/functions/encodeBinaryNode -->

[Skip to main content](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/encode.ts:5](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/WABinary/encode.ts#L5)
## Parameters[​](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#parameters "Direct link to Parameters")
### node[​](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#node "Direct link to node")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
### opts[​](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#opts "Direct link to opts")
`Pick`<`__module`, `"TAGS"` | `"TOKEN_MAP"`> = `constants`
### buffer[​](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#buffer "Direct link to buffer")
`number`[] = `...`
## Returns[​](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#returns "Direct link to Returns")
`Buffer`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/encodeBinaryNode.md)
[Previous Function: encodeBigEndian()](https://baileys.wiki/docs/api/functions/encodeBigEndian)[Next Function: encodeNewsletterMessage()](https://baileys.wiki/docs/api/functions/encodeNewsletterMessage)
  * [Parameters](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#parameters)
    * [node](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#node)
    * [opts](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#opts)
    * [buffer](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#buffer)
  * [Returns](https://baileys.wiki/docs/api/functions/encodeBinaryNode/#returns)
