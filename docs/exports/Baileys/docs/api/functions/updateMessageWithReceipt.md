# Source: https://baileys.wiki/docs/api/functions/updateMessageWithReceipt

<!-- Scraped from https://baileys.wiki/docs/api/functions/updateMessageWithReceipt -->

[Skip to main content](https://baileys.wiki/docs/api/functions/updateMessageWithReceipt/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/messages.ts:818](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L818)
> Upserts a receipt in the message

## Parameters[​](https://baileys.wiki/docs/api/functions/updateMessageWithReceipt/#parameters "Direct link to Parameters")

### msg[​](https://baileys.wiki/docs/api/functions/updateMessageWithReceipt/#msg "Direct link to msg")

`Pick`<[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage), `"userReceipt"`>

### receipt[​](https://baileys.wiki/docs/api/functions/updateMessageWithReceipt/#receipt "Direct link to receipt")

[`IUserReceipt`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IUserReceipt)

## Returns[​](https://baileys.wiki/docs/api/functions/updateMessageWithReceipt/#returns "Direct link to Returns")

`void`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/updateMessageWithReceipt.md)
[Previous Function: updateMessageWithReaction()](https://baileys.wiki/docs/api/functions/updateMessageWithReaction)[Next Function: useMultiFileAuthState()](https://baileys.wiki/docs/api/functions/useMultiFileAuthState)

- [Parameters](https://baileys.wiki/docs/api/functions/updateMessageWithReceipt/#parameters)
  - [msg](https://baileys.wiki/docs/api/functions/updateMessageWithReceipt/#msg)
  - [receipt](https://baileys.wiki/docs/api/functions/updateMessageWithReceipt/#receipt)
- [Returns](https://baileys.wiki/docs/api/functions/updateMessageWithReceipt/#returns)
