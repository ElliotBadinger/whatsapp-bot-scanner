# Source: https://baileys.wiki/docs/api/functions/unpadRandomMax16

<!-- Scraped from https://baileys.wiki/docs/api/functions/unpadRandomMax16 -->

[Skip to main content](https://baileys.wiki/docs/api/functions/unpadRandomMax16/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: unpadRandomMax16()


On this page
# Function: unpadRandomMax16()
> **unpadRandomMax16**(`e`): `Uint8Array`<`ArrayBuffer`>
Defined in: [src/Utils/generics.ts:57](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/generics.ts#L57)
## Parameters[​](https://baileys.wiki/docs/api/functions/unpadRandomMax16/#parameters "Direct link to Parameters")
### e[​](https://baileys.wiki/docs/api/functions/unpadRandomMax16/#e "Direct link to e")
`Uint8Array`<`ArrayBufferLike`> | `Buffer`<`ArrayBufferLike`>
## Returns[​](https://baileys.wiki/docs/api/functions/unpadRandomMax16/#returns "Direct link to Returns")
`Uint8Array`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/unpadRandomMax16.md)
[Previous Function: unixTimestampSeconds()](https://baileys.wiki/docs/api/functions/unixTimestampSeconds)[Next Function: updateMessageWithEventResponse()](https://baileys.wiki/docs/api/functions/updateMessageWithEventResponse)
  * [Parameters](https://baileys.wiki/docs/api/functions/unpadRandomMax16/#parameters)
    * [e](https://baileys.wiki/docs/api/functions/unpadRandomMax16/#e)
  * [Returns](https://baileys.wiki/docs/api/functions/unpadRandomMax16/#returns)
