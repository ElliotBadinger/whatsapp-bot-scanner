# Source: https://baileys.wiki/docs/api/functions/isHostedLidUser

<!-- Scraped from https://baileys.wiki/docs/api/functions/isHostedLidUser -->

[Skip to main content](https://baileys.wiki/docs/api/functions/isHostedLidUser/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: isHostedLidUser()


On this page
# Function: isHostedLidUser()
> **isHostedLidUser**(`jid`): `undefined` | `boolean`
Defined in: [src/WABinary/jid-utils.ts:107](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L107)
is the jid a hosted LID
## Parameters[​](https://baileys.wiki/docs/api/functions/isHostedLidUser/#parameters "Direct link to Parameters")
### jid[​](https://baileys.wiki/docs/api/functions/isHostedLidUser/#jid "Direct link to jid")
`undefined` | `string`
## Returns[​](https://baileys.wiki/docs/api/functions/isHostedLidUser/#returns "Direct link to Returns")
`undefined` | `boolean`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/isHostedLidUser.md)
[Previous Function: initAuthCreds()](https://baileys.wiki/docs/api/functions/initAuthCreds)[Next Function: isHostedPnUser()](https://baileys.wiki/docs/api/functions/isHostedPnUser)
  * [Parameters](https://baileys.wiki/docs/api/functions/isHostedLidUser/#parameters)
    * [jid](https://baileys.wiki/docs/api/functions/isHostedLidUser/#jid)
  * [Returns](https://baileys.wiki/docs/api/functions/isHostedLidUser/#returns)
