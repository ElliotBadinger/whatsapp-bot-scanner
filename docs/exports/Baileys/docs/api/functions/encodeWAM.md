# Source: https://baileys.wiki/docs/api/functions/encodeWAM

<!-- Scraped from https://baileys.wiki/docs/api/functions/encodeWAM -->

[Skip to main content](https://baileys.wiki/docs/api/functions/encodeWAM/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WAM/encode.ts:15](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/WAM/encode.ts#L15)
## Parameters[​](https://baileys.wiki/docs/api/functions/encodeWAM/#parameters "Direct link to Parameters")
### binaryInfo[​](https://baileys.wiki/docs/api/functions/encodeWAM/#binaryinfo "Direct link to binaryInfo")
[`BinaryInfo`](https://baileys.wiki/docs/api/classes/BinaryInfo)
## Returns[​](https://baileys.wiki/docs/api/functions/encodeWAM/#returns "Direct link to Returns")
`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/encodeWAM.md)
[Previous Function: encodeSyncdPatch()](https://baileys.wiki/docs/api/functions/encodeSyncdPatch)[Next Function: encodeWAMessage()](https://baileys.wiki/docs/api/functions/encodeWAMessage)
  * [Parameters](https://baileys.wiki/docs/api/functions/encodeWAM/#parameters)
    * [binaryInfo](https://baileys.wiki/docs/api/functions/encodeWAM/#binaryinfo)
  * [Returns](https://baileys.wiki/docs/api/functions/encodeWAM/#returns)
