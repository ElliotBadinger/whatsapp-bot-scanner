# Source: https://baileys.wiki/docs/api/functions/cleanMessage

<!-- Scraped from https://baileys.wiki/docs/api/functions/cleanMessage -->

[Skip to main content](https://baileys.wiki/docs/api/functions/cleanMessage/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/process-message.ts:59](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/process-message.ts#L59)
Cleans a received message to further processing
## Parameters[​](https://baileys.wiki/docs/api/functions/cleanMessage/#parameters "Direct link to Parameters")
### message[​](https://baileys.wiki/docs/api/functions/cleanMessage/#message "Direct link to message")
[`WAMessage`](https://baileys.wiki/docs/api/type-aliases/WAMessage)
### meId[​](https://baileys.wiki/docs/api/functions/cleanMessage/#meid "Direct link to meId")
`string`
### meLid[​](https://baileys.wiki/docs/api/functions/cleanMessage/#melid "Direct link to meLid")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/cleanMessage/#returns "Direct link to Returns")
`void`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/cleanMessage.md)
[Previous Function: chatModificationToAppPatch()](https://baileys.wiki/docs/api/functions/chatModificationToAppPatch)[Next Function: configureSuccessfulPairing()](https://baileys.wiki/docs/api/functions/configureSuccessfulPairing)
  * [Parameters](https://baileys.wiki/docs/api/functions/cleanMessage/#parameters)
    * [message](https://baileys.wiki/docs/api/functions/cleanMessage/#message)
    * [meId](https://baileys.wiki/docs/api/functions/cleanMessage/#meid)
    * [meLid](https://baileys.wiki/docs/api/functions/cleanMessage/#melid)
  * [Returns](https://baileys.wiki/docs/api/functions/cleanMessage/#returns)
