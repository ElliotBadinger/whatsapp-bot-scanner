# Source: https://baileys.wiki/docs/api/functions/encodeSyncdPatch

<!-- Scraped from https://baileys.wiki/docs/api/functions/encodeSyncdPatch -->

[Skip to main content](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: encodeSyncdPatch()
> **encodeSyncdPatch**(`__namedParameters`, `myAppStateKeyId`, `state`, `getAppStateSyncKey`): `Promise`<{ `patch`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch); `state`: [`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState); }>
Defined in: [src/Utils/chat-utils.ts:140](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/chat-utils.ts#L140)
## Parameters[​](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#__namedparameters "Direct link to __namedParameters")
[`WAPatchCreate`](https://baileys.wiki/docs/api/type-aliases/WAPatchCreate)
### myAppStateKeyId[​](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#myappstatekeyid "Direct link to myAppStateKeyId")
`string`
### state[​](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#state "Direct link to state")
[`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState)
### getAppStateSyncKey[​](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#getappstatesynckey "Direct link to getAppStateSyncKey")
`FetchAppStateSyncKey`
## Returns[​](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#returns "Direct link to Returns")
`Promise`<{ `patch`: [`ISyncdPatch`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/ISyncdPatch); `state`: [`LTHashState`](https://baileys.wiki/docs/api/type-aliases/LTHashState); }>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/encodeSyncdPatch.md)
[Previous Function: encodeSignedDeviceIdentity()](https://baileys.wiki/docs/api/functions/encodeSignedDeviceIdentity)[Next Function: encodeWAM()](https://baileys.wiki/docs/api/functions/encodeWAM)
  * [Parameters](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#__namedparameters)
    * [myAppStateKeyId](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#myappstatekeyid)
    * [state](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#state)
    * [getAppStateSyncKey](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#getappstatesynckey)
  * [Returns](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#returns)
