...
### **namedParameters[​](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#**namedparameters "Direct link to \_\_namedParameters")
...
- [Parameters](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#parameters)
  - [\_\_namedParameters](https://baileys.wiki/docs/api/functions/encodeSyncdPatch/#__namedparameters)
