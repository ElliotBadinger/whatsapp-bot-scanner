# Source: https://baileys.wiki/docs/api/functions/getBinaryNodeMessages

<!-- Scraped from https://baileys.wiki/docs/api/functions/getBinaryNodeMessages -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getBinaryNodeMessages/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: getBinaryNodeMessages()


On this page
# Function: getBinaryNodeMessages()
> **getBinaryNodeMessages**(`__namedParameters`): [`WebMessageInfo`](https://baileys.wiki/docs/api/namespaces/proto/classes/WebMessageInfo)[]
Defined in: [src/WABinary/generic-utils.ts:76](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/generic-utils.ts#L76)
## Parameters[​](https://baileys.wiki/docs/api/functions/getBinaryNodeMessages/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/getBinaryNodeMessages/#__namedparameters "Direct link to __namedParameters")
[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)
## Returns[​](https://baileys.wiki/docs/api/functions/getBinaryNodeMessages/#returns "Direct link to Returns")
[`WebMessageInfo`](https://baileys.wiki/docs/api/namespaces/proto/classes/WebMessageInfo)[]
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getBinaryNodeMessages.md)
[Previous Function: getBinaryNodeChildren()](https://baileys.wiki/docs/api/functions/getBinaryNodeChildren)[Next Function: getCallStatusFromNode()](https://baileys.wiki/docs/api/functions/getCallStatusFromNode)
  * [Parameters](https://baileys.wiki/docs/api/functions/getBinaryNodeMessages/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/getBinaryNodeMessages/#__namedparameters)
  * [Returns](https://baileys.wiki/docs/api/functions/getBinaryNodeMessages/#returns)
