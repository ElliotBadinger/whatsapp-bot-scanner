# Source: https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent

<!-- Scraped from https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent -->

[Skip to main content](https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent/#__docusaurus_skipToContent_fallback)
...
[Sponsor](https://purpshell.dev/sponsor "Sponsor")[Discord](https://whiskey.so/discord "Discord")[GitHub](https://github.com/WhiskeySockets/Baileys "GitHub")
  ...
  * [](https://baileys.wiki/)
  * functions
  * Function: prepareDisappearingMessageSettingContent()


On this page
# Function: prepareDisappearingMessageSettingContent()
> **prepareDisappearingMessageSettingContent**(`ephemeralExpiration`?): [`Message`](https://baileys.wiki/docs/api/namespaces/proto/classes/Message)
Defined in: [src/Utils/messages.ts:318](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages.ts#L318)
## Parameters[​](https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent/#parameters "Direct link to Parameters")
### ephemeralExpiration?[​](https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent/#ephemeralexpiration "Direct link to ephemeralExpiration?")
`number`
## Returns[​](https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent/#returns "Direct link to Returns")
[`Message`](https://baileys.wiki/docs/api/namespaces/proto/classes/Message)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/prepareDisappearingMessageSettingContent.md)
[Previous Function: parseAndInjectE2ESessions()](https://baileys.wiki/docs/api/functions/parseAndInjectE2ESessions)[Next Function: prepareWAMessageMedia()](https://baileys.wiki/docs/api/functions/prepareWAMessageMedia)
  * [Parameters](https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent/#parameters)
    * [ephemeralExpiration?](https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent/#ephemeralexpiration)
  * [Returns](https://baileys.wiki/docs/api/functions/prepareDisappearingMessageSettingContent/#returns)
