# Source: https://baileys.wiki/docs/api/functions/toBuffer

<!-- Scraped from https://baileys.wiki/docs/api/functions/toBuffer -->

[Skip to main content](https://baileys.wiki/docs/api/functions/toBuffer/#__docusaurus_skipToContent_fallback)
...
> Defined in: [src/Utils/messages-media.ts:293](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L293)

## Parameters[​](https://baileys.wiki/docs/api/functions/toBuffer/#parameters "Direct link to Parameters")

### stream[​](https://baileys.wiki/docs/api/functions/toBuffer/#stream "Direct link to stream")

`Readable`

## Returns[​](https://baileys.wiki/docs/api/functions/toBuffer/#returns "Direct link to Returns")

`Promise`<`Buffer`<`ArrayBuffer`>>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/toBuffer.md)
[Previous Function: signedKeyPair()](https://baileys.wiki/docs/api/functions/signedKeyPair)[Next Function: toNumber()](https://baileys.wiki/docs/api/functions/toNumber)

- [Parameters](https://baileys.wiki/docs/api/functions/toBuffer/#parameters)
  - [stream](https://baileys.wiki/docs/api/functions/toBuffer/#stream)
- [Returns](https://baileys.wiki/docs/api/functions/toBuffer/#returns)
