# Source: https://baileys.wiki/docs/api/functions/generateRegistrationId

<!-- Scraped from https://baileys.wiki/docs/api/functions/generateRegistrationId -->

[Skip to main content](https://baileys.wiki/docs/api/functions/generateRegistrationId/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:80](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L80)
## Returns[​](https://baileys.wiki/docs/api/functions/generateRegistrationId/#returns "Direct link to Returns")
`number`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/generateRegistrationId.md)
[Previous Function: generateProfilePicture()](https://baileys.wiki/docs/api/functions/generateProfilePicture)[Next Function: generateRegistrationNode()](https://baileys.wiki/docs/api/functions/generateRegistrationNode)
  * [Returns](https://baileys.wiki/docs/api/functions/generateRegistrationId/#returns)
