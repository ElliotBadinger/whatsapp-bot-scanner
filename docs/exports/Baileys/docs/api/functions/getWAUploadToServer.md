# Source: https://baileys.wiki/docs/api/functions/getWAUploadToServer

<!-- Scraped from https://baileys.wiki/docs/api/functions/getWAUploadToServer -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getWAUploadToServer/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: getWAUploadToServer()
> **getWAUploadToServer**(`__namedParameters`, `refreshMediaConn`): [`WAMediaUploadFunction`](https://baileys.wiki/docs/api/type-aliases/WAMediaUploadFunction)
Defined in: [src/Utils/messages-media.ts:642](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages-media.ts#L642)
## Parameters[​](https://baileys.wiki/docs/api/functions/getWAUploadToServer/#parameters "Direct link to Parameters")
### __namedParameters[​](https://baileys.wiki/docs/api/functions/getWAUploadToServer/#__namedparameters "Direct link to __namedParameters")
[`SocketConfig`](https://baileys.wiki/docs/api/type-aliases/SocketConfig)
### refreshMediaConn[​](https://baileys.wiki/docs/api/functions/getWAUploadToServer/#refreshmediaconn "Direct link to refreshMediaConn")
(`force`) => `Promise`<[`MediaConnInfo`](https://baileys.wiki/docs/api/type-aliases/MediaConnInfo)>
## Returns[​](https://baileys.wiki/docs/api/functions/getWAUploadToServer/#returns "Direct link to Returns")
[`WAMediaUploadFunction`](https://baileys.wiki/docs/api/type-aliases/WAMediaUploadFunction)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getWAUploadToServer.md)
[Previous Function: getUrlInfo()](https://baileys.wiki/docs/api/functions/getUrlInfo)[Next Function: hkdf()](https://baileys.wiki/docs/api/functions/hkdf)
  * [Parameters](https://baileys.wiki/docs/api/functions/getWAUploadToServer/#parameters)
    * [__namedParameters](https://baileys.wiki/docs/api/functions/getWAUploadToServer/#__namedparameters)
    * [refreshMediaConn](https://baileys.wiki/docs/api/functions/getWAUploadToServer/#refreshmediaconn)
  * [Returns](https://baileys.wiki/docs/api/functions/getWAUploadToServer/#returns)
