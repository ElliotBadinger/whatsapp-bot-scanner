# Source: https://baileys.wiki/docs/api/functions/getBinaryNodeChildString

<!-- Scraped from https://baileys.wiki/docs/api/functions/getBinaryNodeChildString -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getBinaryNodeChildString/#__docusaurus_skipToContent_fallback)
...
- [](https://baileys.wiki/)
- functions
- Function: getBinaryNodeChildString()
...
> Defined in: [src/WABinary/generic-utils.ts:36](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/generic-utils.ts#L36)

## Parameters[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildString/#parameters "Direct link to Parameters")

### node[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildString/#node "Direct link to node")

`undefined` | [`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)

### childTag[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildString/#childtag "Direct link to childTag")

`string`

## Returns[​](https://baileys.wiki/docs/api/functions/getBinaryNodeChildString/#returns "Direct link to Returns")

`undefined` | `string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getBinaryNodeChildString.md)
[Previous Function: getBinaryNodeChildBuffer()](https://baileys.wiki/docs/api/functions/getBinaryNodeChildBuffer)[Next Function: getBinaryNodeChildUInt()](https://baileys.wiki/docs/api/functions/getBinaryNodeChildUInt)

- [Parameters](https://baileys.wiki/docs/api/functions/getBinaryNodeChildString/#parameters)
  - [node](https://baileys.wiki/docs/api/functions/getBinaryNodeChildString/#node)
  - [childTag](https://baileys.wiki/docs/api/functions/getBinaryNodeChildString/#childtag)
- [Returns](https://baileys.wiki/docs/api/functions/getBinaryNodeChildString/#returns)
