# Source: https://baileys.wiki/docs/api/functions/transferDevice

<!-- Scraped from https://baileys.wiki/docs/api/functions/transferDevice -->

[Skip to main content](https://baileys.wiki/docs/api/functions/transferDevice/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/WABinary/jid-utils.ts:123](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/WABinary/jid-utils.ts#L123)
## Parameters[​](https://baileys.wiki/docs/api/functions/transferDevice/#parameters "Direct link to Parameters")
### fromJid[​](https://baileys.wiki/docs/api/functions/transferDevice/#fromjid "Direct link to fromJid")
`string`
### toJid[​](https://baileys.wiki/docs/api/functions/transferDevice/#tojid "Direct link to toJid")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/transferDevice/#returns "Direct link to Returns")
`string`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/transferDevice.md)
[Previous Function: toReadable()](https://baileys.wiki/docs/api/functions/toReadable)[Next Function: trimUndefined()](https://baileys.wiki/docs/api/functions/trimUndefined)
  * [Parameters](https://baileys.wiki/docs/api/functions/transferDevice/#parameters)
    * [fromJid](https://baileys.wiki/docs/api/functions/transferDevice/#fromjid)
    * [toJid](https://baileys.wiki/docs/api/functions/transferDevice/#tojid)
  * [Returns](https://baileys.wiki/docs/api/functions/transferDevice/#returns)
