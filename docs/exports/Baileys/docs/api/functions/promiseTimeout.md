# Source: https://baileys.wiki/docs/api/functions/promiseTimeout

<!-- Scraped from https://baileys.wiki/docs/api/functions/promiseTimeout -->

[Skip to main content](https://baileys.wiki/docs/api/functions/promiseTimeout/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/generics.ts:146](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/generics.ts#L146)
## Type Parameters[​](https://baileys.wiki/docs/api/functions/promiseTimeout/#type-parameters "Direct link to Type Parameters")
• **T**
## Parameters[​](https://baileys.wiki/docs/api/functions/promiseTimeout/#parameters "Direct link to Parameters")
### ms[​](https://baileys.wiki/docs/api/functions/promiseTimeout/#ms "Direct link to ms")
`undefined` | `number`
### promise[​](https://baileys.wiki/docs/api/functions/promiseTimeout/#promise "Direct link to promise")
(`resolve`, `reject`) => `void`
## Returns[​](https://baileys.wiki/docs/api/functions/promiseTimeout/#returns "Direct link to Returns")
`Promise`<`T`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/promiseTimeout.md)
[Previous Function: processSyncAction()](https://baileys.wiki/docs/api/functions/processSyncAction)[Next Function: reduceBinaryNodeToDictionary()](https://baileys.wiki/docs/api/functions/reduceBinaryNodeToDictionary)
  * [Type Parameters](https://baileys.wiki/docs/api/functions/promiseTimeout/#type-parameters)
  * [Parameters](https://baileys.wiki/docs/api/functions/promiseTimeout/#parameters)
    * [ms](https://baileys.wiki/docs/api/functions/promiseTimeout/#ms)
    * [promise](https://baileys.wiki/docs/api/functions/promiseTimeout/#promise)
  * [Returns](https://baileys.wiki/docs/api/functions/promiseTimeout/#returns)
