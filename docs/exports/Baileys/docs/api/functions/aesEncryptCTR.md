# Source: https://baileys.wiki/docs/api/functions/aesEncryptCTR

<!-- Scraped from https://baileys.wiki/docs/api/functions/aesEncryptCTR -->

[Skip to main content](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/crypto.ts:74](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/crypto.ts#L74)
## Parameters[​](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#parameters "Direct link to Parameters")
### plaintext[​](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#plaintext "Direct link to plaintext")
`Uint8Array`
### key[​](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#key "Direct link to key")
`Uint8Array`
### iv[​](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#iv "Direct link to iv")
`Uint8Array`
## Returns[​](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#returns "Direct link to Returns")
`Buffer`<`ArrayBuffer`>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/aesEncryptCTR.md)
[Previous Function: aesEncrypt()](https://baileys.wiki/docs/api/functions/aesEncrypt)[Next Function: aesEncryptGCM()](https://baileys.wiki/docs/api/functions/aesEncryptGCM)
  * [Parameters](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#parameters)
    * [plaintext](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#plaintext)
    * [key](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#key)
    * [iv](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#iv)
  * [Returns](https://baileys.wiki/docs/api/functions/aesEncryptCTR/#returns)
