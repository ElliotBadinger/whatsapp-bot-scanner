# Source: https://baileys.wiki/docs/api/functions/getAudioWaveform

<!-- Scraped from https://baileys.wiki/docs/api/functions/getAudioWaveform -->

[Skip to main content](https://baileys.wiki/docs/api/functions/getAudioWaveform/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/messages-media.ts:243](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/messages-media.ts#L243)
referenced from and modifying <https://github.com/wppconnect-team/wa-js/blob/main/src/chat/functions/prepareAudioWaveform.ts>
## Parameters[​](https://baileys.wiki/docs/api/functions/getAudioWaveform/#parameters "Direct link to Parameters")
### buffer[​](https://baileys.wiki/docs/api/functions/getAudioWaveform/#buffer "Direct link to buffer")
`string` | `Buffer`<`ArrayBufferLike`> | `Readable`
### logger?[​](https://baileys.wiki/docs/api/functions/getAudioWaveform/#logger "Direct link to logger?")
`ILogger`
## Returns[​](https://baileys.wiki/docs/api/functions/getAudioWaveform/#returns "Direct link to Returns")
`Promise`<`undefined` | `Uint8Array`<`ArrayBuffer`>>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/getAudioWaveform.md)
[Previous Function: getAudioDuration()](https://baileys.wiki/docs/api/functions/getAudioDuration)[Next Function: getBinaryNodeChild()](https://baileys.wiki/docs/api/functions/getBinaryNodeChild)
  * [Parameters](https://baileys.wiki/docs/api/functions/getAudioWaveform/#parameters)
    * [buffer](https://baileys.wiki/docs/api/functions/getAudioWaveform/#buffer)
    * [logger?](https://baileys.wiki/docs/api/functions/getAudioWaveform/#logger)
  * [Returns](https://baileys.wiki/docs/api/functions/getAudioWaveform/#returns)
