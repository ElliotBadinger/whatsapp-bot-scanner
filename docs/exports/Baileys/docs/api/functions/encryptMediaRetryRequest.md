# Source: https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest

<!-- Scraped from https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest -->

[Skip to main content](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#__docusaurus_skipToContent_fallback)
...
On this page
# Function: encryptMediaRetryRequest()
> **encryptMediaRetryRequest**(`key`, `mediaKey`, `meId`): `Promise`<[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)>
Defined in: [src/Utils/messages-media.ts:727](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/messages-media.ts#L727)
Generate a binary node that will request the phone to re-upload the media & return the newly uploaded URL
## Parameters[​](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#parameters "Direct link to Parameters")
### key[​](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#key "Direct link to key")
[`WAMessageKey`](https://baileys.wiki/docs/api/type-aliases/WAMessageKey)
### mediaKey[​](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#mediakey "Direct link to mediaKey")
`Uint8Array`<`ArrayBufferLike`> | `Buffer`<`ArrayBufferLike`>
### meId[​](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#meid "Direct link to meId")
`string`
## Returns[​](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#returns "Direct link to Returns")
`Promise`<[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)>
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/encryptMediaRetryRequest.md)
[Previous Function: encodeWAMessage()](https://baileys.wiki/docs/api/functions/encodeWAMessage)[Next Function: encryptedStream()](https://baileys.wiki/docs/api/functions/encryptedStream)
  * [Parameters](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#parameters)
    * [key](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#key)
    * [mediaKey](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#mediakey)
    * [meId](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#meid)
  * [Returns](https://baileys.wiki/docs/api/functions/encryptMediaRetryRequest/#returns)
