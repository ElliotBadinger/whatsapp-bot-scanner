# Source: https://baileys.wiki/docs/api/functions/extractAddressingContext

<!-- Scraped from https://baileys.wiki/docs/api/functions/extractAddressingContext -->

[Skip to main content](https://baileys.wiki/docs/api/functions/extractAddressingContext/#__docusaurus_skipToContent_fallback)
...
- [](https://baileys.wiki/)
- functions
- Function: extractAddressingContext()
...
> Defined in: [src/Utils/decode-wa-message.ts:87](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/decode-wa-message.ts#L87)

## Parameters[​](https://baileys.wiki/docs/api/functions/extractAddressingContext/#parameters "Direct link to Parameters")

### stanza[​](https://baileys.wiki/docs/api/functions/extractAddressingContext/#stanza "Direct link to stanza")

[`BinaryNode`](https://baileys.wiki/docs/api/type-aliases/BinaryNode)

## Returns[​](https://baileys.wiki/docs/api/functions/extractAddressingContext/#returns "Direct link to Returns")

`object`

### addressingMode[​](https://baileys.wiki/docs/api/functions/extractAddressingContext/#addressingmode "Direct link to addressingMode")

> **addressingMode** : `string`

### recipientAlt[​](https://baileys.wiki/docs/api/functions/extractAddressingContext/#recipientalt "Direct link to recipientAlt")

> **recipientAlt** : `undefined` | `string`

### senderAlt[​](https://baileys.wiki/docs/api/functions/extractAddressingContext/#senderalt "Direct link to senderAlt")

> **senderAlt** : `undefined` | `string`
> [](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/functions/extractAddressingContext.md)
> [Previous Function: extensionForMediaMessage()](https://baileys.wiki/docs/api/functions/extensionForMediaMessage)[Next Function: extractDeviceJids()](https://baileys.wiki/docs/api/functions/extractDeviceJids)

- [Parameters](https://baileys.wiki/docs/api/functions/extractAddressingContext/#parameters)
  - [stanza](https://baileys.wiki/docs/api/functions/extractAddressingContext/#stanza)
- [Returns](https://baileys.wiki/docs/api/functions/extractAddressingContext/#returns)
  - [addressingMode](https://baileys.wiki/docs/api/functions/extractAddressingContext/#addressingmode)
  - [recipientAlt](https://baileys.wiki/docs/api/functions/extractAddressingContext/#recipientalt)
  - [senderAlt](https://baileys.wiki/docs/api/functions/extractAddressingContext/#senderalt)
