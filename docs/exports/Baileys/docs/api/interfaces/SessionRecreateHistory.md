# Source: https://baileys.wiki/docs/api/interfaces/SessionRecreateHistory

<!-- Scraped from https://baileys.wiki/docs/api/interfaces/SessionRecreateHistory -->

[Skip to main content](https://baileys.wiki/docs/api/interfaces/SessionRecreateHistory/#__docusaurus_skipToContent_fallback)
...
On this page
# Interface: SessionRecreateHistory
Defined in: [src/Utils/message-retry-manager.ts:23](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/message-retry-manager.ts#L23)
## Indexable[​](https://baileys.wiki/docs/api/interfaces/SessionRecreateHistory/#indexable "Direct link to Indexable")
[`jid`: `string`]: `number`
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/interfaces/SessionRecreateHistory.md)
[Previous Interface: RetryStatistics](https://baileys.wiki/docs/api/interfaces/RetryStatistics)[Next Interface: SignalRepositoryWithLIDStore](https://baileys.wiki/docs/api/interfaces/SignalRepositoryWithLIDStore)
  * [Indexable](https://baileys.wiki/docs/api/interfaces/SessionRecreateHistory/#indexable)
