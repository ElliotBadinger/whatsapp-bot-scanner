# Source: https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse

<!-- Scraped from https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse -->

[Skip to main content](https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Types/GroupMetadata.ts:61](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Types/GroupMetadata.ts#L61)

## Properties[​](https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse/#properties "Direct link to Properties")

### gid?[​](https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse/#gid "Direct link to gid?")

> `optional` **gid** : `string`
> Defined in: [src/Types/GroupMetadata.ts:63](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Types/GroupMetadata.ts#L63)

---

### participants?[​](https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse/#participants "Direct link to participants?")

> `optional` **participants** : [{}]
> Defined in: [src/Types/GroupMetadata.ts:64](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Types/GroupMetadata.ts#L64)

---

### status[​](https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse/#status "Direct link to status")

> **status** : `number`
> Defined in: [src/Types/GroupMetadata.ts:62](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Types/GroupMetadata.ts#L62)
> [](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/interfaces/WAGroupCreateResponse.md)
> [Previous Interface: SignalRepositoryWithLIDStore](https://baileys.wiki/docs/api/interfaces/SignalRepositoryWithLIDStore)[Next Interface: WAUrlInfo](https://baileys.wiki/docs/api/interfaces/WAUrlInfo)

- [Properties](https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse/#properties)
  - [gid?](https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse/#gid)
  - [participants?](https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse/#participants)
  - [status](https://baileys.wiki/docs/api/interfaces/WAGroupCreateResponse/#status)
