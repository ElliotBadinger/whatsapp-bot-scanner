...
<!-- Scraped from https://baileys.wiki/docs/api/interfaces/RecentMessage -->

[Skip to main content](https://baileys.wiki/docs/api/interfaces/RecentMessage/#__docusaurus_skipToContent_fallback)
...
On this page
# Interface: RecentMessage
Defined in: [src/Utils/message-retry-manager.ts:18](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/message-retry-manager.ts#L18)
## Properties[​](https://baileys.wiki/docs/api/interfaces/RecentMessage/#properties "Direct link to Properties")
### message[​](https://baileys.wiki/docs/api/interfaces/RecentMessage/#message "Direct link to message")
> **message** : [`IMessage`](https://baileys.wiki/docs/api/namespaces/proto/interfaces/IMessage)
Defined in: [src/Utils/message-retry-manager.ts:19](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/message-retry-manager.ts#L19)
* * *
### timestamp[​](https://baileys.wiki/docs/api/interfaces/RecentMessage/#timestamp "Direct link to timestamp")
> **timestamp** : `number`
Defined in: [src/Utils/message-retry-manager.ts:20](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Utils/message-retry-manager.ts#L20)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/interfaces/RecentMessage.md)
[Previous Interface: PresenceData](https://baileys.wiki/docs/api/interfaces/PresenceData)[Next Interface: RecentMessageKey](https://baileys.wiki/docs/api/interfaces/RecentMessageKey)
  * [Properties](https://baileys.wiki/docs/api/interfaces/RecentMessage/#properties)
    * [message](https://baileys.wiki/docs/api/interfaces/RecentMessage/#message)
    * [timestamp](https://baileys.wiki/docs/api/interfaces/RecentMessage/#timestamp)
