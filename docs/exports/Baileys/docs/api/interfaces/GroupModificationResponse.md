# Source: https://baileys.wiki/docs/api/interfaces/GroupModificationResponse

<!-- Scraped from https://baileys.wiki/docs/api/interfaces/GroupModificationResponse -->

[Skip to main content](https://baileys.wiki/docs/api/interfaces/GroupModificationResponse/#__docusaurus_skipToContent_fallback)
...
On this page
# Interface: GroupModificationResponse
Defined in: [src/Types/GroupMetadata.ts:67](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Types/GroupMetadata.ts#L67)
## Properties[​](https://baileys.wiki/docs/api/interfaces/GroupModificationResponse/#properties "Direct link to Properties")
### participants?[​](https://baileys.wiki/docs/api/interfaces/GroupModificationResponse/#participants "Direct link to participants?")
> `optional` **participants** : `object`
Defined in: [src/Types/GroupMetadata.ts:69](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Types/GroupMetadata.ts#L69)
#### Index Signature[​](https://baileys.wiki/docs/api/interfaces/GroupModificationResponse/#index-signature "Direct link to Index Signature")
[`key`: `string`]: `object`
* * *
### status[​](https://baileys.wiki/docs/api/interfaces/GroupModificationResponse/#status "Direct link to status")
> **status** : `number`
Defined in: [src/Types/GroupMetadata.ts:68](https://github.com/WhiskeySockets/Baileys/blob/9720ff49caf0dbee182a7577a96e3639011824e6/src/Types/GroupMetadata.ts#L68)
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/interfaces/GroupModificationResponse.md)
[Previous Interface: GroupMetadata](https://baileys.wiki/docs/api/interfaces/GroupMetadata)[Next Interface: NewsletterCreateResponse](https://baileys.wiki/docs/api/interfaces/NewsletterCreateResponse)
  * [Properties](https://baileys.wiki/docs/api/interfaces/GroupModificationResponse/#properties)
    * [participants?](https://baileys.wiki/docs/api/interfaces/GroupModificationResponse/#participants)
    * [status](https://baileys.wiki/docs/api/interfaces/GroupModificationResponse/#status)
