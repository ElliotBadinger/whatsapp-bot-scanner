# Source: https://baileys.wiki/docs/api/interfaces/PresenceData

<!-- Scraped from https://baileys.wiki/docs/api/interfaces/PresenceData -->

[Skip to main content](https://baileys.wiki/docs/api/interfaces/PresenceData/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Types/Chat.ts:36](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Types/Chat.ts#L36)

## Properties[​](https://baileys.wiki/docs/api/interfaces/PresenceData/#properties "Direct link to Properties")

### lastKnownPresence[​](https://baileys.wiki/docs/api/interfaces/PresenceData/#lastknownpresence "Direct link to lastKnownPresence")

> **lastKnownPresence** : [`WAPresence`](https://baileys.wiki/docs/api/type-aliases/WAPresence)
> Defined in: [src/Types/Chat.ts:37](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Types/Chat.ts#L37)

---

### lastSeen?[​](https://baileys.wiki/docs/api/interfaces/PresenceData/#lastseen "Direct link to lastSeen?")

> `optional` **lastSeen** : `number`
> Defined in: [src/Types/Chat.ts:38](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Types/Chat.ts#L38)
> [](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/interfaces/PresenceData.md)
> [Previous Interface: NewsletterMetadata](https://baileys.wiki/docs/api/interfaces/NewsletterMetadata)[Next Interface: RecentMessage](https://baileys.wiki/docs/api/interfaces/RecentMessage)

- [Properties](https://baileys.wiki/docs/api/interfaces/PresenceData/#properties)
  - [lastKnownPresence](https://baileys.wiki/docs/api/interfaces/PresenceData/#lastknownpresence)
  - [lastSeen?](https://baileys.wiki/docs/api/interfaces/PresenceData/#lastseen)
