...
<!-- Scraped from https://baileys.wiki/docs/api/interfaces/RecentMessageKey -->

[Skip to main content](https://baileys.wiki/docs/api/interfaces/RecentMessageKey/#__docusaurus_skipToContent_fallback)
...
Defined in: [src/Utils/message-retry-manager.ts:13](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/message-retry-manager.ts#L13)

## Properties[​](https://baileys.wiki/docs/api/interfaces/RecentMessageKey/#properties "Direct link to Properties")

### id[​](https://baileys.wiki/docs/api/interfaces/RecentMessageKey/#id "Direct link to id")

> **id** : `string`
> Defined in: [src/Utils/message-retry-manager.ts:15](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/message-retry-manager.ts#L15)

---

### to[​](https://baileys.wiki/docs/api/interfaces/RecentMessageKey/#to "Direct link to to")

> **to** : `string`
> Defined in: [src/Utils/message-retry-manager.ts:14](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Utils/message-retry-manager.ts#L14)
> [](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/interfaces/RecentMessageKey.md)
> [Previous Interface: RecentMessage](https://baileys.wiki/docs/api/interfaces/RecentMessage)[Next Interface: RetryCounter](https://baileys.wiki/docs/api/interfaces/RetryCounter)

- [Properties](https://baileys.wiki/docs/api/interfaces/RecentMessageKey/#properties)
  - [id](https://baileys.wiki/docs/api/interfaces/RecentMessageKey/#id)
  - [to](https://baileys.wiki/docs/api/interfaces/RecentMessageKey/#to)
