# Source: https://baileys.wiki/docs/api/enumerations/WAMessageAddressingMode

<!-- Scraped from https://baileys.wiki/docs/api/enumerations/WAMessageAddressingMode -->

[Skip to main content](https://baileys.wiki/docs/api/enumerations/WAMessageAddressingMode/#__docusaurus_skipToContent_fallback)
...
- [](https://baileys.wiki/)
- enumerations
- Enumeration: WAMessageAddressingMode

On this page

# Enumeration: WAMessageAddressingMode

Defined in: [src/Types/Message.ts:45](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Types/Message.ts#L45)

## Enumeration Members[​](https://baileys.wiki/docs/api/enumerations/WAMessageAddressingMode/#enumeration-members "Direct link to Enumeration Members")

### LID[​](https://baileys.wiki/docs/api/enumerations/WAMessageAddressingMode/#lid "Direct link to LID")

> **LID** : `"lid"`
> Defined in: [src/Types/Message.ts:47](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Types/Message.ts#L47)

---

### PN[​](https://baileys.wiki/docs/api/enumerations/WAMessageAddressingMode/#pn "Direct link to PN")

> **PN** : `"pn"`
> Defined in: [src/Types/Message.ts:46](https://github.com/WhiskeySockets/Baileys/blob/cb8b3717aaede47460ba700651ee936f268c0ce4/src/Types/Message.ts#L46)
> [](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/api/enumerations/WAMessageAddressingMode.md)
> [Previous Enumeration: WAJIDDomains](https://baileys.wiki/docs/api/enumerations/WAJIDDomains)[Next Enumeration: XWAPaths](https://baileys.wiki/docs/api/enumerations/XWAPaths)

- [Enumeration Members](https://baileys.wiki/docs/api/enumerations/WAMessageAddressingMode/#enumeration-members)
  - [LID](https://baileys.wiki/docs/api/enumerations/WAMessageAddressingMode/#lid)
  - [PN](https://baileys.wiki/docs/api/enumerations/WAMessageAddressingMode/#pn)
