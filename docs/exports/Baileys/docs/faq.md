# Source: https://baileys.wiki/docs/faq

<!-- Scraped from https://baileys.wiki/docs/faq -->

[Skip to main content](https://baileys.wiki/docs/faq/#__docusaurus_skipToContent_fallback)
...
[](https://github.com/WhiskeySockets/baileys.wiki-site/tree/main/docs/faq.md)
[Previous Handling Broadcast Lists/Status](https://baileys.wiki/docs/socket/broadcast-lists)
Docs
