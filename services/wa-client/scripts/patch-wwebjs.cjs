...
const packageJsonPath = path.join(__dirname, '..', 'node_modules', 'whatsapp-web.js', 'package.json');
...
if (isModernVersion) {
  console.log('✅ Version 1.32.0+ detected - uses AuthStore-based authentication');
