...
let configContent = fs.readFileSync('services/wa-client/src/__tests__/commands.test.ts', 'utf8');
...
fs.writeFileSync('services/wa-client/src/__tests__/commands.test.ts', configContent);
