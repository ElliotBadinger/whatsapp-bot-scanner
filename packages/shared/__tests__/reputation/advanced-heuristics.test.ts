...
describe('Advanced Heuristics', () => {
  describe('advancedHeuristics', () => {
    ...
    it('should detect high entropy in hostname', () => {
      const result = advancedHeuristics('https://xk7j9m2n4p8q1r5s.example.com/');
    ...
    it('should detect suspicious patterns', () => {
      const result = advancedHeuristics('https://example.com/wp-admin/abcdefghijklmnopqrstuvwxyz123456');
    ...
    it('should detect IP addresses in URL', () => {
      const result = advancedHeuristics('https://example.com/redirect?url=192.168.1.1');

      expect(result.suspiciousPatterns.some(p => p.includes('IP address'))).toBe(true);
    });

    it('should detect phishing patterns', () => {
      const result = advancedHeuristics('https://example.com/verify-account-abcdefghijklmnopqrstuvwxyz123456');
    ...
    it('should analyze path entropy', () => {
      const result = advancedHeuristics('https://example.com/xk7j9m2n4p8q1r5s3t6u9v2w5x8y1z4');
