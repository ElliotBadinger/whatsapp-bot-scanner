...
`;
  ...
  showCompactPairingCode(code, countdown) {
    ...
    console.log(
      COLORS.primary("  │") +
        `  ${ICONS.key} ${COLORS.accentBold("Pairing Code:")} ${COLORS.codeHighlight(`  ${formattedCode}  `)}  ` +
        COLORS.primary("│"),
    );
    console.log(
      COLORS.primary("  │") +
        `  ${ICONS.timer} Expires: ${COLORS.warning(countdown)}                              ` +
        COLORS.primary("│"),
    );
    console.log(
      COLORS.primary("  ╰──────────────────────────────────────────────────╯"),
  ...
  updateCountdownDisplay(countdown) {
    ...
    if (process.stdout.isTTY) {
      ...
      process.stdout.write(
        `\r${ICONS.timer}  Expires in: ${COLORS.warning(countdown)}    `,
      );
    }
  }
  ...
  showCodeExpiredMessage() {
    ...
    console.log(
      COLORS.warning("  │") +
        `  ${ICONS.warning} ${COLORS.warningBold("PAIRING CODE EXPIRED")}                       ` +
        COLORS.warning("│"),
    );
    console.log(
      COLORS.warning("  │") +
    ...
    console.log(
      COLORS.warning("  │") +
        `  ${COLORS.text("Generating a new code automatically...")}          ` +
        COLORS.warning("│"),
    );
    console.log(
      COLORS.warning(
  ...
  showPairingSuccess() {
    ...
    console.log(
      COLORS.success("  │") +
        `       ${COLORS.successBold("✓ WHATSAPP PAIRED SUCCESSFULLY!")}             ` +
        COLORS.success("│"),
    );
    console.log(
      COLORS.success("  │") +
    ...
    console.log(
      COLORS.success("  │") +
        `  ${COLORS.text("Your bot is now connected and ready to protect")}   ` +
        COLORS.success("│"),
    );
    console.log(
      COLORS.success("  │") +
        `  ${COLORS.text("your WhatsApp groups from malicious links.")}       ` +
        COLORS.success("│"),
    );
    console.log(
      COLORS.success("  │") +
  ...
  showPairingError(errorMessage) {
    ...
    console.log(
      COLORS.error("  │") +
        `  ${COLORS.error.bold("✗ PAIRING FAILED")}                                ` +
        COLORS.error("│"),
    );
    console.log(
      COLORS.error("  │") +
    ...
    console.log(
      COLORS.error("  │") +
        `  ${COLORS.text(truncateMessage(errorMessage, 42))}` +
        COLORS.error("│"),
    );
    console.log(
      COLORS.error("  │") +
    ...
    console.log(
      COLORS.error("  │") +
        `  ${COLORS.muted("Try: npx whatsapp-bot-scanner pair")}               ` +
        COLORS.error("│"),
    );
    console.log(
      COLORS.error("  ╰────────────────────────────────────────────────────╯"),
