...
export default {
  ...
  copy: {
    guided: {
      description:
        "Verify prerequisites, ensure the repository is present, and align git/docker state before making changes.",
    },
    expert: {
      description:
        "Quick environment validation before proceeding to destructive operations.",
    },
  },
  steps: [
