...
import { generateHexSecret, generateBase64Secret, cleanDigits } from '../utils/runtime.mjs';
...
export default {
  ...
  copy: {
    guided: {
      description: 'Provision secrets, capture API keys, and configure WhatsApp Remote Auth.'
    },
    expert: {
