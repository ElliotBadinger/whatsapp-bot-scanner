...
export default {
  ...
  copy: {
    guided: {
      description: 'Builds workspace containers and boots the docker-compose stack.'
    },
    expert: {
      description: 'Rebuilds images, resets stopped containers, and launches services via make up.'
    }
  },
