...
import { handleRemoteAuthLog, handleRemoteAuthLine } from '../utils/remote-auth.mjs';
...
export default {
  ...
  copy: {
    guided: {
      description: 'Monitor container health and display WhatsApp pairing cues while the stack stabilises.'
    },
    expert: {
      description: 'Waits for core services, tails WhatsApp logs, and verifies reverse proxy health.'
    }
  },
