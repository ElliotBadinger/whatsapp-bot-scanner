...
*   **Issue:** The bot replies to messages *instantly* (sub-millisecond reaction time). Humans take time to read and type.
...
*   **Fix:**
    ...
    *   **Mature Number:** Use a phone number that has been active on a real phone for months/years. Do *not* use a fresh virtual number.
