...
const RAILWAY_TEMPLATE_URL =
  "https://railway.app/template/safemode?referralCode=demo";
const RENDER_DEPLOY_URL =
  "https://render.com/deploy?repo=https://github.com/safemode/whatsapp-scanner";
