module.exports = [
  ...
  (e) => {
    ...
    var r,
      ...
      _ = "object" == typeof globalThis ? globalThis : e.g,
      b = "1.9.0",
      S = /^(\d+)\.(\d+)\.(\d+)(-(.+))?$/,
      E = (function (e) {
        var t = new Set([e]),
        ...
        return function (e) {
          ...
          if (0 === a.major)
            return a.minor === i.minor && a.patch <= i.patch
              ? (t.add(e), !0)
              : o(e);
          return a.minor <= i.minor ? (t.add(e), !0) : o(e);
        };
      })(b),
      R = Symbol.for("opentelemetry.js.api." + b.split(".")[0]);
    function O(e, t, r, n) {
      void 0 === n && (n = !1);
      var a,
        o = (_[R] = null != (a = _[R]) ? a : { version: b });
      if (!n && o[e]) {
        var i = Error(
      ...
      return (
        (o[e] = t),
        r.debug(
          "@opentelemetry/api: Registered a global for " + e + " v" + b + ".",
        ),
        !0
      );
    }
    function w(e) {
      var t,
        r,
        n = null == (t = _[R]) ? void 0 : t.version;
      if (n && E(n)) return null == (r = _[R]) ? void 0 : r[e];
    }
    function T(e, t) {
      t.debug(
        "@opentelemetry/api: Unregistering a global for " + e + " v" + b + ".",
      );
      var r = _[R];
      r && delete r[e];
    }
    ...
    function C(e, t, r) {
      var n = w("diag");
      if (n) return (r.unshift(t), n[e].apply(n, P([], x(r), !1)));
    }
    (((l = r || (r = {}))[(l.NONE = 0)] = "NONE"),
      (l[(l.ERROR = 30)] = "ERROR"),
      (l[(l.WARN = 50)] = "WARN"),
    ...
    var A = function (e, t) {
          ...
          function e(e) {
            return function () {
              for (var t = [], r = 0; r < arguments.length; r++)
                t[r] = arguments[r];
              var n = w("diag");
              if (n) return n[e].apply(n, I([], A(t), !1));
            };
          }
          var t = this;
      ...
      V = (function () {
        ...
        return (
          ...
          (e.prototype.setGlobalContextManager = function (e) {
            return O(j, e, M.instance());
          }),
          (e.prototype.active = function () {
            return this._getContextManager().active();
          }),
          (e.prototype.with = function (e, t, r) {
            for (var n, a = [], o = 3; o < arguments.length; o++)
              a[o - 3] = arguments[o];
          ...
          (e.prototype.disable = function () {
            (this._getContextManager().disable(), T(j, M.instance()));
          }),
          e
        );
      })(),
      ...
      F = (function (e) {
        ...
        return ($(t, e), (t.prototype.add = function (e, t) {}), t);
      })(H),
      q = (function (e) {
        function t() {
          return (null !== e && e.apply(this, arguments)) || this;
      ...
      X = (function (e) {
        ...
        return ($(t, e), (t.prototype.record = function (e, t) {}), t);
      })(H),
      W = (function (e) {
        function t() {
          return (null !== e && e.apply(this, arguments)) || this;
    ...
    function eg() {
      return eh(V.getInstance().active());
    }
    function ev(e, t) {
    ...
    var em = function (e, t) {
      ...
      eb = (function () {
        ...
        return (
          ...
          (e.prototype.removeEntries = function () {
            ...
            try {
              for (var i = e_(n), s = i.next(); !s.done; s = i.next()) {
                var l = s.value;
                o._entries.delete(l);
              }
            } catch (e) {
      ...
      eE = M.instance();
    function eR(e) {
      return (void 0 === e && (e = {}), new eb(new Map(Object.entries(e))));
    }
    function eO(e) {
      return (
        "string" != typeof e &&
    ...
    function eL() {
      return eM(V.getInstance().active());
    }
    function eD(e, t) {
    ...
    function eV(e) {
      var t;
      return null == (t = eM(e)) ? void 0 : t.spanContext();
    }
    var ek = /^([0-9a-f]{32})$/i,
      eU = /^[0-9a-f]{16}$/i;
    function e$(e) {
      return ek.test(e) && e !== eN;
    }
    function eG(e) {
      return eU.test(e) && e !== eP;
    }
    function eH(e) {
      return e$(e.traceId) && eG(e.spanId);
    }
    function eF(e) {
      return new eA(e);
    }
    var eq = V.getInstance(),
      eX = (function () {
        function e() {}
        return (
          (e.prototype.startSpan = function (e, t, r) {
            if (
              (void 0 === r && (r = eq.active()), null == t ? void 0 : t.root)
            )
              return new eA();
            var n,
              a = r && eV(r);
      ...
      eY = (function () {
        ...
        return (
          ...
          (e.prototype.getDelegate = function () {
            var e;
            return null != (e = this._delegate) ? e : ez;
          }),
      ...
      eQ = (function () {
        ...
        return (
          ...
          (e.prototype.setGlobalTracerProvider = function (e) {
            var t = O(eJ, this._proxyTracerProvider, M.instance());
          ...
          (e.prototype.disable = function () {
            (T(eJ, M.instance()), (this._proxyTracerProvider = new eY()));
          }),
          e
        );
      })().getInstance();
    let eZ = { context: k, diag: U, metrics: eu, propagation: ex, trace: eQ };
    (e.s(["default", 0, eZ], 44286), e.i(44286));
    var e0 = [
        { n: "error", c: "error" },
        { n: "warn", c: "warn" },
        { n: "info", c: "info" },
              ...
              ((this._internalState = e
                ...
                .reduce(function (e, t) {
                  ...
                  if (-1 !== n) {
                    ...
                    e9.test(a) && e6.test(o) && !e4.test(o) && e.set(a, o);
                  }
                  return e;
                }, new Map())),
    ...
    (() => {
      ...
      function w(e) {
        ...
        var r = (O[e] = { exports: {} }),
          n = !0;
        try {
          (R[e].call(r.exports, r, r.exports, w), (n = !1));
        } finally {
          n && delete O[e];
        }
        return r.exports;
      ...
      w.ab =
        "/ROOT/Development/whatsapp-bot-scanner/node_modules/next/dist/compiled/@opentelemetry/api/";
      var T = {};
      (Object.defineProperty(T, "__esModule", { value: !0 }),
        (T.trace =
          T.propagation =
  ...
  (e, t, r) => {
    "use strict";
    t.exports = e.r(37950).vendored["react-rsc"].React;
  },
  83154,
  (e, t, r) => {
    "use strict";
        ...
        );
      {
        var v,
          ...
          m = {
            ...
            path: l,
            ...(u && {
              sameSite: f.includes((v = (v = u).toLowerCase())) ? v : void 0,
            }),
            ...(c && { secure: !0 }),
            ...(g && {
              priority: h.includes((y = (y = g).toLowerCase())) ? y : void 0,
            }),
            ...(p && { partitioned: !0 }),
          };
        let e = {};
    ...
    (() => {
      ...
      "undefined" != typeof __nccwpck_require__ &&
        (__nccwpck_require__.ab =
          "/ROOT/Development/whatsapp-bot-scanner/node_modules/next/dist/compiled/cookie/");
      var e,
        r,
        n,
        a,
  ...
  (e) => {
    ...
    var R =
      ...
      P =
        (((u = P || {}).getServerSideProps = "Render.getServerSideProps"),
        ...
        u),
      N =
        (((c = N || {}).renderToString = "AppRender.renderToString"),
      ...
      M =
        (((h = M || {}).generateMetadata = "ResolveMetadata.generateMetadata"),
        (h.generateViewport = "ResolveMetadata.generateViewport"),
        h),
      L = (((g = L || {}).execute = "Middleware.execute"), g);
    let D = new Set([
        "Middleware.execute",
    ...
    let q = (e, t) => {
      ...
      Y =
        ((n = new (class e {
          ...
          trace(...e) {
            let [t, r, n] = e,
              ...
              i = o.spanName ?? t;
            if (
              (!D.has(t) && "1" !== process.env.NEXT_OTEL_VERBOSE) ||
              o.hideSpan
            )
              return a();
            ...
            return (
              ...
              V.with(s.setValue(W, c), () =>
                this.getTracerInstance().startActiveSpan(i, o, (e) => {
                  ...
                  if (
                    (u && X.set(c, new Map(Object.entries(o.attributes ?? {}))),
                    a.length > 1)
                  )
                    try {
                      return a(e, (t) => q(e, t));
        ...
        () => n);
    e.s(["SpanKind", () => G, "getTracer", () => Y], 68568);
    let J = {
      shared: "shared",
          ...
          switch (t.type) {
            case "prerender-ppr":
              ...
              return (
                ...
                Q.default.unstable_postpone(ec(n, a)))
              );
    ...
    function ey() {}
    (e.s(
      ["CachedRouteKind", () => eg, "IncrementalCacheKind", () => ev],
      33280,
    ),
    ...
    class ek {
      constructor(e, t, r) {
        ...
        (("object" == typeof t && "pathname" in t) || "string" == typeof t
          ? ((n = t), (a = r || {}))
          : (a = r || t || {}),
          (this[eV] = { url: eB(e, n ?? a.base), options: a, basePath: "" }),
          this.analyze());
      }
      analyze() {
        var e, t, r, n, a;
        let o = (function (e, t) {
              ...
              ((o.locale = e.detectedLocale),
                ...
                !e.detectedLocale &&
                  ...
                  (e = t.i18nProvider
                    ...
                    : eD(i, n.locales)).detectedLocale &&
                  (o.locale = e.detectedLocale));
            }
            return o;
          })(this[eV].url.pathname, {
            nextConfig: this[eV].options.nextConfig,
            parseData: !0,
            i18nProvider: this[eV].options.i18nProvider,
          }),
          i = (function (e, t) {
            let r;
          ...
          })(this[eV].url, this[eV].options.headers);
        this[eV].domainLocale = this[eV].options.i18nProvider
          ? this[eV].options.i18nProvider.detectDomainLocale(i)
          : (function (e, t, r) {
              if (e) {
              ...
              null == (t = this[eV].options.nextConfig) || null == (e = t.i18n)
                ? void 0
                : e.domains,
              i,
            );
        let s =
          (null == (r = this[eV].domainLocale) ? void 0 : r.defaultLocale) ||
          (null == (a = this[eV].options.nextConfig) || null == (n = a.i18n)
            ? void 0
            : n.defaultLocale);
        ((this[eV].url.pathname = o.pathname),
          (this[eV].defaultLocale = s),
          (this[eV].basePath = o.basePath ?? ""),
          (this[eV].buildId = o.buildId),
          (this[eV].locale = o.locale ?? s),
          (this[eV].trailingSlash = o.trailingSlash));
      }
      formatPathname() {
        var e;
        let t;
        return (
          (t = (function (e, t, r, n) {
            if (!t || t === r) return e;
            let a = e.toLowerCase();
            return !n && (eM(a, "/api") || eM(a, `/${t.toLowerCase()}`))
              ? e
              : eA(e, `/${t}`);
          })(
            (e = {
              basePath: this[eV].basePath,
              buildId: this[eV].buildId,
              defaultLocale: this[eV].options.forceLocale
                ? void 0
                : this[eV].defaultLocale,
              locale: this[eV].locale,
              pathname: this[eV].url.pathname,
              trailingSlash: this[eV].trailingSlash,
            }).pathname,
            e.locale,
      ...
      formatSearch() {
        return this[eV].url.search;
      }
      get buildId() {
        return this[eV].buildId;
      }
      set buildId(e) {
        this[eV].buildId = e;
      }
      get locale() {
        return this[eV].locale ?? "";
      }
      set locale(e) {
        var t, r;
        if (
          !this[eV].locale ||
          !(null == (r = this[eV].options.nextConfig) || null == (t = r.i18n)
            ? void 0
      ...
      get defaultLocale() {
        return this[eV].defaultLocale;
      }
      get domainLocale() {
        return this[eV].domainLocale;
      }
      get searchParams() {
        return this[eV].url.searchParams;
      }
      get host() {
        return this[eV].url.host;
      }
      set host(e) {
        this[eV].url.host = e;
      }
      get hostname() {
        return this[eV].url.hostname;
      }
      set hostname(e) {
        this[eV].url.hostname = e;
      }
      get port() {
        return this[eV].url.port;
      }
      set port(e) {
        this[eV].url.port = e;
      }
      get protocol() {
        return this[eV].url.protocol;
      }
      set protocol(e) {
        this[eV].url.protocol = e;
      }
      get href() {
      ...
      set href(e) {
        ((this[eV].url = eB(e)), this.analyze());
      }
      get origin() {
        return this[eV].url.origin;
      }
      get pathname() {
        return this[eV].url.pathname;
      }
      set pathname(e) {
        this[eV].url.pathname = e;
      }
      get hash() {
        return this[eV].url.hash;
      }
      set hash(e) {
        this[eV].url.hash = e;
      }
      ...
      set search(e) {
        this[eV].url.search = e;
      }
      get password() {
        return this[eV].url.password;
      }
      set password(e) {
        this[eV].url.password = e;
      }
      get username() {
        return this[eV].url.username;
      }
      set username(e) {
        this[eV].url.username = e;
      }
      get basePath() {
        return this[eV].basePath;
      }
      set basePath(e) {
        this[eV].basePath = e.startsWith("/") ? e : `/${e}`;
      }
      toString() {
        return this.href;
      }
      ...
      clone() {
        return new ek(String(this), this[eV].options);
      }
    }
  ...
  `);
            ...
            : Buffer.isBuffer(this.response)
              ...
              : Array.isArray(this.response)
                ? (function (...e) {
                    ...
                    let o = e[a];
                    return ((n = n.then(() => o.pipeTo(r))).catch(ey), t);
                  })(...this.response)
                : this.response;
      }
      coerce() {
    ...
    async function e4(e, t, r, n, a, o, i, s, l) {
      let [u, c] = ep(t),
        d = u
          .arrayBuffer()
          .then(async (e) => {
            ...
            (null == o || o.set(r, s),
              n &&
                (await a.set(
                  r,
                  { kind: eg.FETCH, data: s, revalidate: i },
                  n,
                )));
          })
          ...
          let l = (null == s ? void 0 : s.href) ?? "",
            u =
              (null == a || null == (o = a.method)
                ...
                : o.toUpperCase()) || "GET",
            c =
              (null == a || null == (i = a.next) ? void 0 : i.internal) === !0,
            d = "1" === process.env.NEXT_OTEL_FETCH_DISABLED,
            p = c ? void 0 : performance.timeOrigin + performance.now(),
            f = t.getStore(),
            h = r.getStore(),
            g = h ? (0, et.getCacheSignal)(h) : null;
          g && g.beginRead();
          let v = Y().trace(
            c ? T.internalFetch : N.fetch,
            {
              hideSpan: d,
              kind: G.CLIENT,
            ...
            async () => {
              ...
              let E = null == h ? void 0 : h.implicitTags,
                R = f.fetchCache;
              h && "unstable-cache" === h.type && (R = "force-no-store");
              let O = !!f.isUnstableNoStore,
                w = y("cache"),
                T = "";
              "string" == typeof w &&
                void 0 !== b &&
                (("force-cache" === w && 0 === b) ||
                  ("no-store" === w && (b > 0 || !1 === b))) &&
                ((o = `Specified "cache: ${w}" and "revalidate: ${b}", only one should be specified.`),
                (w = void 0),
                (b = void 0));
              let x =
                  "no-cache" === w ||
                  ...
                  "force-no-store" === R ||
                  "only-no-store" === R,
                P = !R && !w && !b && f.forceDynamic;
              ("force-cache" === w && void 0 === b
                ? (b = !1)
                : (x || P) && (b = 0),
              ...
              let N = y("headers"),
                ...
                M =
                  ...
                  (void 0 == w || "default" === w) &&
                  void 0 == b,
                L = !!((A || I) && (null == r ? void 0 : r.revalidate) === 0),
                D = !1;
              if (
                (!L && M && (f.isBuildTimePrerendering ? (D = !0) : (L = !0)),
                M && void 0 !== h)
              )
                switch (h.type) {
                  case "prerender":
              ...
              if (
                (void 0 === d
                  ...
                  : T || (T = `revalidate: ${d}`),
                !(f.forceStatic && 0 === d) && !L && r && d < r.revalidate)
              ) {
                if (0 === d) {
                  if (h)
                    switch (h.type) {
              ...
              if (i && B) {
                ...
                if ((V && s && ((e = s.get(i)), (H = !0)), j && !e)) {
                  ...
                  if (
                    ...
                    if (f.isStaticGeneration && t.isStale) G = !0;
                    else {
                      if (
                        t.isStale &&
                        ...
                        (e.catch(console.error), (f.pendingRevalidates[i] = e));
                      }
                      e = t.value.data;
                    }
                }
    ...
    (e.s(["patchFetch", () => e8], 12669),
      e.s(["normalizeAppPath", () => e5], 54985));
    let e7 = Symbol.for("next.server.action-manifests");
    function te({
      page: e,
      ...
      var a;
      let o =
        null == (a = globalThis[e7])
          ? void 0
          : a.clientReferenceManifestsPerPage;
      globalThis[e7] = {
        clientReferenceManifestsPerPage: { ...o, [e5(e)]: t },
        serverActionsManifest: r,
        serverModuleMap: n,
      };
    }
      ...
      return new Proxy(
        {},
        {
          get: (t, r) => {
            ...
            if (
              !(i = l
                ? s[eM((o = l.page), "app") ? o : "app" + o]
                : Object.values(s).at(0))
            )
              return;
            let { moduleId: u, async: c } = i;
            return { id: u, name: r, chunks: [], async: c };
          },
        },
      );
    }
    (e.s(["setReferenceManifestsSingleton", () => te], 80066),
      e.s(["createServerModuleMap", () => tt], 98898));
    class tr {
      static get(e, t, r) {
    ...
    async function tp(e, t, r, n) {
      {
          ...
          a.forEach((e, r) => {
            if ("x-middleware-set-cookie" !== r.toLowerCase())
              if ("set-cookie" === r.toLowerCase())
                for (let n of eT(e)) t.appendHeader(r, n);
              else {
        ...
        r.body && "HEAD" !== e.method ? await e0(r.body, i, n) : i.end();
      }
    }
    function tf({ revalidate: e, expire: t }) {
      let r =
    ...
    (e.s(["NodeNextRequest", () => tu, "NodeNextResponse", () => tc], 49794),
      e.s(["getRevalidateReason", () => td], 2400),
      e.s(["sendResponse", () => tp], 49283),
      e.s(["getCacheControlHeader", () => tf], 46723));
  },
];

//# sourceMappingURL=%5Broot-of-the-server%5D__bd668af9._.js.map
