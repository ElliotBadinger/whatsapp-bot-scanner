module.exports = [
  ...
  (a) => {
    ...
    function i({ isDeploying: a, onComplete: d }) {
      let [e, g] = (0, c.useState)(0),
        [i, j] = (0, c.useState)([]),
        [k, l] = (0, c.useState)(0);
      return ((0, c.useEffect)(() => {
        ...
        let b = 0,
          c = 0,
          e = h.reduce((a, b) => a + b.duration, 0),
          f = () => {
            if (b >= h.length) return void d?.();
            let a = h[b],
            ...
            (g(b),
              j((b) => [...b, `[${i}] ${a.message}`]),
              l(Math.min(100, Math.floor(((c += a.duration) / e) * 100))),
              a.duration > 0 &&
                setTimeout(() => {
                  (b++, f());
                }, a.duration));
                ...
                children: i.map((c, d) =>
                  (0, b.jsxs)(
                    "div",
                    {
                      className: (0, f.cn)(
                        "py-1",
                        d === i.length - 1 && a && "text-primary",
                        c.includes("COMPLETE") && "text-primary font-bold",
                        !c.includes("COMPLETE") &&
                          !(d === i.length - 1 && a) &&
              ...
              (0, b.jsx)("div", {
                ...
                children: (0, b.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, b.jsx)("span", {
                      className: "text-primary",
                      children: "▓".repeat(Math.floor(k / 5)),
                    }),
                    (0, b.jsx)("span", {
                      className: "text-primary/20",
                      children: "░".repeat(20 - Math.floor(k / 5)),
                    }),
                    "]",
                  ],
                }),
    ...
    var j = a.i(50196);
    function k({ isVisible: a }) {
      if (!a) return null;
      let c = `2@abc123xyz...${Date.now()}`;
      return (0, b.jsxs)("div", {
        ...
        children: [
          ...
          (0, b.jsx)("div", {
            ...
            children: (0, b.jsx)(j.QRCodeDisplay, { value: c, size: 220 }),
          }),
          (0, b.jsxs)("div", {
        ...
        children: [
          ...
          (0, b.jsxs)("main", {
            ...
            children: [
              ...
              (0, b.jsx)("div", {
                className: "mb-8",
                children: (0, b.jsx)(e.TerminalCard, {
                      ...
                      (0, b.jsxs)("div", {
                        children: [
                          ...
                          (0, b.jsxs)("div", {
                            ...
                            children: [
                              (0, b.jsx)("div", { children: "> 1 vCPU" }),
                              (0, b.jsx)("div", { children: "> 1GB RAM" }),
                              (0, b.jsx)("div", { children: "> 10GB Storage" }),
                            ],
                          }),
                        ],
                      }),
                      (0, b.jsxs)("div", {
                        children: [
                          ...
                          (0, b.jsxs)("div", {
                            className: "space-y-1 text-muted-foreground",
                            children: [
                              (0, b.jsx)("div", { children: "> 2 vCPU" }),
                              (0, b.jsx)("div", { children: "> 2GB RAM" }),
                              (0, b.jsx)("div", { children: "> 20GB SSD" }),
                            ],
                          }),
                        ],
                      }),
                      (0, b.jsxs)("div", {
                        children: [
                          ...
                          (0, b.jsxs)("div", {
                            className: "space-y-1 text-muted-foreground",
                            children: [
                              (0, b.jsx)("div", { children: "> Redis 7+" }),
                              (0, b.jsx)("div", {
                                children: "> PostgreSQL 15+",
                              }),
                              (0, b.jsx)("div", { children: "> Node.js 20+" }),
                            ],
                          }),
                        ],
                      }),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__496b7b1c._.js.map
