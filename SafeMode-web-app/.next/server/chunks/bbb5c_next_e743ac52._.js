module.exports = [
  ...
  (e, t, r) => {
    ...
    function a(e, t) {
      ...
      r &&
        ...
        ((u.pathname = (0, i.removePathPrefix)(u.pathname, r)),
        (u.basePath = r));
      let c = u.pathname;
      if (
  ...
  (e, t, r) => {
        ...
        226: function (t, r) {
          !(function (n, i) {
            ...
            var o = "function",
              ...
              z = function (e, t) {
                for (var r, n, i, a, u, c, l = 0; l < t.length && !u; ) {
                  var d = t[l],
                    p = t[l + 1];
              ...
              Z = function (e, t) {
                ...
                return (
                  ...
                  (this.getCPU = function () {
                    var e = {};
                    return ((e[b] = void 0), z.call(e, i, _.cpu), e);
                  }),
                  ...
                  (this.setUA = function (e) {
                    return (
                      (i = typeof e === u && e.length > 350 ? W(e, 350) : e),
                      this
                    );
                  }),
                  this.setUA(i),
    ...
    ((o.ab =
      "/ROOT/Development/whatsapp-bot-scanner/node_modules/next/dist/compiled/ua-parser-js/"),
      (t.exports = o(226)));
  },
  36123,
  (e, t, r) => {
    ...
    let a = (n = e.r(41920)) && n.__esModule ? n : { default: n };
    function s(e) {
  ...
  (e, t, r) => {
    ...
    let s = (n = e.r(25659)) && n.__esModule ? n : { default: n },
      u = e.r(76568),
      c = e.r(86532),
      l = e.r(32319),
      d = e.r(56704),
      ...
      m = e.r(29835),
      g = e.r(81370),
      w = "function" == typeof s.default.unstable_postpone;
    function _(e) {
      return {
    ...
    function O(e) {
      e.stagedRendering &&
        e.stagedRendering.advanceStage(g.RenderStage.Dynamic);
    }
    function A(e, t, r, n) {
...
${t}`
      ...
      return (
        e.abort(
          Object.defineProperty(
            new b.BailoutToCSRError("Render in Browser"),
            "__NEXT_ERROR_CODE",
      ...
      if (!Y.test(t)) {
        ...
        if (W.test(t)) {
          ...
          let s =
            ...
            (o = t),
            ((a = Object.defineProperty(Error(i), "__NEXT_ERROR_CODE", {
              value: "E394",
              enumerable: !1,
              configurable: !0,
            })).stack = a.name + ": " + i + o),
  ...
  (e, t, r) => {
    let n = {
      NextRequest: e.r(80572).NextRequest,
      NextResponse: e.r(28833).NextResponse,
      ImageResponse: e.r(37397).ImageResponse,
      userAgentFromString: e.r(36123).userAgentFromString,
      userAgent: e.r(36123).userAgent,
      URLPattern: e.r(84851).URLPattern,
      after: e.r(54751).after,
      connection: e.r(6697).connection,
    };
    ((t.exports = n),
  ...
  (e) => {
    ...
    let y = new t.AppRouteRouteModule({
        ...
        relativeProjectDir: "",
        resolvedPagePath:
          "[project]/Development/whatsapp-bot-scanner/SafeMode-web-app/app/api/status/route.ts",
        nextConfigOutput: "",
        userland: E,
      }),
      { workAsyncStorage: R, workUnitAsyncStorage: P, serverHooks: S } = y;
    function x() {
    ...
    async function O(e, t, n) {
      ...
      let _ = "/api/status/route";
      _ = _.replace(/\/index$/, "") || "/";
      let v = await y.prepare(e, t, { srcPage: _, multiZoneDraftMode: !1 });
      if (!v)
        return (
          (t.statusCode = 400),
          t.end("Bad Request"),
      ...
      let {
        ...
        D = (0, u.normalizeAppPath)(_),
        I = !!(O.dynamicRoutes[D] || O.routes[k]),
        L = async () => (
      ...
      if (I && !x) {
        let e = !!O.routes[k],
          t = O.dynamicRoutes[D];
        if (t && !1 === t.fallback && !e) {
          if (P.experimental.adapterPath) return await L();
          throw new g.NoFallbackError();
        }
      }
      let M = null;
      !I || y.isDev || x || (M = "/index" === (M = k) ? "/" : M);
      let U = !0 === y.isDev || !I,
        q = I && !U;
      C &&
        j &&
        ...
        B = {
          ...
          renderOpts: {
            ...
            onInstrumentationRequestError: (t, r, n) =>
              y.onRequestError(e, t, n, A),
          },
          sharedContext: { buildId: E },
        },
        G = new c.NodeNextRequest(e),
        F = new c.NodeNextResponse(t),
      ...
      try {
          ...
          u = async (i) => {
            ...
            let c = async ({ previousCacheEntry: r }) => {
                try {
                  ...
                  let u = B.renderOpts.pendingWaitUntil;
                  u && n.waitUntil && (n.waitUntil(u), (u = void 0));
                  let c = B.renderOpts.collectedTags;
                  if (!I)
                    return (
            ...
            if (
              ...
              throw Object.defineProperty(
                Error(
                  `Invariant: app-route received invalid cache entry ${null == l || null == (u = l.value) ? void 0 : u.kind}`,
                ),
                "__NEXT_ERROR_CODE",
            ...
            let d = (0, f.fromNodeOutgoingHttpHeaders)(l.value.headers);
            return (
              (s && I) || d.delete(m.NEXT_CACHE_TAGS_HEADER),
              !l.cacheControl ||
                t.getHeader("Cache-Control") ||
                d.get("Cache-Control") ||
                d.set(
                  "Cache-Control",
                  (0, b.getCacheControlHeader)(l.cacheControl),
                ),
              await (0, h.sendResponse)(
                G,
                F,
        ...
        if (
          ...
          throw t;
        return (
          await (0, h.sendResponse)(G, F, new Response(null, { status: 500 })),
          null
        );
      }
    }
...
//# sourceMappingURL=bbb5c_next_e743ac52._.js.map
