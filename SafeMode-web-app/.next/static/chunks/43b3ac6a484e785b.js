              ...
              if ("$" === u[0]) {
                ...
                switch (u[1]) {
                  case "$":
                    return u.slice(1);
                  case "L":
                    return F((r = L(r, (n = parseInt(u.slice(2), 16)))));
                  case "@":
              ...
              if (t[0] === p) {
                if (
                  ...
                  if (((U = (t = U).parent), t.errored))
                    e = F((e = new O("rejected", null, t.reason)));
                  else if (0 < t.deps) {
        ...
        .then(function t(i) {
          ...
          for (
            ...
            if (-1 < y)
                  ...
                  case 73:
                    ...
                    if ((p = c(_))) {
                      if (v) {
                        var y = v;
                        y.status = "blocked";
                      } else ((y = new O("blocked", null, null)), h.set(f, y));
                      p.then(
                        function () {
                          return k(s, y, _);
                        },
                      ...
                      v
                        ? k(s, v, _)
                        : ((v = new O("resolved_module", _, null)),
                          h.set(f, v));
                    break;
                  case 72:
                    switch (
              ...
              })(e, u, i, p, v, (h = new Uint8Array(l.buffer, g, y - s))),
                (s = y),
                3 === f && s++,
                (h = i = p = f = 0),
                (v.length = 0));
    ...
    function u() {
      return !(function () {
        if ("undefined" == typeof window) {
          let { workUnitAsyncStorage: t } = e.r(97225),
            r = t.getStore();
          if (!r) return !1;
          switch (r.type) {
            case "prerender":
  ...
  (e, t, r) => {
    ...
    async function b(e, t) {
      ...
      try {
        ...
        let b = await g;
        if ((0, d.getAppBuildId)() !== b.b) return y(r.url);
