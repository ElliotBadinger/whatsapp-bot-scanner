(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t, e, r) => {
    ...
    function d(t) {
      let e,
        r,
        o = h(l.NUMERIC, n.NUMERIC, t),
        i = h(l.ALPHANUMERIC, n.ALPHANUMERIC, t);
      return (
        u.isKanjiModeEnabled()
          ? ((e = h(l.BYTE, n.BYTE, t)), (r = h(l.KANJI, n.KANJI, t)))
          : ((e = h(l.BYTE_KANJI, n.BYTE, t)), (r = [])),
        o
          .concat(i, e, r)
          .sort(function (t, e) {
    ...
    ((r.fromArray = function (t) {
      ...
      (r.rawSplit = function (t) {
        return r.fromArray(d(t, u.isKanjiModeEnabled()));
      }));
  },
  77741,
  (t, e, r) => {
      ...
      return (
        ...
        (function (t, e, r, o) {
          ...
          let y = (function (t, e, r) {
              ...
              return (function (t, e, r) {
                ...
                let v = new Uint8Array(a),
                  T = 0;
                for (o = 0; o < A; o++)
                  for (i = 0; i < l; i++) o < w[i].length && (v[T++] = w[i][o]);
                for (o = 0; o < m; o++)
                  for (i = 0; i < l; i++) v[T++] = C[i][o];
                return v;
              })(o, t, e);
            })(e, r, d),
          ...
          return (
            ...
            isNaN(o) && (o = u.getBestMask(w, m.bind(null, w, r))),
            u.applyMask(o, w),
            m(w, r, o),
            {
              modules: w,
        ...
        for (let e = 0; e < s; e++)
          for (let r = 0; r < s; r++) {
            ...
            (e >= l &&
              ...
              r < s - l &&
              (f =
                u[+!!i[Math.floor((e - l) / a) * o + Math.floor((r - l) / a)]]),
              (t[c++] = f.r),
              (t[c++] = f.g),
              (t[c++] = f.b),
              (t[c] = f.a));
  ...
  (t) => {
    ...
    var e = t.i(66808),
      r = t.i(16371),
      n = t.i(9450);
    function o({ value: t, size: o = 200 }) {
      let i = (0, r.useRef)(null);
      return (
        (0, r.useEffect)(() => {
          i.current &&
            n.default.toCanvas(i.current, t, {
              width: o,
              margin: 2,
              color: { dark: "#00FF41", light: "#0D1117" },
