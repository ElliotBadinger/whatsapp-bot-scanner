...
describe('PairingManager Tests', () => {
  ...
  beforeEach(() => {
    ...
    pairingManager = new PairingManager(mockDockerOrchestrator, mockUI, mockNotifications);
  });
...
describe('SetupWizard Tests', () => {
  ...
  beforeEach(async () => {
    ...
    setupWizard.dockerOrchestrator = new MockDockerOrchestrator(tempDir, mockUI);
...
describe('UI Components Tests', () => {
  describe('UserInterface Tests', () => {
    ...
    it('should handle non-interactive mode correctly', async () => {
      const result = await ui.prompt({ message: 'Test', default: 'default-value' });
  ...
  describe('NotificationManager Tests', () => {
    ...
    it('should handle countdown updates', () => {
      notificationManager.currentDisplay = { code: '123456', phone: '+1234567890' };
